...
class AdvancedChunkingService:
    ...
    def detect_content_type(self, text: str) -> str:
        ...
        has_code = any(
            re.search(pattern, text, re.IGNORECASE) for pattern in code_patterns
        )
    ...
    def preprocess_technical_document(self, text: str) -> str:
        ...
        processed = re.sub(header_pattern, r"## \1", processed, flags=re.MULTILINE)
