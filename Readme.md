<div align="center">
  <img src="https://github.com/xmlangel/testcasecraft/blob/master/docs/testcasecraft.jpg" width="600" alt="TestcaseCraft Logo">
...
> **운영 배포 시 보안 환경변수(CORS 도메인·Jira 암호화 키·프록시 IP 신뢰·SSRF 가드)는 [docs/SECURITY_DEPLOYMENT_ENV.md](docs/SECURITY_DEPLOYMENT_ENV.md) 를 반드시 확인하세요.** 기본값이 개발용이라 미설정 시 프론트 CORS 파손·Jira 암호화 실패가 발생합니다.
