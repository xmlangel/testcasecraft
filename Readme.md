<div align="center">
  <img src="./docs/feature_images/TestcaseCraft.jpeg" width="600" alt="TestcaseCraft Logo">
</div>
...
<table width="100%">
  <tr>
    <td valign="top" width="25%">
      <b>Light Login</b><br>
      <a href="./docs/feature_images/01_Light_Login.png" target="_blank"><img src="./docs/feature_images/01_Light_Login.png" alt="Light Login"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light SignUp</b><br>
      <a href="./docs/feature_images/02_Light_SignUp.png" target="_blank"><img src="./docs/feature_images/02_Light_SignUp.png" alt="Light SignUp"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Project List</b><br>
      <a href="./docs/feature_images/03_Light_Project_List.png" target="_blank"><img src="./docs/feature_images/03_Light_Project_List.png" alt="Light Project List"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Project Dashboard</b><br>
      <a href="./docs/feature_images/04_Light_Project_Dashboard.png" target="_blank"><img src="./docs/feature_images/04_Light_Project_Dashboard.png" alt="Light Project Dashboard"></a>
    </td>
  </tr>
  <tr>
    <td valign="top" width="25%">
      <b>Light Test Case Form Input</b><br>
      <a href="./docs/feature_images/05_Light_Test_CASE_Form_INPUT.png" target="_blank"><img src="./docs/feature_images/05_Light_Test_CASE_Form_INPUT.png" alt="Light Test Case Form Input"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Test Case Spreadsheet 01</b><br>
      <a href="./docs/feature_images/06_Light_Test_CASE_Sprdadsheet_01.png" target="_blank"><img src="./docs/feature_images/06_Light_Test_CASE_Sprdadsheet_01.png" alt="Light Test Case Spreadsheet 01"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Test Case Spreadsheet 02</b><br>
      <a href="./docs/feature_images/07_Light_Test_CASE_Sprdadsheet_02.png" target="_blank"><img src="./docs/feature_images/07_Light_Test_CASE_Sprdadsheet_02.png" alt="Light Test Case Spreadsheet 02"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Test Plan List</b><br>
      <a href="./docs/feature_images/08_Light_Test_Plan_List.png" target="_blank"><img src="./docs/feature_images/08_Light_Test_Plan_List.png" alt="Light Test Plan List"></a>
    </td>
  </tr>
  <tr>
    <td valign="top" width="25%">
      <b>Light Test Execution List</b><br>
      <a href="./docs/feature_images/09_00_Light_Test_Execution_List.png" target="_blank"><img src="./docs/feature_images/09_00_Light_Test_Execution_List.png" alt="Light Test Execution List"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Test Execution 1</b><br>
      <a href="./docs/feature_images/09_01_Light_Test_execution_1.png" target="_blank"><img src="./docs/feature_images/09_01_Light_Test_execution_1.png" alt="Light Test Execution 1"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Test Execution Input Result</b><br>
      <a href="./docs/feature_images/09_02_Light_Test_execution_Input_result.png" target="_blank"><img src="./docs/feature_images/09_02_Light_Test_execution_Input_result.png" alt="Light Test Execution Input Result"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Test Execution Previous Execution Result</b><br>
      <a href="./docs/feature_images/09_03_Light_Test_execution_Previos_Execution_result.png" target="_blank"><img src="./docs/feature_images/09_03_Light_Test_execution_Previos_Execution_result.png" alt="Light Test Execution Previous Execution Result"></a>
    </td>
  </tr>
  <tr>
    <td valign="top" width="25%">
      <b>Light Test Result 01</b><br>
      <a href="./docs/feature_images/10_Light_Test_Result_01.png" target="_blank"><img src="./docs/feature_images/10_Light_Test_Result_01.png" alt="Light Test Result 01"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Test Result 02</b><br>
      <a href="./docs/feature_images/11_Light_Test_Result_02.png" target="_blank"><img src="./docs/feature_images/11_Light_Test_Result_02.png" alt="Light Test Result 02"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Automation Dashboard</b><br>
      <a href="./docs/feature_images/12_Light_Automation_Dashboard.png" target="_blank"><img src="./docs/feature_images/12_Light_Automation_Dashboard.png" alt="Light Automation Dashboard"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Automation Recent Result</b><br>
      <a href="./docs/feature_images/13_Light_Automation_Recent_Result.png" target="_blank"><img src="./docs/feature_images/13_Light_Automation_Recent_Result.png" alt="Light Automation Recent Result"></a>
    </td>
  </tr>
  <tr>
    <td valign="top" width="25%">
      <b>Light Automation Result Detail Tests</b><br>
      <a href="./docs/feature_images/14_Light_Automation_Result_Detail_Tests.png" target="_blank"><img src="./docs/feature_images/14_Light_Automation_Result_Detail_Tests.png" alt="Light Automation Result Detail Tests"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Automation Result Detail Fail Tests</b><br>
      <a href="./docs/feature_images/15_Light_Automation_Result_Detail_Fail_Tests.png" target="_blank"><img src="./docs/feature_images/15_Light_Automation_Result_Detail_Fail_Tests.png" alt="Light Automation Result Detail Fail Tests"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light Automation Result Detail Slow Tests</b><br>
      <a href="./docs/feature_images/16_Light_Automation_Result_Detail_Slow_Tests.png" target="_blank"><img src="./docs/feature_images/16_Light_Automation_Result_Detail_Slow_Tests.png" alt="Light Automation Result Detail Slow Tests"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light RAG DOC</b><br>
      <a href="./docs/feature_images/17_Light_RAG_DOC.png" target="_blank"><img src="./docs/feature_images/17_Light_RAG_DOC.png" alt="Light RAG DOC"></a>
    </td>
  </tr>
  <tr>
    <td valign="top" width="25%">
      <b>Light RAG DOC Chat 01</b><br>
      <a href="./docs/feature_images/18_Light_RAG_DOC_Chat_01.png" target="_blank"><img src="./docs/feature_images/18_Light_RAG_DOC_Chat_01.png" alt="Light RAG DOC Chat 01"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light RAG DOC Chat Reference RAC</b><br>
      <a href="./docs/feature_images/19_Light_RAG_DOC_Chat_Referenct_RAC.png" target="_blank"><img src="./docs/feature_images/19_Light_RAG_DOC_Chat_Referenct_RAC.png" alt="Light RAG DOC Chat Reference RAC"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light RAG DOC Chat Creation</b><br>
      <a href="./docs/feature_images/20_00_Light_RAG_DOC_Chat_Creation.png" target="_blank"><img src="./docs/feature_images/20_00_Light_RAG_DOC_Chat_Creation.png" alt="Light RAG DOC Chat Creation"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light RAG PDF</b><br>
      <a href="./docs/feature_images/20_01_Light_RAG_PDF.png" target="_blank"><img src="./docs/feature_images/20_01_Light_RAG_PDF.png" alt="Light RAG PDF"></a>
    </td>
  </tr>
  <tr>
    <td valign="top" width="25%">
      <b>Light RAG View Document Chunks</b><br>
      <a href="./docs/feature_images/20_02_Light_RAG_View_Document_chunks.png" target="_blank"><img src="./docs/feature_images/20_02_Light_RAG_View_Document_chunks.png" alt="Light RAG View Document Chunks"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light User Profile Basic Info</b><br>
      <a href="./docs/feature_images/21_Light_User_Profile_Basic_info.png" target="_blank"><img src="./docs/feature_images/21_Light_User_Profile_Basic_info.png" alt="Light User Profile Basic Info"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light User Profile Password</b><br>
      <a href="./docs/feature_images/22_Light_User_Profile_Password.png" target="_blank"><img src="./docs/feature_images/22_Light_User_Profile_Password.png" alt="Light User Profile Password"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light User Profile Language</b><br>
      <a href="./docs/feature_images/23_Light_User_Profile_Language.png" target="_blank"><img src="./docs/feature_images/23_Light_User_Profile_Language.png" alt="Light User Profile Language"></a>
    </td>
  </tr>
  <tr>
    <td valign="top" width="25%">
      <b>Light User Profile Appearance</b><br>
      <a href="./docs/feature_images/24_Light_User_Profile_Appearance.png" target="_blank"><img src="./docs/feature_images/24_Light_User_Profile_Appearance.png" alt="Light User Profile Appearance"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light User Profile Jira Settings</b><br>
      <a href="./docs/feature_images/25_Light_User_Profile_Jira_Settings.png" target="_blank"><img src="./docs/feature_images/25_Light_User_Profile_Jira_Settings.png" alt="Light User Profile Jira Settings"></a>
    </td>
    <td valign="top" width="25%">
      <b>Light User Profile Add Jira Settings</b><br>
      <a href="./docs/feature_images/26_Light_User_Profile_Add_Jira_Settings.png" target="_blank"><img src="./docs/feature_images/26_Light_User_Profile_Add_Jira_Settings.png" alt="Light User Profile Add Jira Settings"></a>
    </td>
