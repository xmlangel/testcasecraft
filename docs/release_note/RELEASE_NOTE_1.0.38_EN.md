...
- **system-out Metadata Extraction**: Analyzes `[METADATA:...]` formats in `<system-out>` logs to automatically recover and apply test specifications (description, steps, expected/actual results).
