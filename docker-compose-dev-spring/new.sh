...
# Test Case Management - Docker Environment (No Build)
...
echo "🚀 Starting Test Case Management - Docker Environment..."
echo "📋 Configuration:"
...
# Docker image will be used (no local JAR check needed)
echo "🔍 Preparing Docker environment..."
echo "✅ Using Docker image for application"
...
echo "   🚀 Start services:    ./new.sh [start]"
echo "   🔄 Restart services:  ./new.sh restart"
echo "   📊 View status:     ./new.sh status"
echo "   📋 View logs:       docker-compose logs -f"
echo "   📋 View app logs:   docker-compose logs -f app"
echo "   🛑 Stop services:   ./new.sh stop"
echo "   🗑️  Clean up:        ./new.sh stop && docker-compose down -v"
echo ""
