// src/main/java/com/testcase/testcasemanagement/controller/TestResultController.java
...
import com.testcase.testcasemanagement.service.TestResultService;
...
public class TestResultController {
    ...
    public ResponseEntity<Map<String, Object>> getTestResultsByProject(@PathVariable String projectId) {
        Map<String, Object> result = testResultService.getTestResultsByProject(projectId);
    ...
    public ResponseEntity<List<Map<String, Object>>> getTestResultsByProjectAndAssignee(@PathVariable String projectId) {
        List<Map<String, Object>> result = testResultService.getTestResultsByProjectAndAssignee(projectId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Map<String, Object>> getTestResultsByTestPlan(@PathVariable String testPlanId) {
        Map<String, Object> result = testResultService.getTestResultsByTestPlan(testPlanId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<List<Map<String, Object>>> getTestResultsByTestPlanAndAssignee(@PathVariable String testPlanId) {
        List<Map<String, Object>> result = testResultService.getTestResultsByTestPlanAndAssignee(testPlanId);
        return ResponseEntity.ok(result);
    }
}
