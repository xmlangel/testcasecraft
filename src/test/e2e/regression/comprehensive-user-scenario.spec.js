...
test.describe("포괄적 사용자 시나리오 E2E 테스트", () => {
  test("전체 사용자 시나리오: 프로젝트 선택부터 스프레드시트 테스트케이스 관리까지", async ({
    page,
    loginPage,
    projectListPage,
    testCasePage,
    ...
    // 저장 성공 메시지 대기
    await page
      .waitForSelector("text=/저장되었습니다|완료/", { timeout: 10000 })
      .catch(() => {});
