...
class TestResultPage extends BasePage {
    ...
    constructor(page, testInfo) {
        ...
        // Result selection
        this.passButton = page.locator('[data-testid="result-selector-button-PASS"]');
        this.failButton = page.locator('[data-testid="result-selector-button-FAIL"]');
        this.blockedButton = page.locator('[data-testid="result-selector-button-BLOCKED"]');
        this.notRunButton = page.locator('[data-testid="result-selector-button-NOTRUN"]');
    ...
    async selectResult(status) {
        const selector = this.page.locator(`[data-testid="result-selector-button-${status.toUpperCase()}"]`);
