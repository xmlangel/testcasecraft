...
public class JiraSmartRedirectIntegrationTest extends AbstractTestNGSpringContextTests {
    ...
    public void testLatestExecutionContext_SingleMatch() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/jira-integration/latest-execution-context")
    ...
    private TestResult createResult(TestExecution execution, String testCaseId, String issueKey,
