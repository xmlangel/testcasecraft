...
public class OrganizationControllerIntegrationTest extends AbstractTestNGSpringContextTests {
    ...
    void setUp() {
        ...
        when(organizationSecurityService.hasOrganizationAdminRole(any(String.class), any(String.class))).thenReturn(true);
        when(organizationSecurityService.canManageOrganization(any(String.class), any(String.class))).thenReturn(true);
        when(organizationSecurityService.canAccessOrganization(any(String.class), any(String.class))).thenReturn(true);
        when(organizationSecurityService.isOrganizationOwner(any(String.class), any(String.class))).thenReturn(true);
        when(organizationSecurityService.canInviteMembers(any(String.class), any(String.class))).thenReturn(true);
    ...
    void 존재하지_않는_조직_접근_시_403_반환() throws Exception {
        ...
        when(organizationSecurityService.isOrganizationMember(any(String.class), any(String.class))).thenReturn(false);
        when(organizationSecurityService.isOrganizationOwner(any(String.class), any(String.class))).thenReturn(false);
