...
@Feature("테스트플랜")
@ActiveProfiles("test")
public class TestPlanControllerJsonSchemaTest
  ...
  public void globalSetup() throws Exception {
    ...
    // 스키마 파일 로드
    try (InputStream is =
        getClass().getClassLoader().getResourceAsStream("schemas/testplan-schema.json")) {
      testPlanSchema = new String(is.readAllBytes(), StandardCharsets.UTF_8);
    }

    try (InputStream is =
        getClass().getClassLoader().getResourceAsStream("schemas/testplan-list-schema.json")) {
  ...
  public void createTestPlanTest() {
    ...
    requestBody.put(
        "testCaseIds",
        new String[] {
          "ba0f5d9c-1486-45cd-bcbe-a4425d688700", "45e3c021-1e46-4e96-b5ca-7507e57ae8fd"
        });
  ...
  public void updateTestPlanTest() {
    ...
    updateBody.put(
        "testCaseIds",
        new String[] {
          "f6912b8f-b10a-4c1a-8dd2-67dfeb9eee97", "adc6a5ee-e809-46bd-8c44-83e8ac182172"
        });
