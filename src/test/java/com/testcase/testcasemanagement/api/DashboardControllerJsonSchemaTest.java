...
@Feature("대시보드 관리")
@ActiveProfiles("test")
public class DashboardControllerJsonSchemaTest
  ...
  public void globalSetup() throws Exception {
    ...
    try (InputStream is =
        getClass().getClassLoader().getResourceAsStream("schemas/project-statistics-schema.json")) {
        ...
        given()
            ...
            .get(
                "/api/dashboard/projects/"
                    ...
                    + "/open-test-runs/assignee-results")
            .then()
            .statusCode(200)
            .body(matchesJsonSchema(openTestRunAssigneeResultsSchema))
            .body("size()", equalTo(0)) // 빈 배열이어야 함
