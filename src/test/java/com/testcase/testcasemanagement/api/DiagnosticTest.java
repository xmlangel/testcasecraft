...
public class DiagnosticTest extends AbstractTestNGSpringContextTests {
    ...
    public void listUsers() {
        ...
        if (users.isEmpty()) {
            ...
            for (User user : users) {
                System.out.println("Username: " + user.getUsername() + ", Role: " + user.getRole() + ", Active: "
                        + user.getIsActive());
                System.out.println("Stored Hash: " + user.getPassword());
                System.out.println("Matches 'admin123': " + passwordEncoder.matches("admin123", user.getPassword()));
                System.out.println("Matches 'admin': " + passwordEncoder.matches("admin", user.getPassword()));
                System.out.println("Matches 'password': " + passwordEncoder.matches("password", user.getPassword()));
                System.out.println("Matches 'tester123': " + passwordEncoder.matches("tester123", user.getPassword()));
            }
        }
