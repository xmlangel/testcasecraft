...
@Feature("확장된 프로젝트 관리")
@ActiveProfiles("test")
public class ProjectControllerExtendedJsonSchemaTest
  ...
  void testCreateProject_DuplicateCode() {
    // Given - 먼저 프로젝트 하나 생성
    Map<String, Object> firstProject =
        Map.of(
            "name", "First Project",
            "code", "DUPLICATE001",
    ...
    Map<String, Object> duplicateProject =
        Map.of(
            "name", "Second Project",
  ...
  void testTransferProject() {
    ...
    Map<String, String> transferData = Map.of("organizationId", newOrganization.getId());
