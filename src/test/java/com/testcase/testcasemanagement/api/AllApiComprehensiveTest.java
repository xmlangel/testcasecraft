 ...
 * 전체 API 종합 테스트
 *
 * <p>이 테스트는 모든 컨트롤러의 API 엔드포인트를 체계적으로 검증합니다. TestNG 그룹 "api-comprehensive-test"로 분리되어 있어 기본 빌드에 영향을
 * 주지 않습니다.
 *
 * <p>실행 방법: - API 종합 테스트만 실행: ./gradlew apiComprehensiveTest - 전체 실행: ./gradlew test
 * -Dgroups="api-comprehensive-test" - 기본 빌드 (종합 테스트 제외): ./gradlew test 또는 ./gradlew build
 *
 * <p>테스트 대상 컨트롤러 (26개 - 모든 컨트롤러): 1. AuthController - 인증 및 사용자 등록 2. ProjectController - 프로젝트 관리 3.
 * TestCaseController - 테스트케이스 관리 4. TestPlanController - 테스트플랜 관리 5. TestExecutionController - 테스트
 * 실행 6. TestExecutionIndividualController - 개별 테스트 실행 7. TestResultApiController - 테스트 결과 API v2 8.
 * TestResultReportController - 테스트 결과 리포트 9. TestResultEditController - 테스트 결과 편집 10.
 * DashboardController - 대시보드 11. OrganizationController - 조직 관리 12. GroupController - 그룹 관리 13.
 * UserManagementController - 사용자 관리 14. UserActivityController - 사용자 활동 15.
 * UserPermissionController - 사용자 권한 16. JiraIntegrationController - JIRA 통합 17.
 * JiraConfigController - JIRA 설정 18. JiraStatusController - JIRA 상태 19. JiraMonitoringController -
 * JIRA 모니터링 20. JiraBatchController - JIRA 배치 21. JunitResultController - JUnit 결과 22.
 * JunitVersionController - JUnit 버전 23. MonitoringController - 모니터링 24. MailController - 메일 25.
 * AuditLogController - 감사 로그 26. RagController - RAG 공통 문서 관리 (**v6.0 신규**)
 *
 * <p>총 테스트 케이스: 184개 (59개 → 75개 → 123개 → 158개 → 178개 → 184개로 확장) 테스트 그룹: auth, project, testcase,
 * testplan, testexecution, dashboard, organization, group, user, user-permission, test-result,
 * test-result-api, test-result-edit, junit, jira-integration, jira-config, jira-status,
 * jira-monitoring, jira-batch, mail, junit-version, audit, monitoring, rag, security, final
 *
 * <p>주요 업데이트 (v5.0): - AuthController: 9/9 엔드포인트 (100% 커버리지) - TestPlanController: 5/5 엔드포인트 (100%
 * 커버리지) - JiraStatusController: 5/5 엔드포인트 (100% 커버리지) - JiraBatchController: 5/5 엔드포인트 (100% 커버리지)
 * - TestCaseController: 10/10 엔드포인트 (100% 커버리지) - TestResultApiController: 10/10 엔드포인트 (100% 커버리지)
 * - GroupController: 12/12 엔드포인트 (100% 커버리지) - DashboardController: 14/14 엔드포인트 (100% 커버리지) -
 * UserPermissionController: 21/21 엔드포인트 (100% 커버리지) - TestResultReportController: 15/15 엔드포인트 (100%
 * 커버리지) - JunitResultController: 14/14 엔드포인트 (100% 커버리지) - JiraConfigController: 11/11 엔드포인트 (100%
 * 커버리지) - JiraIntegrationController: 9/9 엔드포인트 (100% 커버리지) - **v5.0 신규** - AuditLogController:
 * 13/13 엔드포인트 (100% 커버리지) - **v5.0 신규** - MonitoringController: 3/3 엔드포인트 (100% 커버리지) - **v5.0 신규**
 *
 * <p>v6.0: 6개의 새로운 테스트 추가 (RagController 공통 문서 관리 API) v5.0: 20개의 새로운 테스트 추가 (3개 컨트롤러 100% 커버리지 달성)
 * v4.0: 35개의 새로운 테스트 추가 (3개 컨트롤러 100% 커버리지 달성) v3.0: 48개의 새로운 테스트 추가 (5개 컨트롤러 100% 커버리지 달성)
 */
...
public class AllApiComprehensiveTest extends AbstractTestNGSpringContextTests {
  ...
  private void waitForServerReady() {
    ...
    for (int i = 0; i < maxRetries; i++) {
      try {
        ...
        System.out.println(
            "Waiting for server to be ready on port "
                + port
                + "... (Attempt "
                + (i + 1)
                + "/"
  ...
  @Test(
      groups = {"api-comprehensive-test", "auth"},
      priority = 1)
  @Story("사용자 인증")
  ...
  @Test(
      groups = {"api-comprehensive-test", "auth"},
      priority = 1,
      dependsOnMethods = "testAuthLogin")
  @Story("사용자 인증")
  ...
  @Test(
      groups = {"api-comprehensive-test", "project"},
      priority = 2)
  @Story("프로젝트 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "testcase"},
      priority = 3,
      dependsOnMethods = "testCreateAndGetProject")
  @Story("테스트케이스 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "testcase"},
      priority = 3,
      dependsOnMethods = "testCreateTestCase")
  @Story("테스트케이스 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "testcase"},
      priority = 3,
      dependsOnMethods = {"testGetTestCaseById", "testUpdateTestCase"})
  @Story("테스트케이스 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "testplan"},
      priority = 4,
      dependsOnMethods = "testCreateAndGetProject")
  @Story("테스트플랜 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "testplan"},
      priority = 4,
      dependsOnMethods = "testCreateTestPlan")
  @Story("테스트플랜 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "testplan"},
      priority = 4,
      dependsOnMethods = {"testGetTestPlanById", "testUpdateTestPlan"})
  @Story("테스트플랜 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "testexecution"},
      priority = 5,
      dependsOnMethods = "testCreateTestPlan")
  @Story("테스트 실행")
  ...
  public void testUpdatePreviousTestResultUnauthorized() {
    ...
    try {
      ...
      io.restassured.response.Response loginResp =
          given().contentType(ContentType.JSON).body(loginRequest).when().post("/api/auth/login");

      if (loginResp.getStatusCode() != 200) {
        System.out.println(
            "⚠️ TESTER account not available (status: "
                + loginResp.getStatusCode()
                + "), skipping unauthorized test");
        return;
      }
  ...
  @Test(
      groups = {"api-comprehensive-test", "dashboard"},
      priority = 6)
  @Story("대시보드")
  ...
  @Test(
      groups = {"api-comprehensive-test", "organization"},
      priority = 7)
  @Story("조직 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "group"},
      priority = 8,
      dependsOnMethods = "testCreateAndGetProject")
  @Story("그룹 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "group"},
      priority = 8,
      dependsOnMethods = "testCreateOrganization")
  @Story("그룹 관리")
  ...
  public void testInviteGroupMember() {
    Map<String, String> inviteRequest =
        Map.of(
  ...
  @Test(
      groups = {"api-comprehensive-test", "user"},
      priority = 9)
  @Story("사용자 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "user-activity"},
      priority = 10)
  @Story("사용자 활동")
  ...
  @Test(
      groups = {"api-comprehensive-test", "monitoring"},
      priority = 11)
  @Story("모니터링")
  ...
  @Test(
      groups = {"api-comprehensive-test", "test-result"},
      priority = 12,
      dependsOnMethods = "testCreateAndGetProject")
  @Story("테스트 결과 리포트")
  ...
  public void testExportTestResultReport() {
    Map<String, Object> filter =
        Map.of(
            "projectId",
            testProjectId != null ? testProjectId : "test-project",
            "exportFormat",
            "EXCEL");
    given()
        .header("Authorization", "Bearer " + jwtToken)
  ...
  @Test(
      groups = {"api-comprehensive-test", "junit"},
      priority = 13,
      dependsOnMethods = "testCreateAndGetProject")
  @Story("JUnit 결과")
  ...
  @Test(
      groups = {"api-comprehensive-test", "audit"},
      priority = 14)
  @Story("감사 로그")
  ...
  @Test(
      groups = {"api-comprehensive-test", "test-execution-individual"},
      priority = 15,
      dependsOnMethods = "testCreateTestPlan")
  @Story("개별 테스트 실행")
  ...
  @Test(
      groups = {"api-comprehensive-test", "test-result-api"},
      priority = 16)
  @Story("테스트 결과 API v2")
  ...
  public void testGetComprehensiveStatistics() {
    Map<String, Object> statsRequest = Map.of("includeCharts", true);
  ...
  public void testExportTestResults() {
    Map<String, Object> exportRequest = Map.of("format", "JSON");
  ...
  @Test(
      groups = {"api-comprehensive-test", "test-result-edit"},
      priority = 17)
  @Story("테스트 결과 편집")
  ...
  @Test(
      groups = {"api-comprehensive-test", "user-permission"},
      priority = 18)
  @Story("사용자 권한")
  ...
  public void testValidatePermissionChanges() {
    List<Map<String, String>> changes =
        List.of(
            Map.of(
                "userId", "user1", "action", "ADD_TO_ORG", "targetId", "org1", "role", "MEMBER"));
    given()
        .header("Authorization", "Bearer " + jwtToken)
        .contentType(ContentType.JSON)
        .body(changes)
  ...
  public void testExecuteCsvChanges() {
    List<Map<String, String>> validatedChanges =
        List.of(
            Map.of(
                "userId", "user1", "action", "ADD_TO_ORG", "targetId", "org1", "role", "MEMBER"));
    given()
  ...
  @Test(
      groups = {"api-comprehensive-test", "mail"},
      priority = 19)
  @Story("메일")
  ...
  @Test(
      groups = {"api-comprehensive-test", "junit-version"},
      priority = 20)
  @Story("JUnit 버전 관리")
  ...
  @Test(
      groups = {"api-comprehensive-test", "jira-integration"},
      priority = 21)
  @Story("JIRA 통합")
  ...
  @Test(
      groups = {"api-comprehensive-test", "jira-config"},
      priority = 22)
  @Story("JIRA 설정")
  ...
  public void testSearchJiraIssues() {
    Map<String, Object> searchRequest =
        Map.of("query", "project = ICT AND status = Open", "maxResults", 50);
    given()
        .header("Authorization", "Bearer " + jwtToken)
        .contentType(ContentType.JSON)
        .body(searchRequest)
  ...
  @Test(
      groups = {"api-comprehensive-test", "jira-status"},
      priority = 23,
      dependsOnMethods = "testCreateAndGetProject")
  @Story("JIRA 상태")
  ...
  @Test(
      groups = {"api-comprehensive-test", "jira-monitoring"},
      priority = 24)
  @Story("JIRA 모니터링")
  ...
  @Test(
      groups = {"api-comprehensive-test", "jira-batch"},
      priority = 25)
  @Story("JIRA 배치")
  ...
  public void testBatchAddComments() {
    Map<String, Object> comment1 =
        Map.of(
            "issueKey", "ICT-123",
            "comment", "Test comment 1");
    Map<String, Object> comment2 =
        Map.of(
            "issueKey", "ICT-456",
            "comment", "Test comment 2");
    Map<String, Object> batchRequest = Map.of("comments", List.of(comment1, comment2));
  ...
  public void testBatchGetProjects() {
    Map<String, Object> batchRequest = Map.of("userIds", List.of("user1", "user2"));
  ...
  public void testBatchTestConnections() {
    Map<String, Object> batchRequest = Map.of("configIds", List.of("config1", "config2"));
  ...
  @Test(
      groups = {"api-comprehensive-test", "rag"},
      priority = 26)
  @Story("RAG 공통 문서")
  ...
  public void testUploadGlobalDocument() {
    // 테스트용 텍스트 파일 생성
    String testContent =
        "This is a global RAG document for testing.\n"
            + "공통 문서 테스트를 위한 내용입니다.\n"
  ...
  @Test(
      groups = {"api-comprehensive-test", "security"},
      priority = 30)
  @Story("보안")
  ...
  @Test(
      groups = {"api-comprehensive-test", "final"},
      priority = 99)
  @Story("종합 테스트")
