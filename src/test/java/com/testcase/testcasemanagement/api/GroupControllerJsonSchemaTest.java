...
@Feature("그룹 관리")
@ActiveProfiles("test")
public class GroupControllerJsonSchemaTest extends AbstractTestNGSpringContextTests {
  ...
  void setUp() {
    ...
    testUser.setName("Test User " + uniqueId);
    ...
    testOrganization.setName("Test Org " + uniqueId);
    ...
    testProject.setName("Test Proj " + uniqueId);
    testProject.setCode("T" + uniqueId.toUpperCase());
  ...
  private String getAuthToken() {
    Response response =
        given()
            ...
            .body(Map.of("username", testUser.getUsername(), "password", "password123"))
            .when()
            .post("/api/auth/login")
            .then()
  ...
  void testCreateGroup_InvalidData() {
    ...
    Map<String, String> invalidData = Map.of("description", "Test Description");
  ...
  void testGetGroupsByOrganization() {
    ...
    given()
        ...
        .body(
            "findAll { it.organization?.id == '" + testOrganization.getId() + "' }.size()",
  ...
  void testGetGroupsByProject() {
    ...
    given()
        ...
        .body("size()", greaterThanOrEqualTo(2))
        .body(
            "findAll { it.project?.id == '" + testProject.getId() + "' }.size()",
            greaterThanOrEqualTo(2));
  }
  ...
  private String createTestGroup(
      String name, String description, String organizationId, String projectId) {
