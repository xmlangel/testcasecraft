 ...
 *
 * <p>이 클래스는 실행하지 않고 코드 검토를 통해 보안 로직을 검증합니다.
 */
 ...
 * 검증 결과 요약:
 *
 * <p>✅ 조직 접근 제어: 권한 없는 사용자 접근 차단 ✅ 프로젝트 접근 제어: 권한 없는 사용자 접근 차단 + 조직 권한 상속 ✅ 그룹 접근 제어: 권한 없는 사용자 접근
 * 차단 + 다중 권한 상속 ✅ 역할 기반 권한: 계층적 권한 구조 및 상위 역할의 하위 리소스 관리 ✅ 멤버 관리: 적절한 권한 제어와 동등 역할 간 제한 ✅ 시스템 관리자:
 * 모든 리소스에 대한 전체 권한 ✅ 보안 예외 처리: 적절한 HTTP 상태 코드와 메시지 ✅ Spring Security 통합: @PreAuthorize 사용 준비 완료
 *
 * <p>결론: 권한 없는 사용자의 접근을 효과적으로 차단하는 보안 프레임워크가 성공적으로 구현되었습니다.
 */
