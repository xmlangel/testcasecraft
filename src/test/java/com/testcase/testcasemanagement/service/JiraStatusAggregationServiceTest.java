...
public class JiraStatusAggregationServiceTest {
  ...
  @Mock private JiraApiService jiraApiService;
  ...
  public void setUp() {
    ...
    jiraStatusAggregationService =
        new JiraStatusAggregationService(
  ...
  public void testGetProjectJiraStatusSummary_EmptyResults() {
    ...
    List<JiraStatusSummaryDto> result =
        jiraStatusAggregationService.getProjectJiraStatusSummary("admin", projectId);
  ...
  @Test(
      description = "JIRA 상태 동기화 - 사용자 설정 없음 시 예외 발생 (Fallback 비활성화)",
      expectedExceptions = IllegalStateException.class,
      expectedExceptionsMessageRegExp = "JIRA_CONFIG_MISSING")
  ...
  public void testGetProjectJiraStatusSummary_WithValidJiraIds() throws Exception {
    ...
    com.testcase.testcasemanagement.model.JiraConfig mockConfigEntity =
        mock(com.testcase.testcasemanagement.model.JiraConfig.class);
  ...
  public void testBatchGetJiraIssueInfo_ValidIds() throws Exception {
    ...
    Map<String, JsonNode> result =
        jiraStatusAggregationService.batchGetJiraIssueInfo("admin", jiraIds);

    // Then
    assertNotNull(result);
    assertFalse(result.isEmpty());
    verify(jiraApiService, atLeastOnce())
        .searchIssues(anyString(), anyString(), anyString(), anyString(), anyInt());
  }
  ...
  public void testRefreshProjectJiraStatus() {
    ...
    // When
    List<JiraStatusSummaryDto> result =
        jiraStatusAggregationService.refreshProjectJiraStatus("admin", projectId);
  ...
  private List<TestResult> createMockTestResults() {
    ...
    com.testcase.testcasemanagement.model.TestExecution mockExecution =
        mock(com.testcase.testcasemanagement.model.TestExecution.class);
    com.testcase.testcasemanagement.model.Project mockProject =
        mock(com.testcase.testcasemanagement.model.Project.class);
  ...
  @Test(
      description = "JIRA 상태 동기화 - 설정 없음 (예외 발생)",
      expectedExceptions = IllegalStateException.class,
      expectedExceptionsMessageRegExp = "JIRA_CONFIG_MISSING")
