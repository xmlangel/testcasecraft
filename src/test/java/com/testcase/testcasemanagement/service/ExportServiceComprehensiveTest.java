...
public class ExportServiceComprehensiveTest {
    ...
    public void testLargeDataPdfGeneration() {
        ...
        try {
            ...
            System.out.println("  - 평균 처리 속도: " + (100.0 / (endTime - startTime) * 1000) + " records/sec");
    ...
    public void testComplexKoreanTextPdf() {
        ...
        complexResult.setNotes("복잡한 한글 내용입니다. " +
                "줄바꿈이 포함된 내용, " +
                "특수문자 !@#$%^&*()_+-=[]{}|;':\",./<>? " +
                "그리고 이모지도 포함 🎉✅❌📊💡");
    ...
    public void testAllFormatsPerformance() {
        ...
        try {
            ...
            System.out.println("  - 총 처리시간: " + ((pdfEnd - pdfStart) + (excelEnd - excelStart) + (csvEnd - csvStart)) + "ms");
