...
public class JunitXmlParserServiceTest {
        ...
        public void testParseStructuredJunitXml() throws Exception {
                // Given
                String structuredXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                                "<testsuites>\n" +
                                "  <testsuite name=\"PostgreSQL Regression Tests\" tests=\"2\" failures=\"1\" errors=\"0\" skipped=\"0\">\n"
                                +
                                "    <testcase name=\"plisql\" classname=\"parallel group (2 tests)\" time=\"0.12\">\n"
                                +
                ...
                // When
                JunitTestResult result = parserService.parseJunitXml(
                                xmlStream, "structured.xml", "test-project", testUser);
        ...
        public void testParseStepAttributeJunitXml() throws Exception {
                ...
                String stepXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                // When
                JunitTestResult result = parserService.parseJunitXml(
                                xmlStream, "step.xml", "test-project", testUser);
        ...
        public void testParseRobustJunitXml() throws Exception {
                ...
                String robustXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                // When
                JunitTestResult result = parserService.parseJunitXml(
                                xmlStream, "robust.xml", "test-project", testUser);
        ...
        public void testParsePropertiesJunitXml() throws Exception {
                // Given
                String propertiesXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                                ...
                                "      <property name=\"Step\" value=\"1. BTC 15m 캔들 스냅샷을 고정한다 | 2. btc_up 및 block_new_entry를 계산한다\" />\n"
                                +
                                "      <property name=\"ExpectedResult\" value=\"block_new_entry가 bool이며 계산 흐름이 정상 동작한다\" />\n"
                                +
                ...
                // When
                JunitTestResult result = parserService.parseJunitXml(
                                xmlStream, "properties.xml", "test-project", testUser);
        ...
        public void testParseMetadataFromSystemOut() throws Exception {
                ...
                String metadataXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                                ...
                                "  <testcase name=\"initialize returns true when drive helper initializes successfully\" classname=\"uk.xmlangel.googledrivesync.sync.SyncManagerTest\" time=\"4.1\">\n"
                                +
                                "    <system-out>\n" +
                                "[METADATA:initialize returns true when drive helper initializes successfully:description=서비스 초기화 검증]\n"
                                +
                                "[METADATA:initialize returns true when drive helper initializes successfully:step=1. DriveServiceHelper 목킹 | 2. initialize() 호출 | 3. 반환값 확인]\n"
                                +
                                "[METADATA:initialize returns true when drive helper initializes successfully:expected_result=DriveServiceHelper가 성공하면 true를 반환한다]\n"
                                +
                                "[METADATA:initialize returns true when drive helper initializes successfully:actual_result=FAIL: FORCED FAILURE FOR VERIFICATION]\n"
                                +
                                "    </system-out>\n" +
                                "  </testcase>\n" +
                                "</testsuite>";
                ...
                // When
                JunitTestResult result = parserService.parseJunitXml(
                                xmlStream, "metadata.xml", "test-project", testUser);
        ...
        public void testParseSuccessStepsJunitXml() throws Exception {
                ...
                String successXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                                ...
                                "  <testcase name=\"test_success_with_steps\" classname=\"SuccessClass\" time=\"0.2\">\n"
                                +
                ...
                // When
                JunitTestResult result = parserService.parseJunitXml(
                                xmlStream, "success_steps.xml", "test-project", testUser);
        ...
        public void testParseLegacyStepsFormat() throws Exception {
                ...
                // When
                JunitTestResult result = parserService.parseJunitXml(
                                xmlStream, "legacy_steps.xml", "test-project", testUser);
