 ...
 *
 * <p>프로젝트코드-넘버 형식의 Display ID 생성 기능을 테스트합니다.
 */
public class TestCaseDisplayIdServiceTest {
  ...
  public void testExtractSequenceFromDisplayId() {
    Assert.assertEquals(
        displayIdService.extractSequenceFromDisplayId("TEST-001"), Integer.valueOf(1));
    Assert.assertEquals(
        displayIdService.extractSequenceFromDisplayId("PROJ-999"), Integer.valueOf(999));
    Assert.assertEquals(
        displayIdService.extractSequenceFromDisplayId("WEB-042"), Integer.valueOf(42));
