...
public class DatabaseInitializer {
    ...
    private void initOrganizations() {
        ...
        // 조직-사용자 연결 초기화
        jdbcTemplate.execute("DELETE FROM organization_users WHERE organization_id IN ('qa-org-id-2025', 'dev-org-id-2025', 'devops-org-id-2025')");
        
        jdbcTemplate.execute("INSERT INTO organization_users (id, organization_id, user_id, role_in_organization, created_at, updated_at) VALUES " +
    ...
    private void initProjects() {
        ...
        // 프로젝트 MERGE
        jdbcTemplate.execute("MERGE INTO projects (id, name, code, description, organization_id, display_order, created_at, updated_at) " +
            "KEY(name) VALUES " +
        ...
        // 프로젝트-사용자 권한 초기화
        jdbcTemplate.execute("DELETE FROM project_users WHERE project_id IN ('main-project-id-2025', 'qa-auto-project-id-2025', 'api-project-id-2025')");
        
        jdbcTemplate.execute("INSERT INTO project_users (id, project_id, user_id, role_in_project, created_at, updated_at) VALUES " +
    ...
    private void initTestCases() {
        ...
        jdbcTemplate.execute("INSERT INTO testcases (id, name, type, description, priority, status, project_id, created_at, updated_at, display_order, execution_time) VALUES " +
    ...
    private void initTestPlans() {
        ...
        // 각 프로젝트별 테스트플랜 생성
        jdbcTemplate.execute("INSERT INTO testplans (id, name, description, status, project_id, created_at, updated_at, start_date, end_date, created_by) VALUES " +
        ...
        jdbcTemplate.execute("INSERT INTO testplan_testcases (id, testplan_id, testcase_id, execution_order, created_at, updated_at) VALUES " +
    ...
    private void initTestExecutions() {
        ...
        jdbcTemplate.execute("INSERT INTO test_executions (id, testplan_id, name, description, status, executed_by, started_at, completed_at, created_at, updated_at) VALUES " +
            // 메인 프로젝트 실행 이력
    ...
    private void initTestResults() {
        ...
        jdbcTemplate.execute("INSERT INTO test_results (id, test_execution_id, testcase_id, status, notes, executed_by, executed_at, created_at, updated_at, execution_duration, failure_reason) VALUES " +
