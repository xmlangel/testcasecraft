...
public interface LanguageRepository extends JpaRepository<Language, String> {
  ...
  List<Language> searchByKeywordAndActiveStatus(
      @Param("keyword") String keyword, @Param("isActive") Boolean isActive);

  // 정렬 순서 범위 내 언어들 조회
  @Query(
      "SELECT l FROM Language l WHERE l.sortOrder BETWEEN :minOrder AND :maxOrder ORDER BY"
          + " l.sortOrder ASC")
  List<Language> findBySortOrderBetween(
      @Param("minOrder") Integer minOrder, @Param("maxOrder") Integer maxOrder);
