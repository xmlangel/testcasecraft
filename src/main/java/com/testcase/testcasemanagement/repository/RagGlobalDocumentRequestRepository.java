...
public interface RagGlobalDocumentRequestRepository
    extends JpaRepository<RagGlobalDocumentRequest, String> {

  List<RagGlobalDocumentRequest> findByStatusOrderByCreatedAtAsc(
      RagGlobalDocumentRequestStatus status);

  Optional<RagGlobalDocumentRequest> findTopByDocumentIdAndStatusOrderByCreatedAtDesc(
      java.util.UUID documentId, RagGlobalDocumentRequestStatus status);
}
