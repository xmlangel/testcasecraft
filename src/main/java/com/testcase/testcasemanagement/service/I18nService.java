...
public class I18nService {
  ...
  public String getTranslation(String keyName, String languageCode, boolean useFallback) {
    ...
    if (!defaultLanguage.getCode().equals(languageCode)) {
      Optional<Translation> defaultTranslation =
          translationRepository.findByKeyNameAndLanguageCode(keyName, defaultLanguage.getCode());
  ...
  public Map<String, String> getTranslationsByCategory(String languageCode, String category) {
    List<Translation> translations =
        translationRepository.findByLanguageCodeAndCategory(languageCode, category);
    Map<String, String> translationMap = new HashMap<>();
  ...
  @CacheEvict(
      value = {"translations", "translationsByCategory", "translationStats"},
      allEntries = true)
  ...
  @CacheEvict(
      value = {"activeLanguages", "defaultLanguage", "languages"},
      allEntries = true)
