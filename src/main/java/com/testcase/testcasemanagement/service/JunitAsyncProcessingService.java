...
public class JunitAsyncProcessingService {
    ...
    private JunitTestResult parseWithProgressTracking(String filePath, JunitTestResult testResult, 
        ...
        try (InputStream inputStream = fileStorageService.loadFileAsInputStream(filePath)) {
            ...
            throw new JunitXmlParserService.JunitXmlParsingException("Failed to parse with streaming: " + e.getMessage(), e);
        }
    }
    ...
    public static class ProcessingProgress {
        ...
        public int getParsingCurrent() { return parsingCurrent; }
        public void setParsingCurrent(int parsingCurrent) { this.parsingCurrent = parsingCurrent; }
        
        public int getParsingTotal() { return parsingTotal; }
        public void setParsingTotal(int parsingTotal) { this.parsingTotal = parsingTotal; }
        
        public boolean isCompleted() { return currentStep >= totalSteps && !failed; }
    }
}