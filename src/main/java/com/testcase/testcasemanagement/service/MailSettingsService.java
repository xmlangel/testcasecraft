...
public class MailSettingsService {
  ...
  public void testMailSettings(String testRecipient, String adminUser) {
    try {
      ...
      org.springframework.mail.javamail.JavaMailSender dynamicMailSender =
          createDynamicMailSender(settings);
  ...
  private org.springframework.mail.javamail.JavaMailSender createDynamicMailSender(
      MailSettings settings) {
