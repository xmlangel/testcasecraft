...
public class TestCaseDisplayIdMigrationService {
  ...
  /** 애플리케이션 시작 시 자동으로 실행되는 마이그레이션 displayId가 null인 모든 테스트 케이스에 대해 Display ID를 생성합니다. */
  ...
  public int migrateByProject(String projectId) {
    ...
    List<TestCase> testCasesWithoutDisplayId =
        testCaseRepository.findByProjectIdAndDisplayIdIsNull(projectId);
