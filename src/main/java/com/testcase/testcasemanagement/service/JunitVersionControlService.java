...
public class JunitVersionControlService {
  ...
  public FileRestoreResult restoreVersion(String testResultId, int versionNumber, String targetPath)
    ...
    try {
      ...
      if (!targetVersion.getChecksum().equals(restoredChecksum)) {
        logger.warn(
            "복원된 파일의 체크섬이 일치하지 않음 - 원본: {}, 복원: {}", targetVersion.getChecksum(), restoredChecksum);
      }
  ...
  /** 백업 생성 */
  public BackupResult createBackup(String testResultId, FileVersion version)
      throws VersionControlException {
    try {
  ...
  private void updateVersionHistory(String testResultId, FileVersion version)
  ...
  public static class FileRestoreResult {
    ...
    // Getters and Setters
    public FileVersion getRestoredVersion() {
      return restoredVersion;
    }

    public void setRestoredVersion(FileVersion restoredVersion) {
  ...
  public static class VersionDiff {
    ...
    public void setVersion1(FileVersion version1) {
    ...
    public void setVersion2(FileVersion version2) {
  ...
  public static class StorageStatistics {
    ...
    // Getters and Setters
    public long getVersionFileCount() {
      return versionFileCount;
    }

    public void setVersionFileCount(long versionFileCount) {
      this.versionFileCount = versionFileCount;
    }
    ...
    public long getVersionStorageSize() {
      return versionStorageSize;
    }

    public void setVersionStorageSize(long versionStorageSize) {
      this.versionStorageSize = versionStorageSize;
    }
    ...
    public void setBackupStorageSize(long backupStorageSize) {
