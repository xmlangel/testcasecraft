...
/** ICT-134: 대시보드 모니터링 서비스 메트릭 수집, 성능 측정, 사용자 세션 추적 등의 기능을 제공합니다. */
@Service
public class MonitoringService {

  private static final Logger logger = LoggerFactory.getLogger(MonitoringService.class);

  @Autowired private Timer dashboardApiTimer;

  @Autowired private Counter dashboardApiCallCounter;

  @Autowired private Counter dashboardCacheHitCounter;

  @Autowired private Counter dashboardCacheMissCounter;

  @Autowired private AtomicLong concurrentUsersCounter;

  @Autowired private Counter dashboardDataSuccessCounter;

  @Autowired private Counter dashboardDataFailureCounter;

  @Autowired private Timer dashboardStatisticsTimer;

  @Autowired private Timer dashboardQueryTimer;
