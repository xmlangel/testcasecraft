...
public class TranslationManagementController {
  ...
  public ResponseEntity<Language> createLanguage(
    ...
    Language language =
        translationManagementService.createLanguage(
            request.code, request.name, request.nativeName, request.isDefault, request.sortOrder);
  ...
  public ResponseEntity<Language> updateLanguage(
      @PathVariable String languageId, @Valid @RequestBody UpdateLanguageRequest request) {

    Language language =
        translationManagementService.updateLanguage(
            languageId,
            request.name,
            request.nativeName,
            request.isActive,
  ...
  public ResponseEntity<Map<String, Object>> getAllTranslationKeys(
    ...
    Map<String, Object> result =
        translationManagementService.searchTranslationKeysWithPagination(
  ...
  public ResponseEntity<List<Map<String, Object>>> getCategoryTranslationCompletionStats() {
    List<Map<String, Object>> stats =
        translationManagementService.getCategoryTranslationCompletionStats();
    return ResponseEntity.ok(stats);
  }
  ...
  public ResponseEntity<List<Map<String, Object>>> getCategoryCompletionStatsByLanguage(
    ...
    List<Map<String, Object>> stats =
        translationManagementService.getCategoryCompletionStatsByLanguage(languageCode);
    return ResponseEntity.ok(stats);
  }
  ...
  public ResponseEntity<List<Map<String, Object>>> getLanguageCompletionStatsByCategory(
    ...
    List<Map<String, Object>> stats =
        translationManagementService.getLanguageCompletionStatsByCategory(category);
    return ResponseEntity.ok(stats);
  }
  ...
  public ResponseEntity<TranslationKey> createTranslationKey(
    ...
    TranslationKey translationKey =
        translationManagementService.createTranslationKey(
            request.keyName, request.category, request.description, request.defaultValue);
  ...
  public ResponseEntity<TranslationKey> updateTranslationKey(
      @PathVariable String keyId, @Valid @RequestBody UpdateTranslationKeyRequest request) {

    TranslationKey translationKey =
        translationManagementService.updateTranslationKey(
            keyId, request.category, request.description, request.defaultValue, request.isActive);
    return ResponseEntity.ok(translationKey);
  }
  ...
  public ResponseEntity<Map<String, Object>> getTranslationsWithPagination(
    ...
    Map<String, Object> result =
        translationManagementService.searchTranslationsWithPagination(
  ...
  public ResponseEntity<List<Translation>> getTranslationsByLanguage(
      @PathVariable String languageCode) {
    List<Translation> translations =
        translationManagementService.getTranslationsByLanguage(languageCode);
    return ResponseEntity.ok(translations);
  }
  ...
  public ResponseEntity<?> createOrUpdateTranslation(
      @Valid @RequestBody CreateTranslationRequest request, Authentication authentication) {

    try {
      String updatedBy = authentication.getName();
      Translation translation =
          translationManagementService.createOrUpdateTranslation(
              request.keyName, request.languageCode, request.value, request.context, updatedBy);
  ...
  public ResponseEntity<Map<String, String>> updateTranslationStatus(
      @PathVariable String translationId, @RequestBody Map<String, Boolean> request) {
  ...
  public ResponseEntity<Map<String, Object>> batchCreateTranslations(
      @Valid @RequestBody List<CreateTranslationRequest> requests, Authentication authentication) {
    ...
    Map<String, Object> result =
        translationManagementService.batchCreateTranslations(translationData, updatedBy);
    return ResponseEntity.ok(result);
  }
  ...
  public ResponseEntity<Map<String, Object>> getTranslationProgress(
      @PathVariable String languageCode) {
    Map<String, Object> progress =
        translationManagementService.getTranslationProgress(languageCode);
  ...
  public ResponseEntity<byte[]> exportTranslationsAsCsv(
    ...
    try {
      ...
      return ResponseEntity.ok().headers(headers).body(csvContent.getBytes("UTF-8"));
  ...
  public ResponseEntity<Map<String, Object>> importTranslationsFromCsv(
    ...
    try {
      ...
      String updatedBy = authentication.getName();
      Map<String, Object> result =
          translationManagementService.importTranslationsFromCsv(
  ...
  public static class CreateLanguageRequest {
    ...
    @NotBlank public String nativeName;
  ...
  public static class CreateTranslationKeyRequest {
    @NotBlank public String keyName;
  ...
  public static class CreateTranslationRequest {
    ...
    @NotBlank public String languageCode;
