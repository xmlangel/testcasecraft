...
public class TestResultAttachmentController {
  ...
  public ResponseEntity<?> uploadFile(
      ...
      @Parameter(description = "파일 설명 (선택사항)")
    ...
    try {
      ...
      // 파일 업로드
      TestResultAttachmentDto attachmentDto =
          fileStorageService.uploadFile(testResultId, file, currentUser, description);
  ...
  public ResponseEntity<?> getAttachmentsByTestResult(
    ...
    try {
      List<TestResultAttachmentDto> attachments =
          fileStorageService.getAttachmentsByTestResultId(testResultId);
  ...
  public ResponseEntity<Resource> downloadFile(
    ...
    try {
      ...
      log.info(
          "파일 다운로드: {} by {}", attachmentInfo.getOriginalFileName(), userDetails.getUsername());
  ...
  public ResponseEntity<Resource> previewFile(
    ...
    try {
      ...
      log.info(
          "파일 미리보기: {} by {}", attachmentInfo.getOriginalFileName(), userDetails.getUsername());
