...
/** 그룹 관리 컨트롤러 Spring Security @PreAuthorize를 통한 메서드 레벨 보안 적용 */
...
public class GroupController {
  ...
  /** 사용자가 접근 가능한 그룹 목록 조회 권한: 인증된 사용자만 가능 */
  ...
  /** 조직에 새 그룹 생성 권한: 조직 멤버 또는 시스템 관리자 */
  ...
  public ResponseEntity<Group> createOrganizationGroup(
  ...
  /** 프로젝트에 새 그룹 생성 권한: 프로젝트 멤버 또는 시스템 관리자 */
  ...
  public ResponseEntity<Group> createProjectGroup(
  ...
  /** 조직별 그룹 목록 조회 권한: 조직 멤버 또는 시스템 관리자 */
  ...
  /** 프로젝트별 그룹 목록 조회 권한: 프로젝트 멤버 또는 시스템 관리자 */
  ...
  /** 그룹 상세 정보 조회 권한: 그룹 멤버 또는 상위 조직/프로젝트 멤버 또는 시스템 관리자 */
  ...
  /** 그룹 정보 수정 권한: 그룹 리더 이상 또는 시스템 관리자 */
  ...
  /** 그룹에 멤버 초대 권한: 그룹 리더 이상 또는 시스템 관리자 */
  @Operation(summary = "그룹 멤버 초대", description = "그룹에 새로운 멤버를 초대합니다.")
  @PostMapping("/{groupId}/members")
  @PreAuthorize("@groupSecurityService.hasLeaderRole(#groupId, authentication.name)")
  public ResponseEntity<GroupMember> inviteGroupMember(
      @PathVariable String groupId,
  ...
  /** 그룹에서 멤버 제거 권한: 그룹 리더 이상 또는 시스템 관리자 (자기 자신은 항상 가능) */
  ...
  /** 그룹 멤버 역할 변경 권한: 그룹 리더 이상 또는 시스템 관리자 */
  @Operation(summary = "그룹 멤버 역할 변경", description = "그룹 멤버의 역할을 변경합니다.")
  @PutMapping("/{groupId}/members/{userId}/role")
  @PreAuthorize("@groupSecurityService.hasLeaderRole(#groupId, authentication.name)")
  public ResponseEntity<GroupMember> updateGroupMemberRole(
      @PathVariable String groupId,
  ...
  /** 그룹 멤버 목록 조회 권한: 그룹 멤버 또는 상위 조직/프로젝트 멤버 또는 시스템 관리자 */
