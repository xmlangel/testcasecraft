...
public class ProjectController {
                ...
                .map(project -> {
                    ...
                    if (project.getOrganization() != null) {
                        memberCount = organizationUserRepository
                                .countByOrganizationId(project.getOrganization().getId());
                    } else {
                    ...
                    return new ProjectWithTestCaseCountDto(project, testCaseCount, memberCount, testPlanCount,
                            testExecutionCount);
                })
    ...
    public ResponseEntity<ProjectDto> createOrganizationProject(
        ...
        System.out.println(
                "createOrganizationProject - code: " + code + ", name: " + name + ", description: " + description); // 디버그
                                                                                                                    // 로그
