...
public class I18nController {
  ...
  public ResponseEntity<Map<String, Object>> getTranslationsByCategory(
      @PathVariable String languageCode, @PathVariable String category) {

    String validatedLanguageCode = i18nService.validateLanguageCode(languageCode);
    Map<String, String> translations =
        i18nService.getTranslationsByCategory(validatedLanguageCode, category);
  ...
  public ResponseEntity<Map<String, Object>> getMissingTranslationKeys(
      @PathVariable String languageCode) {
    String validatedLanguageCode = i18nService.validateLanguageCode(languageCode);
  ...
  public ResponseEntity<Map<String, Object>> validateLanguageCode(
      @PathVariable String languageCode) {
  ...
  public ResponseEntity<Map<String, String>> getLoginTranslations(
      @PathVariable String languageCode) {
    String validatedLanguageCode = i18nService.validateLanguageCode(languageCode);
    Map<String, String> loginTranslations =
        i18nService.getTranslationsByCategory(validatedLanguageCode, "login");

    // 버튼 카테고리도 포함 (로그인 버튼용)
    Map<String, String> buttonTranslations =
        i18nService.getTranslationsByCategory(validatedLanguageCode, "button");
