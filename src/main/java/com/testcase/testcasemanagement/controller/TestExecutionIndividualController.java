...
public class TestExecutionIndividualController {
  ...
  @Autowired
  public TestExecutionIndividualController(
      TestExecutionService testExecutionService, TestCaseService testCaseService) {
  ...
  public ResponseEntity<List<TestCaseDto>> getTestCasesByExecutionId(
      @PathVariable String executionId) {
    Optional<TestExecutionDto> executionOpt =
        testExecutionService.getTestExecutionById(executionId);
    ...
    List<TestCaseDto> testCases =
        testCaseService.getTestCasesByParentId(testPlanId).stream()
