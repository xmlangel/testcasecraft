...
public class RateLimiterFilter implements Filter {
    ...
    public RateLimiterFilter() {
        // Rate Limiter 설정: 60초당 10회
        this.rateLimiterConfig = RateLimiterConfig.custom()
            .limitForPeriod(10)                      // 기간당 최대 10회
            .limitRefreshPeriod(Duration.ofSeconds(60))  // 60초마다 리셋
    ...
    private void handleRateLimitExceeded(HttpServletRequest request, HttpServletResponse response, String clientIp)
        ...
        if (wantsHtml) {
            ...
            String jsonResponse = String.format(
                "{\"error\":\"Too Many Requests\",\"message\":\"동일 IP에서 1초에 10번 이상 요청이 발생했습니다. 60초 후 다시 시도해주세요.\",\"retryAfter\":60,\"clientIp\":\"%s\"}",
                clientIp
            );
    ...
    private String generateRateLimitHtmlPage(String clientIp, String requestPath) {
        return "<!DOCTYPE html>\n" +
            ...
            "        <div class=\"content\">\n" +
            "            <div class=\"message\">\n" +
            "                <strong>너무 많은 요청이 발생했습니다!</strong><br>\n" +
            "                동일 IP에서 1초에 10번 이상 요청 시 차단됩니다.<br>\n" +
            "                60초 후 다시 시도해주세요.\n" +
            "            </div>\n" +
            "            \n" +
            "            <div class=\"countdown-box\">\n" +
            "                <div class=\"countdown\" id=\"countdown\">60</div>\n" +
            "                <div class=\"countdown-label\">초 후 자동으로 재시도됩니다</div>\n" +
            ...
            "                <h3>💡 도움말</h3>\n" +
            "                <ul>\n" +
            "                    <li>페이지를 너무 자주 새로고침하지 마세요</li>\n" +
            "                    <li>잠시 기다렸다가 다시 시도해주세요</li>\n" +
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        log.info("RateLimiterFilter 초기화 완료 - 60초당 최대 10회 요청 허용");
    }
