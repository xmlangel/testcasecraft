...
public class ProjectManagementDto {
  ...
  public static class DetailResponse {
    ...
    public Integer getCompletedTestCount() {
      return completedTestCount;
    }

    public void setCompletedTestCount(Integer completedTestCount) {
      this.completedTestCount = completedTestCount;
    }

    public Integer getTotalTestPlanCount() {
      return totalTestPlanCount;
    }

    public void setTotalTestPlanCount(Integer totalTestPlanCount) {
      this.totalTestPlanCount = totalTestPlanCount;
    }

    public ProjectUser.ProjectRole getMyRole() {
      return myRole;
    }

    public void setMyRole(ProjectUser.ProjectRole myRole) {
      this.myRole = myRole;
    }
  ...
  public static class InviteMemberRequest {
    ...
    public ProjectUser.ProjectRole getRole() {
      return role;
    }

    public void setRole(ProjectUser.ProjectRole role) {
      this.role = role;
    }
  }
  ...
  public static class MemberResponse {
    ...
    public ProjectUser.ProjectRole getRoleInProject() {
  ...
  public static class TransferRequest {
    ...
    public void setNewOrganizationId(String newOrganizationId) {
      this.newOrganizationId = newOrganizationId;
    }

    public String getNewProjectManagerUsername() {
      return newProjectManagerUsername;
    }
  ...
  public static class StatisticsResponse {
    ...
    public Integer getTotalTestPlans() {
      return totalTestPlans;
    }

    public void setTotalTestPlans(Integer totalTestPlans) {
      this.totalTestPlans = totalTestPlans;
    }

    public Integer getActiveTestPlans() {
      return activeTestPlans;
    }

    public void setActiveTestPlans(Integer activeTestPlans) {
      this.activeTestPlans = activeTestPlans;
    }
