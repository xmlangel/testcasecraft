...
/** 권한 충돌 정보 객체 ICT-33: 사용자 권한 및 역할 관리 강화 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class PermissionConflictDto {
  ...
  private String
      conflictType; // "DUPLICATE_MEMBERSHIP", "INSUFFICIENT_PERMISSION", "ROLE_CONFLICT" 등
  ...
  public PermissionConflictDto(
      String conflictType, String message, String userId, String resourceId) {
