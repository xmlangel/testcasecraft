...
public class UserActivityDto {
  ...
  public static class Response {
    ...
    public String getActivityCategoryDescription() {
      return activityCategoryDescription;
    }

    public void setActivityCategoryDescription(String activityCategoryDescription) {
      this.activityCategoryDescription = activityCategoryDescription;
    }
  ...
  public static class StatisticsResponse {
    ...
    public void setSuccessfulActivities(Long successfulActivities) {
    ...
    public void setFailedActivities(Long failedActivities) {
      this.failedActivities = failedActivities;
    }

    public Long getDistinctSessions() {
      return distinctSessions;
    }

    public void setDistinctSessions(Long distinctSessions) {
    ...
    public void setAverageRiskScore(Integer averageRiskScore) {
      this.averageRiskScore = averageRiskScore;
    }

    public Long getAnomalousActivities() {
      return anomalousActivities;
    }

    public void setAnomalousActivities(Long anomalousActivities) {
    ...
    public LocalDateTime getStatisticsStartDate() {
      return statisticsStartDate;
    }

    public void setStatisticsStartDate(LocalDateTime statisticsStartDate) {
      this.statisticsStartDate = statisticsStartDate;
    }

    public LocalDateTime getStatisticsEndDate() {
      return statisticsEndDate;
    }

    public void setStatisticsEndDate(LocalDateTime statisticsEndDate) {
    ...
    public void setActivityTypeStatistics(Map<String, Long> activityTypeStatistics) {
      this.activityTypeStatistics = activityTypeStatistics;
    }

    public Map<String, Long> getActivityCategoryStatistics() {
      return activityCategoryStatistics;
    }

    public void setActivityCategoryStatistics(Map<String, Long> activityCategoryStatistics) {
      this.activityCategoryStatistics = activityCategoryStatistics;
    }

    public List<Object[]> getDailyActivityStatistics() {
      return dailyActivityStatistics;
    }

    public void setDailyActivityStatistics(List<Object[]> dailyActivityStatistics) {
      this.dailyActivityStatistics = dailyActivityStatistics;
    }

    public List<Object[]> getHourlyActivityStatistics() {
      return hourlyActivityStatistics;
    }

    public void setHourlyActivityStatistics(List<Object[]> hourlyActivityStatistics) {
      this.hourlyActivityStatistics = hourlyActivityStatistics;
    }
    ...
    public void setFailureStatistics(Map<String, Long> failureStatistics) {
      this.failureStatistics = failureStatistics;
    }

    public List<String> getMostActiveIpAddresses() {
      return mostActiveIpAddresses;
    }

    public void setMostActiveIpAddresses(List<String> mostActiveIpAddresses) {
      this.mostActiveIpAddresses = mostActiveIpAddresses;
    }
