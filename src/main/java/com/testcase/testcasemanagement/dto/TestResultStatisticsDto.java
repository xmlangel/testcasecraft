...
public class TestResultStatisticsDto {
    ...
    public void calculateRates() {
        ...
        if (totalCaseCount != null && totalCaseCount > 0) {
            ...
            Long latestExecutedCount = totalCaseCount - (latestNotRunCount != null ? latestNotRunCount : 0);
            if (latestExecutedCount > 0) {
                this.latestSuccessRate = calculatePercentage(latestPassCount, new BigDecimal(latestExecutedCount));
            } else {
