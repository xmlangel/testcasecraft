...
public class AuditLogDto {
  ...
  public static class StatisticsResponse {
    ...
    public Long getThisWeekLogs() {
      return thisWeekLogs;
    }

    public void setThisWeekLogs(Long thisWeekLogs) {
      this.thisWeekLogs = thisWeekLogs;
    }

    public Long getThisMonthLogs() {
      return thisMonthLogs;
    }

    public void setThisMonthLogs(Long thisMonthLogs) {
      this.thisMonthLogs = thisMonthLogs;
    }

    public List<ActionStatistic> getActionStatistics() {
      return actionStatistics;
    }

    public void setActionStatistics(List<ActionStatistic> actionStatistics) {
      this.actionStatistics = actionStatistics;
    }

    public List<EntityTypeStatistic> getEntityTypeStatistics() {
      return entityTypeStatistics;
    }

    public void setEntityTypeStatistics(List<EntityTypeStatistic> entityTypeStatistics) {
      this.entityTypeStatistics = entityTypeStatistics;
    }
    ...
    public void setUserActivityStatistics(List<UserActivityStatistic> userActivityStatistics) {
      this.userActivityStatistics = userActivityStatistics;
    }

    public List<DailyLogCount> getDailyLogCounts() {
      return dailyLogCounts;
    }

    public void setDailyLogCounts(List<DailyLogCount> dailyLogCounts) {
      this.dailyLogCounts = dailyLogCounts;
    }
  }
  ...
  public static class ConfigurationRequest {
    ...
    public Boolean getEnabledAutoCleanup() {
      return enabledAutoCleanup;
    }

    public void setEnabledAutoCleanup(Boolean enabledAutoCleanup) {
      this.enabledAutoCleanup = enabledAutoCleanup;
    }
    ...
    public Boolean getEnabledRealTimeAlerts() {
      return enabledRealTimeAlerts;
    }

    public void setEnabledRealTimeAlerts(Boolean enabledRealTimeAlerts) {
      this.enabledRealTimeAlerts = enabledRealTimeAlerts;
    }

    public String[] getAlertActions() {
      return alertActions;
    }

    public void setAlertActions(String[] alertActions) {
