 ...
 *
 * <p>FastAPI LLM 분석 상태 조회 API 응답 분석 진행률, 처리된 청크 수, 비용 정보 포함
 */
@Data
@Builder
@NoArgsConstructor
...
public class RagLlmAnalysisStatusResponse {
  ...
  /** 작업 ID FastAPI: job_id */
  @JsonProperty("jobId")
  @com.fasterxml.jackson.annotation.JsonAlias({"job_id"})
  private UUID jobId;

  /** 문서 ID FastAPI: document_id */
  @JsonProperty("documentId")
  @com.fasterxml.jackson.annotation.JsonAlias({"document_id"})
  private UUID documentId;

  /** LLM Config ID (Backend에서 API key 조회용) FastAPI: llm_config_id */
  @JsonProperty("llmConfigId")
  @com.fasterxml.jackson.annotation.JsonAlias({"llm_config_id"})
  private String llmConfigId;

  /**
   * 분석 상태 ("pending", "processing", "paused", "completed", "failed", "cancelled") FastAPI: status
   */
  private String status;

  /** 진행 상황 정보 (nested object) FastAPI: progress */
  private ProgressInfo progress;

  /** 실제 비용 정보 (nested object) FastAPI: actual_cost_so_far */
