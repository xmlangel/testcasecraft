 ...
 *
 * <p>FastAPI LLM 분석 결과 조회 API 응답 청크별 분석 결과, 토큰 사용량, 처리 시간 포함
 */
@Data
@Builder
@NoArgsConstructor
...
public class RagLlmAnalysisResultsResponse {
  ...
  /** 분석 결과 리스트 FastAPI: results */
  private List<ChunkAnalysisResult> results;

  /** 총 결과 수 FastAPI: total */
  @JsonProperty("total")
  private Integer total;

  /** 페이지네이션 offset FastAPI: skip */
  private Integer skip;

  /** 페이지네이션 limit FastAPI: limit */
