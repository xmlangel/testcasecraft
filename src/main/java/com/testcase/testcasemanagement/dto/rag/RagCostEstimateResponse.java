 ...
 * LLM 분석 비용 추정 응답 DTO
 *
 * <p>FastAPI 비용 추정 API 응답 예상 토큰 사용량, 비용, 경고 메시지 포함
 */
@Data
@Builder
@NoArgsConstructor
...
public class RagCostEstimateResponse {
  ...
  /** 예상 입력 토큰 수 FastAPI: estimated_input_tokens */
  ...
  /** 예상 출력 토큰 수 FastAPI: estimated_output_tokens */
  ...
  /** 예상 총 토큰 수 FastAPI: estimated_total_tokens */
  ...
  public static class ModelPricing {
    /** LLM 제공자 FastAPI: provider */
    private String provider;

    /** 모델명 FastAPI: model */
    private String model;

    /** 입력 토큰 1K당 가격 (USD) FastAPI: input_price_per_1k */
    @JsonProperty("inputPricePer1k")
    @com.fasterxml.jackson.annotation.JsonAlias({"input_price_per_1k"})
    private BigDecimal inputPricePer1k;

    /** 출력 토큰 1K당 가격 (USD) FastAPI: output_price_per_1k */
