 ...
 *
 * <p>FastAPI AdvancedSearchRequest 스키마와 매핑 POST /api/v1/search/advanced 엔드포인트 요청 DTO 다양한 검색 방법
 * (vector, BM25, hybrid, reranker) 지원
 */
@Data
@Builder
@NoArgsConstructor
...
public class RagAdvancedSearchRequest {
  ...
  /**
   * 검색 방법 vector: 순수 벡터 검색 bm25: 순수 키워드 검색 hybrid: 하이브리드 (벡터 + BM25) hybrid_rerank: 하이브리드 +
   * Reranker (권장)
   */
