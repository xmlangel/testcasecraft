 ...
 * 분석 요약 조회 응답 DTO
 *
 * <p>FastAPI 분석 요약 CRUD API 응답 저장된 요약 정보 반환
 */
@Data
@Builder
@NoArgsConstructor
...
public class RagAnalysisSummaryResponse {
  ...
  /** 마지막 업데이트 시각 FastAPI: updated_at */
