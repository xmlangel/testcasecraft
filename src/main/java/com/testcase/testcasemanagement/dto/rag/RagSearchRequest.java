 ...
 *
 * <p>FastAPI SearchRequest 스키마와 매핑 POST /api/v1/search/similar 엔드포인트 요청 DTO 벡터 유사도 검색을 위한 파라미터 정의
 */
@Data
@Builder
@NoArgsConstructor
...
public class RagSearchRequest {
  ...
  /** 프로젝트 ID (필터링용) null인 경우 모든 프로젝트 대상 검색 */
  @JsonProperty("project_id")
  @JsonAlias({"projectId", "project_id"})
  private UUID projectId;

  /** 유사도 임계값 (0.0 ~ 1.0) 이 값 이상의 유사도를 가진 결과만 반환 기본값: 0.7 */
  @Min(0)
  @Max(1)
  @Builder.Default
  ...
  /** 최대 결과 수 반환할 최대 검색 결과 개수 기본값: 10, 최대: 100 */
