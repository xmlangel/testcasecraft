 ...
 * 가용성 확인 작업의 상태.
 *
 * <p>확인은 최악의 경우 몇 분이 걸린다(OpenRouter 2분 30초, NVIDIA 6분). 결과를 기다려 돌려주면 리버스 프록시 타임아웃에 먼저 걸려 응답을 아예 받지
 * 못하고, 그동안 확인은 서버에서 계속 도는데 결과가 버려진다. 그래서 작업으로 만들고 화면이 진행 상황을 물어보게 한다.
 */
@Data
@Builder
