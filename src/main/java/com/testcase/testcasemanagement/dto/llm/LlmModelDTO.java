 ...
 *
 * <p>제공자마다 채울 수 있는 항목이 다르다. OpenRouter 는 컨텍스트 길이·만료일·도구 지원까지 알려 주는데, NVIDIA 는 모델 목록에 이름만 있어 {@code
 * id} 와 {@code name} 만 채워진다. 비어 있는 항목은 그 제공자가 알려 주지 않는다는 뜻이고 오류가 아니다.
 */
@Data
@Builder
@NoArgsConstructor
