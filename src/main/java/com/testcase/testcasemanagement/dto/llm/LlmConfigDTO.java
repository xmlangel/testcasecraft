...
/** LLM 설정 DTO Request와 Response 모두 사용 가능한 DTO */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class LlmConfigDTO {
  ...
  /** 기본 테스트 케이스 템플릿 LLM 설정 생성 시 초기값으로 사용됨 */
  ...
  /** API Key (평문 - Request 시만 사용) Response 시에는 마스킹된 값 반환 */
  @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
  private String apiKey;

  /** 마스킹된 API Key (Response 전용) 예: "sk-1234...abcd" */
