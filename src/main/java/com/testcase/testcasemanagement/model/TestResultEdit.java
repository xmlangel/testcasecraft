...
/** ICT-209: 테스트 결과 편집 기능 구현 원본 TestResult 데이터를 보존하면서 편집 내용을 별도로 저장하는 모델 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
@Table(
    ...
    indexes = {
      ...
      @Index(
          name = "idx_test_result_edit_active",
          columnList = "original_test_result_id, is_active")
    })
