...
@Table(
    name = "translations",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"translation_key_id", "language_id"})})
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class Translation {
  ...
  // 생성자 - 기본 번역 생성용
  public Translation(
      TranslationKey translationKey, Language language, String value, String createdBy) {
