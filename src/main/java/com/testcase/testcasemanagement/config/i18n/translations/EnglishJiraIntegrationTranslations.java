...
public class EnglishJiraIntegrationTranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("jira.history.dialogTitle", languageCode, "JIRA Issue Test History", createdBy);
        createTranslationIfNotExists("jira.history.column.execution", languageCode, "Test Execution", createdBy);
        createTranslationIfNotExists("jira.history.column.testcase", languageCode, "Test Case", createdBy);
        createTranslationIfNotExists("jira.history.column.result", languageCode, "Result", createdBy);
        createTranslationIfNotExists("jira.history.column.date", languageCode, "Execution Date", createdBy);
        createTranslationIfNotExists("jira.history.column.executor", languageCode, "Executor", createdBy);
