...
public class KoreanLoginDashboardAndProjectTranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("project.form.descriptionPlaceholder", languageCode, "프로젝트에 대한 설명을 입력하세요...",
                createdBy);
        ...
        createTranslationIfNotExists("dashboard.status.completedCount", languageCode, "{completed}/{total} 완료",
                createdBy);
        createTranslationIfNotExists("dashboard.messages.selectProject", languageCode, "테스트 플랜별 결과를 보려면 프로젝트를 선택해주세요.",
                createdBy);
        ...
        createTranslationIfNotExists("testTrendAnalysis.error.trendLoadFailed", languageCode, "추이 데이터를 불러오는데 실패했습니다.",
                createdBy);
        ...
        createTranslationIfNotExists("testTrendAnalysis.chart.testPlanComparison", languageCode, "테스트 플랜별 결과 비교",
                createdBy);
        createTranslationIfNotExists("testTrendAnalysis.chart.assigneeComparison", languageCode, "실행자별 결과 비교",
                createdBy);
        createTranslationIfNotExists("testTrendAnalysis.chart.successAndCompletionRate", languageCode, "성공률 및 완료율 추이",
                createdBy);
        ...
        createTranslationIfNotExists("testTrendAnalysis.prompt.selectTestPlan", languageCode, "비교할 테스트 플랜을 선택해주세요",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dashboard.metrics.totalOrganizations", languageCode, "총 조직 수",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dashboard.metrics.totalProjects", languageCode, "총 프로젝트 수",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.metrics.totalProjects.subtitle", languageCode, "전체 프로젝트",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dashboard.metrics.totalUsers.subtitle", languageCode, "등록된 사용자",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.metrics.totalMembers", languageCode, "총 프로젝트 참여",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.metrics.totalMembers.subtitle", languageCode, "프로젝트 멤버십 수",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dashboard.charts.projectDistribution", languageCode, "조직별 프로젝트 분포",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.charts.projectDistribution.projects", languageCode,
                "프로젝트 수", createdBy);
        createTranslationIfNotExists("organization.dashboard.charts.projectDistribution.members", languageCode, "멤버 수",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.form.testTechniquePlaceholder", languageCode, "예: 경계값 분석, 의사결정 테이블",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.validation.expectedResultsRequired", languageCode, "전체 예상 결과를 입력하세요.",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.version.error.notSaved", languageCode, "저장된 테스트케이스에만 버전을 생성할 수 있습니다.",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.version.form.labelPlaceholder", languageCode, "예: v2.1 수정사항 반영",
                createdBy);
        createTranslationIfNotExists("testcase.version.form.labelHelperText", languageCode, "버전을 식별할 수 있는 라벨을 입력하세요.",
                createdBy);
        ...
        createTranslationIfNotExists("testPlan.list.table.linkAutomated", languageCode, "자동화 테스트 연결", createdBy);
        createTranslationIfNotExists("testPlan.execution.automated.title", languageCode, "연결된 자동화 테스트", createdBy);
