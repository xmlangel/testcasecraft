...
public class KoreanLoginDashboardAndProjectTranslations {
  ...
  public void initialize() {
    ...
    createTranslationIfNotExists(
        "register.success", languageCode, "회원가입이 완료되었습니다. 로그인 해주세요.", createdBy);
    createTranslationIfNotExists(
        "register.error.general", languageCode, "회원가입 중 오류가 발생했습니다.", createdBy);

    // 세션 만료
    createTranslationIfNotExists("auth.session.expired.title", languageCode, "세션 만료", createdBy);
    createTranslationIfNotExists(
        "auth.session.expired.message", languageCode, "보안을 위해 세션이 안전하게 종료되었습니다.", createdBy);
    createTranslationIfNotExists(
        "auth.session.expired.cause", languageCode, "원인: {cause}", createdBy);
    createTranslationIfNotExists(
        "auth.session.expired.default_help", languageCode, "계속 이용하시려면 다시 로그인해주세요.", createdBy);
    createTranslationIfNotExists(
        "auth.session.button.refresh", languageCode, "페이지 새로고침", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "project.form.codePlaceholder", languageCode, "예: PROJ001", createdBy);
    createTranslationIfNotExists("project.form.organization", languageCode, "소속 조직", createdBy);
    createTranslationIfNotExists(
        "project.form.noOrganization", languageCode, "독립 프로젝트 (조직 없음)", createdBy);
    createTranslationIfNotExists("project.form.description", languageCode, "설명", createdBy);
    createTranslationIfNotExists(
        "project.form.descriptionPlaceholder", languageCode, "프로젝트에 대한 설명을 입력하세요...", createdBy);
    ...
    createTranslationIfNotExists(
        "dashboard.lastUpdated", languageCode, "최종 업데이트: {date}", createdBy);
    createTranslationIfNotExists(
        "dashboard.refresh.tooltip", languageCode, "대시보드 데이터 새로고침", createdBy);
    createTranslationIfNotExists("dashboard.refresh.button", languageCode, "새로고침", createdBy);
    createTranslationIfNotExists(
        "dashboard.loading.data", languageCode, "대시보드 데이터를 불러오는 중...", createdBy);
    createTranslationIfNotExists(
        "dashboard.loading.chart", languageCode, "차트 데이터를 불러오는 중...", createdBy);
    createTranslationIfNotExists(
        "dashboard.error.solution", languageCode, "해결책: {action}", createdBy);
    ...
    createTranslationIfNotExists(
        "dashboard.noData.message", languageCode, "표시할 대시보드 데이터가 없습니다.", createdBy);
    createTranslationIfNotExists(
        "dashboard.noData.chart", languageCode, "차트 데이터가 없습니다.", createdBy);
    createTranslationIfNotExists(
        "dashboard.noData.noActiveTestRuns", languageCode, "진행 중인 테스트 실행이 없습니다.", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "dashboard.charts.openTestRunResults", languageCode, "진행 중인 테스트 결과", createdBy);
    createTranslationIfNotExists(
        "dashboard.charts.assigneeResults", languageCode, "담당자별 결과", createdBy);
    createTranslationIfNotExists(
        "dashboard.charts.testPlanResults", languageCode, "테스트 플랜별 결과", createdBy);
    createTranslationIfNotExists(
        "dashboard.charts.notRunTrend", languageCode, "미실행 테스트 추이", createdBy);
    ...
    createTranslationIfNotExists(
        "project.tabs.byOrganization", languageCode, "조직별 프로젝트", createdBy);
    ...
    createTranslationIfNotExists(
        "project.stats.projectCount", languageCode, "{count}개 프로젝트", createdBy);
    createTranslationIfNotExists(
        "project.stats.totalProjectCount", languageCode, "총 {count}개 프로젝트", createdBy);
    createTranslationIfNotExists(
        "project.messages.noIndependentProjects", languageCode, "독립 프로젝트가 없습니다", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "projectHeader.breadcrumb.projects", languageCode, "프로젝트", createdBy);
    ...
    createTranslationIfNotExists(
        "projectHeader.tabs.testExecution", languageCode, "테스트실행", createdBy);
    createTranslationIfNotExists(
        "projectHeader.tabs.testResults", languageCode, "테스트결과", createdBy);
    createTranslationIfNotExists(
        "projectHeader.tabs.automation", languageCode, "자동화 테스트", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.chart.planComparison", languageCode, "테스트 플랜별 결과 비교", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.chart.executorComparison", languageCode, "실행자별 결과 비교", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.title", languageCode, "통계 요약", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.executionRate", languageCode, "실행률", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.successRate", languageCode, "성공률", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.jiraLinkRate", languageCode, "JIRA 연동률", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.lastUpdated", languageCode, "최종 업데이트", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.unknown", languageCode, "알 수 없음", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.loading.trendData", languageCode, "추이 데이터를 불러오는 중...", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.noData.title", languageCode, "추이 데이터가 없습니다", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last7days", languageCode, "최근 7일", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last15days", languageCode, "최근 15일", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last30days", languageCode, "최근 30일", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last60days", languageCode, "최근 60일", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last90days", languageCode, "최근 90일", createdBy);
    ...
    createTranslationIfNotExists(
        "testTrendAnalysis.summary.avgSuccessRate", languageCode, "평균 성공률", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.summary.avgCompletionRate", languageCode, "평균 완료율", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.summary.dataPoints", languageCode, "데이터 포인트", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.summary.successRateChange", languageCode, "성공률 변화", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.overallTrend", languageCode, "테스트 결과 변화 추이", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.testPlanComparison", languageCode, "테스트 플랜별 결과 비교", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.assigneeComparison", languageCode, "실행자별 결과 비교", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.successRate", languageCode, "성공률", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.completionRate", languageCode, "완료율", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.tooltip.overallSuccessRate", languageCode, "전체 성공률", createdBy);
    ...
    createTranslationIfNotExists(
        "testTrendAnalysis.legend.overallSuccessRate", languageCode, "전체 성공률", createdBy);
    ...
    createTranslationIfNotExists(
        "testTrendAnalysis.prompt.selectTestPlan", languageCode, "비교할 테스트 플랜을 선택해주세요", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.prompt.selectAssignee", languageCode, "비교할 실행자를 선택해주세요", createdBy);
    ...
    createTranslationIfNotExists(
        "header.nav.translationManagement", languageCode, "번역 관리", createdBy);
    ...
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalOrganizations", languageCode, "총 조직 수", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalProjects", languageCode, "총 프로젝트 수", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalTestCases", languageCode, "총 테스트케이스", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalUsers", languageCode, "총 사용자 수", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalUsers.subtitle", languageCode, "등록된 사용자", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalMembers", languageCode, "총 프로젝트 참여", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.tabs.organizationStatus", languageCode, "조직 현황", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.tabs.testStatistics", languageCode, "테스트 통계", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "organization.dashboard.list.projectCount", languageCode, "프로젝트: {count}개", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.list.memberCount", languageCode, "멤버: {count}명", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.testResults.success", languageCode, "성공", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.testResults.failure", languageCode, "실패", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.testResults.blocked", languageCode, "차단됨", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.testResults.notRun", languageCode, "미실행", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.tree.title.select", languageCode, "테스트케이스 선택", createdBy);
    createTranslationIfNotExists("testcase.tree.title.manage", languageCode, "테스트케이스", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.message.selectProject", languageCode, "프로젝트를 선택하세요.", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.message.loading", languageCode, "로딩 중...", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.message.noTestcases", languageCode, "테스트케이스가 없습니다.", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.validation.nameRequired", languageCode, "이름을 입력하세요.", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.error.renameFailed", languageCode, "이름 변경에 실패했습니다: ", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.tree.action.addFolder", languageCode, "폴더 추가", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.action.addTestcase", languageCode, "테스트케이스 추가", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.action.addSubFolder", languageCode, "하위 폴더 추가", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.action.addSubTestcase", languageCode, "하위 테스트케이스 추가", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.tree.action.versionHistory", languageCode, "버전 히스토리", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.dialog.batchDelete.title", languageCode, "선택 삭제", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.tree.tooltip.open", languageCode, "테스트케이스 트리 열기", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.tooltip.close", languageCode, "테스트케이스 트리 닫기", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.count.testcases", languageCode, "테스트케이스: {count}개", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.count.folders", languageCode, "폴더: {count}개", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.count.total", languageCode, "전체: {count}개", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.form.preConditionPlaceholder", languageCode, "사전 조건", createdBy);
    createTranslationIfNotExists(
        "testcase.form.postConditionPlaceholder", languageCode, "사후 조건", createdBy);
    createTranslationIfNotExists(
        "testcase.form.testTechniquePlaceholder", languageCode, "예: 경계값 분석, 의사결정 테이블", createdBy);
    createTranslationIfNotExists("testcase.executionType.manual", languageCode, "수동", createdBy);
    createTranslationIfNotExists(
        "testcase.executionType.automation", languageCode, "자동화", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.form.overallExpectedResults", languageCode, "전체 예상 결과", createdBy);
    createTranslationIfNotExists("testcase.form.folderName", languageCode, "폴더 이름", createdBy);
    createTranslationIfNotExists(
        "testcase.form.folderDescription", languageCode, "폴더 설명", createdBy);
    createTranslationIfNotExists(
        "testcase.form.testcaseName", languageCode, "테스트케이스 이름", createdBy);
    createTranslationIfNotExists(
        "testcase.form.testcaseDescription", languageCode, "테스트케이스 설명", createdBy);
    createTranslationIfNotExists(
        "testcase.helper.description", languageCode, "설명을 입력하세요.", createdBy);
    createTranslationIfNotExists(
        "testcase.helper.preCondition", languageCode, "사전 조건을 입력하세요.", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.message.addSteps", languageCode, "스텝을 추가하세요.", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.form.folder.create", languageCode, "테스트 폴더 생성", createdBy);
    createTranslationIfNotExists(
        "testcase.version.button.create", languageCode, "버전 생성", createdBy);
    createTranslationIfNotExists("testcase.version.button.cancel", languageCode, "취소", createdBy);
    createTranslationIfNotExists(
        "testcase.version.button.creating", languageCode, "생성 중...", createdBy);
    createTranslationIfNotExists(
        "testcase.version.current.fetchError", languageCode, "현재 버전 조회 실패:", createdBy);
    createTranslationIfNotExists(
        "testcase.version.error.notSaved", languageCode, "저장된 테스트케이스에만 버전을 생성할 수 있습니다.", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.version.error.createFailed", languageCode, "버전 생성에 실패했습니다.", createdBy);
    createTranslationIfNotExists(
        "testcase.version.error.createError", languageCode, "버전 생성 실패:", createdBy);
    createTranslationIfNotExists(
        "testcase.version.validation.labelRequired", languageCode, "버전 라벨을 입력하세요.", createdBy);
    createTranslationIfNotExists(
        "testcase.version.defaultDescription", languageCode, "수동 버전 생성", createdBy);
    createTranslationIfNotExists(
        "testcase.version.dialog.title", languageCode, "수동 버전 생성", createdBy);
    createTranslationIfNotExists("testcase.version.form.label", languageCode, "버전 라벨", createdBy);
    createTranslationIfNotExists(
        "testcase.version.form.labelPlaceholder", languageCode, "예: v2.1 수정사항 반영", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.version.form.description", languageCode, "버전 설명", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.header.title", languageCode, "테스트케이스 스프레드시트", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.status.rows", languageCode, "{count}개 행", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.status.steps", languageCode, "{count}개 스텝", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.status.changed", languageCode, "변경됨", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.refresh", languageCode, "새로고침", createdBy);
    createTranslationIfNotExists(
