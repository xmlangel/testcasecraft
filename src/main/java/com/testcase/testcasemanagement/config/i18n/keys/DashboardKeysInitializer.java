...
public class DashboardKeysInitializer {
    ...
    public void initialize() {
        ...
        createTranslationKeyIfNotExists("organization.dashboard.metrics.totalOrganizations", "dashboard", "총 조직 수 메트릭",
                "총 조직 수");
        createTranslationKeyIfNotExists("organization.dashboard.metrics.totalOrganizations.subtitle", "dashboard",
                "총 조직 수 부제목", "활성 조직");
        createTranslationKeyIfNotExists("organization.dashboard.metrics.totalProjects", "dashboard", "총 프로젝트 수 메트릭",
                "총 프로젝트 수");
        createTranslationKeyIfNotExists("organization.dashboard.metrics.totalProjects.subtitle", "dashboard",
                "총 프로젝트 수 부제목", "전체 프로젝트");
        createTranslationKeyIfNotExists("organization.dashboard.metrics.totalTestCases", "dashboard", "총 테스트케이스 메트릭",
                "총 테스트케이스");
        ...
        createTranslationKeyIfNotExists("organization.dashboard.metrics.totalUsers.subtitle", "dashboard",
                "총 사용자 수 부제목", "등록된 사용자");
        createTranslationKeyIfNotExists("organization.dashboard.metrics.totalMembers", "dashboard", "총 멤버 수 메트릭",
                "총 프로젝트 참여");
        createTranslationKeyIfNotExists("organization.dashboard.metrics.totalMembers.subtitle", "dashboard",
                "총 멤버 수 부제목", "프로젝트 멤버십 수");

        // 탭 관련
        createTranslationKeyIfNotExists("organization.dashboard.tabs.organizationStatus", "dashboard", "조직 현황 탭",
                "조직 현황");
        ...
        createTranslationKeyIfNotExists("organization.dashboard.charts.projectDistribution.projects", "dashboard",
                "프로젝트 수 차트 라벨", "프로젝트 수");
        createTranslationKeyIfNotExists("organization.dashboard.charts.projectDistribution.members", "dashboard",
                "멤버 수 차트 라벨", "멤버 수");
        createTranslationKeyIfNotExists("organization.dashboard.charts.organizationList", "dashboard", "조직 목록 제목",
                "조직 목록");
        createTranslationKeyIfNotExists("organization.dashboard.charts.testResultDistribution", "dashboard",
                "테스트 결과 분포 차트", "테스트 결과 분포");
        createTranslationKeyIfNotExists("organization.dashboard.charts.testResultDetails", "dashboard", "테스트 결과 상세 제목",
                "테스트 결과 상세");
