...
public class TranslationManagementKeysInitializer {
    ...
    public void initialize() {
        ...
        createTranslationKeyIfNotExists("translation.languageDialog.sortOrderLabel", "translation", "정렬 순서 라벨",
                "정렬 순서");
        createTranslationKeyIfNotExists("translation.languageDialog.sortOrderHelper", "translation", "정렬 순서 도움말",
                "정렬 순서는 0 이상이어야 합니다");
        ...
        createTranslationKeyIfNotExists("translation.languageDialog.nativeNameHelper", "translation", "원어명 도움말",
                "예: 한국어, English");
        createTranslationKeyIfNotExists("translation.languageDialog.isDefaultLabel", "translation", "기본 언어 설정 라벨",
                "기본 언어로 설정");
        createTranslationKeyIfNotExists("translation.languageDialog.isActiveLabel", "translation", "활성 상태 라벨", "활성 상태");
        createTranslationKeyIfNotExists("translation.languageDialog.defaultLanguageWarning", "translation", "기본 언어 경고",
        ...
        createTranslationKeyIfNotExists("translation.keyDialog.category.navigation", "translation", "네비게이션 카테고리",
                "네비게이션");
        ...
        // 번역 관리 다이얼로그 키들
        createTranslationKeyIfNotExists("translation.translationDialog.addTitle", "translation", "번역 추가 다이얼로그 제목",
                "번역 추가");
        createTranslationKeyIfNotExists("translation.translationDialog.editTitle", "translation", "번역 편집 다이얼로그 제목",
                "번역 편집");
        ...
        createTranslationKeyIfNotExists("translation.translationDialog.keyDescription", "translation", "키 설명 라벨",
                "키 설명");
        ...
        createTranslationKeyIfNotExists("translation.translationDialog.contextHelper", "translation", "컨텍스트 도움말",
                "번역의 맥락이나 사용 상황을 설명해주세요 (선택사항)");
        createTranslationKeyIfNotExists("translation.translationDialog.isActiveLabel", "translation", "활성 상태 라벨",
                "활성 상태");
        ...
        createTranslationKeyIfNotExists("translation.languageTab.table.isDefault", "translation", "기본 언어 테이블 헤더",
                "기본 언어");
        createTranslationKeyIfNotExists("translation.languageTab.table.isActive", "translation", "활성 상태 테이블 헤더",
                "활성 상태");
        createTranslationKeyIfNotExists("translation.languageTab.table.sortOrder", "translation", "정렬 순서 테이블 헤더",
                "정렬 순서");
        ...
        createTranslationKeyIfNotExists("translation.translationTab.exportCsvByLanguage", "translation", "언어별 CSV 내보내기",
        ...
        createTranslationKeyIfNotExists("translation.translationTab.keyNameLabel", "translation", "번역 키 이름 필터 라벨",
                "번역 키 이름");
        createTranslationKeyIfNotExists("translation.translationTab.table.keyName", "translation", "번역 키 테이블 헤더",
                "번역 키");
        ...
        createTranslationKeyIfNotExists("translation.translationTab.table.context", "translation", "컨텍스트 테이블 헤더",
                "컨텍스트");
        createTranslationKeyIfNotExists("translation.translationTab.table.isActive", "translation", "활성 상태 테이블 헤더",
                "활성 상태");
        createTranslationKeyIfNotExists("translation.translationTab.table.updatedBy", "translation", "수정자 테이블 헤더",
                "수정자");
        ...
        createTranslationKeyIfNotExists("translation.statisticsTab.completionRateLabel", "translation", "완성도 라벨",
                "완성도");
        createTranslationKeyIfNotExists("translation.statisticsTab.translatedCountLabel", "translation", "번역됨 라벨",
                "번역됨");
