...
public class TestExecutionKeysInitializer {
    ...
    public void initialize() {
        ...
        // 테스트 실행 즉시 시작 옵션
        createTranslationKeyIfNotExists("testExecution.options.startImmediately", "testExecution", "즉시 실행 시작 옵션",
                "저장 후 즉시 실행 시작");
        createTranslationKeyIfNotExists("testExecution.options.startImmediately.description", "testExecution",
                "즉시 실행 시작 설명", "체크하면 저장과 동시에 테스트 실행이 '진행 중' 상태로 변경되며, 창을 닫지 않고 현재 화면에서 바로 테스트를 시작할 수 있습니다");

        // 이전 결과 다이얼로그
        createTranslationKeyIfNotExists("testExecution.previousResults.title", "testExecution", "이전 실행 결과 제목",
                "이전 실행 결과");
        createTranslationKeyIfNotExists("testExecution.previousResults.noResults", "testExecution", "이전 실행 결과 없음",
                "이전 실행 결과가 없습니다.");
        createTranslationKeyIfNotExists("testExecution.previousResults.executionDate", "testExecution", "실행일시 컬럼",
                "실행일시");
        createTranslationKeyIfNotExists("testExecution.previousResults.executionId", "testExecution", "실행ID 컬럼",
                "실행ID");
        createTranslationKeyIfNotExists("testExecution.previousResults.executionName", "testExecution", "실행명 컬럼",
                "실행명");
        ...
        // 이전 결과 다이얼로그 테이블
        createTranslationKeyIfNotExists("testExecution.previousResults.table.executedAt", "testExecution", "실행일시",
                "실행일시");
        createTranslationKeyIfNotExists("testExecution.previousResults.table.result", "testExecution", "결과", "결과");
        createTranslationKeyIfNotExists("testExecution.previousResults.table.executionId", "testExecution", "실행ID",
                "실행ID");
        createTranslationKeyIfNotExists("testExecution.previousResults.table.executionName", "testExecution", "실행명",
                "실행명");
        createTranslationKeyIfNotExists("testExecution.previousResults.table.executedBy", "testExecution", "실행자",
                "실행자");
        createTranslationKeyIfNotExists("testExecution.previousResults.table.notes", "testExecution", "비고", "비고");
        createTranslationKeyIfNotExists("testExecution.previousResults.table.jiraId", "testExecution", "JIRA ID",
                "JIRA ID");
        createTranslationKeyIfNotExists("testExecution.previousResults.table.attachments", "testExecution", "첨부파일",
                "첨부파일");
        ...
        createTranslationKeyIfNotExists("testExecution.bulk.selectedCount", "testExecution", "선택된 개수", "{count}개 선택됨");
        createTranslationKeyIfNotExists("testExecution.bulk.actionToolbar.title", "testExecution", "일괄 작업 툴바 제목",
                "일괄 작업");
        createTranslationKeyIfNotExists("testExecution.bulk.actionToolbar.deselect", "testExecution", "선택 해제 버튼",
                "선택 해제");
        createTranslationKeyIfNotExists("testExecution.bulk.dialog.title", "testExecution", "일괄 결과 입력 다이얼로그 제목",
                "일괄 결과 입력");
        createTranslationKeyIfNotExists("testExecution.bulk.dialog.selectedCases", "testExecution", "선택된 테스트케이스",
                "선택된 테스트케이스");
        createTranslationKeyIfNotExists("testExecution.bulk.dialog.selectResult", "testExecution", "결과 선택", "결과 선택");
        createTranslationKeyIfNotExists("testExecution.bulk.dialog.commonNotes", "testExecution", "공통 비고", "공통 비고");
        createTranslationKeyIfNotExists("testExecution.bulk.dialog.commonTags", "testExecution", "공통 태그", "공통 태그");
