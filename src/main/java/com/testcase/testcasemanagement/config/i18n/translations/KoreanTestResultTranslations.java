...
public class KoreanTestResultTranslations {
  ...
  public void initialize() {
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.html.feature1", languageCode, "리포트 레이아웃", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.html.feature2", languageCode, "라이트/다크 테마", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.html.feature3", languageCode, "단일 파일 공유", createdBy);
    createTranslationIfNotExists(
