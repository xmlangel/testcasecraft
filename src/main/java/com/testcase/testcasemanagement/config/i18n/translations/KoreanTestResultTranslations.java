...
public class KoreanTestResultTranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("testResult.form.notesPlaceholder", languageCode, "노트 ({length}/10,000)",
                createdBy);
        createTranslationIfNotExists("testResult.form.notesHelp", languageCode, "테스트 과정에서 발견한 특이사항이나 추가 정보를 기록해주세요.",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.form.notesFileRecommendation", languageCode, "긴 내용은 파일 첨부를 권장합니다.",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.form.attachmentsNote", languageCode, "테스트 결과를 저장하면 첨부파일을 확인할 수 있습니다.",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.jira.connectionCheckFailed", languageCode, "JIRA 연결 상태 확인 실패:",
                createdBy);
        createTranslationIfNotExists("testResult.jira.placeholder", languageCode, "관련된 JIRA 이슈 키를 입력하세요 (자동으로 대문자 변환)",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.file.allowedFormats", languageCode,
                "허용 형식: TXT, CSV, JSON, MD, PDF, LOG (최대 10MB)", createdBy);
        createTranslationIfNotExists("testResult.file.newAttachmentsCount", languageCode, "새로 첨부할 파일 ({count}개)",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.export.format.pdf.description", languageCode, "인쇄 및 공유용, 레이아웃 고정",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.export.format.csv.description", languageCode, "데이터 분석용, 가벼운 파일 크기",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.export.progress.message", languageCode, "파일을 생성하고 있습니다... 잠시만 기다려주세요",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.export.error.failed", languageCode, "파일 내보내기 중 오류가 발생했습니다: {message}",
                createdBy);
        createTranslationIfNotExists("testResult.export.error.response", languageCode, "내보내기 실패: {status} {statusText}",
                createdBy);
