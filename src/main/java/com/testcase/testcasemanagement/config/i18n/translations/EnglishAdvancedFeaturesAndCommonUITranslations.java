...
public class EnglishAdvancedFeaturesAndCommonUITranslations {
        ...
        public void initialize() {
                ...
                // Exploratory Session
                createTranslationIfNotExists("projectHeader.tabs.exploratorySessions", languageCode, "Exploratory Sessions", createdBy);
                createTranslationIfNotExists("exploratory.workspace.title", languageCode, "Exploratory Session Workspace", createdBy);
                createTranslationIfNotExists("exploratory.workspace.badgeDraft", languageCode, "UI Draft", createdBy);
                createTranslationIfNotExists("exploratory.view.charterManagement", languageCode, "Charter Management", createdBy);
                createTranslationIfNotExists("exploratory.view.sessionList", languageCode, "Session List", createdBy);
                createTranslationIfNotExists("exploratory.view.sessionEditor", languageCode, "Session Editor", createdBy);
                createTranslationIfNotExists("exploratory.view.debriefApproval", languageCode, "Debrief/Approval", createdBy);
                createTranslationIfNotExists("exploratory.view.sessionDetail", languageCode, "Session Detail", createdBy);
                createTranslationIfNotExists("exploratory.charter.filter.status", languageCode, "Status Filter", createdBy);
                createTranslationIfNotExists("exploratory.charter.create", languageCode, "Create Charter", createdBy);
                createTranslationIfNotExists("exploratory.charter.mission", languageCode, "Mission", createdBy);
                createTranslationIfNotExists("exploratory.charter.sessionCount", languageCode, "Runs {count}", createdBy);
                createTranslationIfNotExists("exploratory.charter.totalBugs", languageCode, "Total Bugs {count}", createdBy);
                createTranslationIfNotExists("exploratory.charter.dialog.createTitle", languageCode, "Create Charter", createdBy);
                createTranslationIfNotExists("exploratory.charter.dialog.editTitle", languageCode, "Edit Charter", createdBy);
                createTranslationIfNotExists("exploratory.charter.dialog.name", languageCode, "Charter Name", createdBy);
                createTranslationIfNotExists("exploratory.charter.dialog.mission", languageCode, "Mission", createdBy);
                createTranslationIfNotExists("exploratory.charter.dialog.status", languageCode, "Status", createdBy);
                createTranslationIfNotExists("exploratory.session.filter.tester", languageCode, "Tester", createdBy);
                createTranslationIfNotExists("exploratory.session.filter.linkedCharter", languageCode, "Linked Charter", createdBy);
                createTranslationIfNotExists("exploratory.session.filter.minBugs", languageCode, "Min Bugs", createdBy);
                createTranslationIfNotExists("exploratory.session.filter.periodFrom", languageCode, "Period From", createdBy);
                createTranslationIfNotExists("exploratory.session.filter.periodTo", languageCode, "Period To", createdBy);
                createTranslationIfNotExists("exploratory.session.label.bugs", languageCode, "Bugs {count}", createdBy);
                createTranslationIfNotExists("exploratory.session.label.meta", languageCode, "Period {date} | Tester {tester} | Charter {charter}", createdBy);
                createTranslationIfNotExists("exploratory.editor.header.title", languageCode, "Header", createdBy);
                createTranslationIfNotExists("exploratory.editor.header.elapsed", languageCode, "Elapsed {value}", createdBy);
                createTranslationIfNotExists("exploratory.editor.header.paused", languageCode, "Paused {value}", createdBy);
                ...
                createTranslationIfNotExists("exploratory.editor.field.environment", languageCode, "Environment", createdBy);
                createTranslationIfNotExists("exploratory.editor.field.version", languageCode, "Version", createdBy);
                createTranslationIfNotExists("exploratory.editor.field.tags", languageCode, "Tags", createdBy);
                createTranslationIfNotExists("exploratory.editor.charterSection.title", languageCode, "Charter Section", createdBy);
                createTranslationIfNotExists("exploratory.editor.charterSection.assigned", languageCode, "Assigned Charter", createdBy);
                createTranslationIfNotExists("exploratory.editor.charterSection.autoMission", languageCode, "Auto-bound Mission", createdBy);
                createTranslationIfNotExists("exploratory.editor.timeSection.title", languageCode, "Time Allocation", createdBy);
                ...
                createTranslationIfNotExists("exploratory.editor.timeSection.total", languageCode, "Total {total}%", createdBy);
                createTranslationIfNotExists("exploratory.editor.timeSection.pausedMinutes", languageCode, "Auto-reflected paused time {minutes}m", createdBy);
                createTranslationIfNotExists("exploratory.editor.timeSection.ratioWarning", languageCode, "Time allocation total is not 100%.", createdBy);
                createTranslationIfNotExists("exploratory.editor.notes.title", languageCode, "Test Notes", createdBy);
                createTranslationIfNotExists("exploratory.editor.notes.flow", languageCode, "Flow", createdBy);
                createTranslationIfNotExists("exploratory.editor.notes.coverage", languageCode, "Coverage", createdBy);
                createTranslationIfNotExists("exploratory.editor.notes.oracle", languageCode, "Oracle", createdBy);
                createTranslationIfNotExists("exploratory.editor.notes.activity", languageCode, "Activity Detail", createdBy);
                createTranslationIfNotExists("exploratory.editor.issue.title", languageCode, "Bugs/Issues", createdBy);
                createTranslationIfNotExists("exploratory.editor.issue.bugHeadline", languageCode, "Bug Headline Link", createdBy);
                createTranslationIfNotExists("exploratory.editor.issue.blockers", languageCode, "Blockers", createdBy);
                createTranslationIfNotExists("exploratory.editor.issue.questions", languageCode, "Open Questions", createdBy);
                createTranslationIfNotExists("exploratory.editor.artifact.title", languageCode, "Data/Artifacts", createdBy);
                createTranslationIfNotExists("exploratory.editor.artifact.testData", languageCode, "Test Data", createdBy);
                createTranslationIfNotExists("exploratory.editor.artifact.upload", languageCode, "Upload Evidence", createdBy);
                createTranslationIfNotExists("exploratory.editor.artifact.empty", languageCode, "No uploaded files.", createdBy);
                createTranslationIfNotExists("exploratory.editor.artifact.sizeKb", languageCode, "{size} KB", createdBy);
                createTranslationIfNotExists("exploratory.editor.evaluation.title", languageCode, "Evaluation/Action", createdBy);
                createTranslationIfNotExists("exploratory.editor.evaluation.achievement", languageCode, "Charter Achievement {value}%", createdBy);
                createTranslationIfNotExists("exploratory.editor.evaluation.overall", languageCode, "Overall Evaluation", createdBy);
                createTranslationIfNotExists("exploratory.editor.evaluation.nextCharter", languageCode, "Suggested Next Charter", createdBy);
                createTranslationIfNotExists("exploratory.debrief.report.title", languageCode, "Debrief Report", createdBy);
                createTranslationIfNotExists("exploratory.debrief.report.meta", languageCode, "Session: Sprint 22 payment exploration | Tester: Kim QA | Status: DONE", createdBy);
                createTranslationIfNotExists("exploratory.debrief.report.summary", languageCode, "Summary: Intermittent timeout reproduced during payment approval. Duplicate approval risk found in retry flow.", createdBy);
                createTranslationIfNotExists("exploratory.debrief.report.keyBugs", languageCode, "Key bugs: PAY-421, PAY-433", createdBy);
                createTranslationIfNotExists("exploratory.debrief.report.evidence", languageCode, "Evidence: screenshot_0210.png, payment-retry.log", createdBy);
                createTranslationIfNotExists("exploratory.debrief.checklist.title", languageCode, "Checklist", createdBy);
                createTranslationIfNotExists("exploratory.debrief.checklist.scope", languageCode, "Charter scope compliance", createdBy);
                createTranslationIfNotExists("exploratory.debrief.checklist.timebox", languageCode, "Timebox/paused time recorded", createdBy);
                createTranslationIfNotExists("exploratory.debrief.checklist.evidence", languageCode, "Bug evidence attached", createdBy);
                createTranslationIfNotExists("exploratory.debrief.checklist.action", languageCode, "Follow-up action proposed", createdBy);
                createTranslationIfNotExists("exploratory.debrief.leadComment", languageCode, "Lead Comment", createdBy);
                createTranslationIfNotExists("exploratory.debrief.action.approve", languageCode, "Approve", createdBy);
                createTranslationIfNotExists("exploratory.debrief.action.requestChanges", languageCode, "Request Changes", createdBy);
                createTranslationIfNotExists("exploratory.detail.timeline.title", languageCode, "Session Activity Timeline (Read-only)", createdBy);
                createTranslationIfNotExists("exploratory.detail.timeline.start.primary", languageCode, "10:02 Session started", createdBy);
                createTranslationIfNotExists("exploratory.detail.timeline.start.secondary", languageCode, "Charter bound: payment failure recovery exploration", createdBy);
                createTranslationIfNotExists("exploratory.detail.timeline.bug.primary", languageCode, "10:27 Bug found", createdBy);
                createTranslationIfNotExists("exploratory.detail.timeline.bug.secondary", languageCode, "PAY-421 created, 2 evidence files attached", createdBy);
                createTranslationIfNotExists("exploratory.detail.timeline.pause.primary", languageCode, "10:41 Pause/Resume", createdBy);
                createTranslationIfNotExists("exploratory.detail.timeline.pause.secondary", languageCode, "Paused 4 minutes due to unstable environment, then resumed", createdBy);
                createTranslationIfNotExists("exploratory.detail.timeline.done.primary", languageCode, "11:03 Ended and approved", createdBy);
                createTranslationIfNotExists("exploratory.detail.timeline.done.secondary", languageCode, "Lead approver: Choi Lead (2026-02-10)", createdBy);
                createTranslationIfNotExists("exploratory.detail.archive.title", languageCode, "Final Approved Report Archive", createdBy);
