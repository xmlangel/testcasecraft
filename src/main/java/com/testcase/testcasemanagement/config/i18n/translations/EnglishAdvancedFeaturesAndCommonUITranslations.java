...
public class EnglishAdvancedFeaturesAndCommonUITranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("organization.form.nameRequired", languageCode, "Organization name is required",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dialog.delete.warning", languageCode, "This action cannot be undone",
                createdBy);
        ...
        createTranslationIfNotExists("dashboard.chart.barChart.title", languageCode, "Monthly Test Execution Trend",
                createdBy);
        ...
        createTranslationIfNotExists("table.pagination.info", languageCode, "Showing {from} to {to} of {total} entries",
                createdBy);
        ...
        createTranslationIfNotExists("search.results.noResults", languageCode, "No results found for your search",
                createdBy);
        ...
        createTranslationIfNotExists("notification.email.testResult", languageCode, "Test Result Notification",
                createdBy);
        createTranslationIfNotExists("notification.email.projectUpdate", languageCode, "Project Update Notification",
                createdBy);
        ...
        createTranslationIfNotExists("header.nav.organizationManagement", languageCode, "Organization Management",
                createdBy);
        createTranslationIfNotExists("header.nav.userManagement", languageCode, "User Management", createdBy);
        createTranslationIfNotExists("organization.dashboard.title", languageCode, "System Dashboard", createdBy);
        createTranslationIfNotExists("organization.dashboard.metrics.totalUsers", languageCode, "Total Users",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.metrics.activeProjects", languageCode, "Active Projects",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.metrics.testCases", languageCode, "Test Cases", createdBy);
        createTranslationIfNotExists("organization.dashboard.metrics.completedTests", languageCode, "Completed Tests",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.stats.title", languageCode, "Organization Statistics",
                createdBy);
        ...
        createTranslationIfNotExists("rag.upload.description", languageCode,
                "Upload PDF, DOCX, DOC, TXT files to register them in the RAG system. (Maximum 50MB)", createdBy);
        createTranslationIfNotExists("rag.upload.dragAndDrop", languageCode, "Drag files here or click to select",
                createdBy);
        ...
        createTranslationIfNotExists("rag.upload.error.noFilesSelected", languageCode, "Please select files to upload.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.document.deleteDialog.title", languageCode, "Confirm Document Deletion",
                createdBy);
        createTranslationIfNotExists("rag.document.deleteDialog.message", languageCode,
                "Are you sure you want to delete this document? This action cannot be undone.", createdBy);
        ...
        createTranslationIfNotExists("rag.document.global.promoteAction", languageCode, "Move to Global Library",
                createdBy);
        createTranslationIfNotExists("rag.document.global.requestAction", languageCode, "Request Global Registration",
                createdBy);
        ...
        createTranslationIfNotExists("rag.document.global.promoteDescription", languageCode,
                "Move this document to the global RAG knowledge base accessible to every project.", createdBy);
        ...
        createTranslationIfNotExists("rag.document.global.requestTitle", languageCode, "Request Global Registration",
                createdBy);
        ...
        createTranslationIfNotExists("rag.similar.noResults", languageCode, "No results found. Try different keywords.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.similar.noHighSimilarityResults", languageCode,
                "No documents with 82% or higher similarity found. See below for lower similarity results.", createdBy);
        ...
        createTranslationIfNotExists("rag.similar.searchMethod.hybridRerank", languageCode, "Hybrid + Reranker ⭐",
                createdBy);
        ...
        createTranslationIfNotExists("rag.similar.searchMethod.vector.info", languageCode,
                "📊 Search based on semantic similarity. Finds documents with similar meanings.", createdBy);
        ...
        createTranslationIfNotExists("rag.similar.searchMethod.hybridRerank.info", languageCode,
                "⭐ Reranks hybrid search results for the highest quality. (Processing time: ~2-3x)", createdBy);
        ...
        createTranslationIfNotExists("rag.chat.deleteThreadConfirm", languageCode,
                "Are you sure you want to delete this thread? All conversation history will be deleted.", createdBy);
        ...
        createTranslationIfNotExists("rag.chat.editPlaceholder", languageCode, "Enter the revised response content.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chat.deleteMessageConfirm", languageCode,
                "Are you sure you want to delete this response? This action cannot be undone.", createdBy);
        createTranslationIfNotExists("rag.chat.threadTitleRequired", languageCode, "Please enter a thread title.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chat.threadNotFound", languageCode, "Cannot find the selected thread.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chat.threadMessagesEmpty", languageCode, "No messages in this conversation.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chat.llmNotConfigured", languageCode, "Default LLM Configuration Required",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chunks.summaryLoadFailed", languageCode, "Failed to load LLM summary.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chunks.filteredMode", languageCode, "Showing only AI-referenced chunks",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chunks.viewCombinedSummary", languageCode, "View LLM Analysis Summary",
                createdBy);
        createTranslationIfNotExists("rag.chunks.documentSummaryTitle", languageCode, "LLM Analysis Summary",
                createdBy);
        createTranslationIfNotExists("rag.chunks.noLlmSummary", languageCode, "No LLM analysis summary available yet.",
                createdBy);
        createTranslationIfNotExists("rag.chunks.loadingLlmSummary", languageCode, "Loading LLM analysis summary...",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chunks.summaryNotReady", languageCode, "Summary is not available yet.",
                createdBy);
        createTranslationIfNotExists("rag.preview.loading", languageCode, "Loading PDF...", createdBy);
        ...
        createTranslationIfNotExists("rag.analysis.selectedConfigInfo", languageCode, "Selected Configuration Info",
                createdBy);
        ...
        createTranslationIfNotExists("rag.analysis.promptTemplateHelper", languageCode, "Use {chunk_text} placeholder",
                createdBy);
        ...
        // Cost warning dialog
        createTranslationIfNotExists("rag.analysis.costWarning.title", languageCode, "Estimated LLM Analysis Cost",
                createdBy);
        ...
        createTranslationIfNotExists("rag.analysis.costWarning.targetSection", languageCode, "Analysis Target",
                createdBy);
        createTranslationIfNotExists("rag.analysis.costWarning.chunkCount", languageCode, "Total {count} Chunks",
                createdBy);
        ...
        createTranslationIfNotExists("rag.analysis.costWarning.costSection", languageCode, "Estimated Cost (USD)",
                createdBy);
        ...
        createTranslationIfNotExists("rag.analysis.costWarning.confirm", languageCode, "Confirm & Start Analysis",
                createdBy);
        createTranslationIfNotExists("rag.analysis.costWarning.starting", languageCode, "Starting...", createdBy);
        createTranslationIfNotExists("rag.analysis.error.costEstimate", languageCode, "Failed to estimate cost.",
                createdBy);
        createTranslationIfNotExists("rag.analysis.error.statusCheck", languageCode, "Failed to check analysis status.",
                createdBy);
        createTranslationIfNotExists("rag.analysis.error.startAnalysis", languageCode, "Failed to start LLM analysis.",
                createdBy);
        ...
        createTranslationIfNotExists("attachment.success.upload", languageCode, "File uploaded successfully.",
                createdBy);
        createTranslationIfNotExists("attachment.success.delete", languageCode, "Attachment deleted successfully.",
                createdBy);
        createTranslationIfNotExists("attachment.error.auth.failed", languageCode, "User authentication failed.",
                createdBy);
        createTranslationIfNotExists("attachment.error.upload.validation", languageCode, "File validation failed.",
                createdBy);
        createTranslationIfNotExists("attachment.error.upload.io", languageCode,
                "An error occurred while saving the file.", createdBy);
        createTranslationIfNotExists("attachment.error.upload.general", languageCode, "A server error occurred.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.llmAnalysis.status.notStartedMessage", languageCode,
                "LLM analysis has not been started yet. Please start LLM analysis from the document list.", createdBy);
        ...
        createTranslationIfNotExists("rag.document.summary.totalChunksLabel", languageCode, "{count} chunks in total",
                createdBy);
        createTranslationIfNotExists("rag.document.summary.analyzedChunksLabel", languageCode, "Analyzed: {count}",
                createdBy);
        createTranslationIfNotExists("rag.document.summary.progressLabel", languageCode, "Progress: {progress}%",
                createdBy);
        createTranslationIfNotExists("rag.document.summary.chunkTemplate", languageCode, "📄 Chunk {chunkNumber}",
                createdBy);
        createTranslationIfNotExists("rag.document.summary.progressFormat", languageCode, "{analyzed}/{total} chunks",
                createdBy);
        ...
        createTranslationIfNotExists("rag.document.error.listFailed", languageCode, "Failed to retrieve document list.",
                createdBy);
        createTranslationIfNotExists("rag.document.error.uploadFailed", languageCode, "Failed to upload document.",
                createdBy);
        createTranslationIfNotExists("rag.document.error.deleteFailed", languageCode, "Failed to delete document.",
                createdBy);
        createTranslationIfNotExists("rag.document.error.downloadFailed", languageCode, "Failed to download document.",
                createdBy);
        createTranslationIfNotExists("rag.document.error.analyzeFailed", languageCode, "Failed to analyze document.",
                createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.title", languageCode, "LLM Configuration Management", createdBy);
        createTranslationIfNotExists("admin.llmConfig.addConfig", languageCode, "Add LLM Configuration", createdBy);
        createTranslationIfNotExists("admin.llmConfig.editConfig", languageCode, "Edit LLM Configuration", createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.testConnection", languageCode, "Test Connection", createdBy);
        createTranslationIfNotExists("admin.llmConfig.setAsDefault", languageCode, "Set as Default", createdBy);
        createTranslationIfNotExists("admin.llmConfig.noConfigs", languageCode, "No LLM configurations available",
                createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.message.connectionFailed", languageCode, "Connection test failed",
                createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.tab.configList", languageCode, "LLM Configuration List",
                createdBy);
        createTranslationIfNotExists("admin.llmConfig.tab.template", languageCode, "Default Template", createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.template.downloadJson", languageCode, "Download JSON", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.usageTitle", languageCode, "How to Use:", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.usage1", languageCode,
                "1. This template is automatically applied when creating new LLM configurations.", createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.template.usage3", languageCode,
                "3. When requesting \"test case\" in RAG chat, this template is automatically referenced.", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.description", languageCode,
                "Manage the global knowledge base automatically referenced by all projects. (Admin only)", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.analysisStatus", languageCode, "Analysis Status", createdBy);
        createTranslationIfNotExists("admin.globalDoc.parser", languageCode, "Parser", createdBy);
        createTranslationIfNotExists("admin.globalDoc.embeddingStatus", languageCode, "Embedding Status", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.info.whatIsTitle", languageCode, "📚 What are Global Documents?",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.whatIsDescription", languageCode,
                ...
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.examplesTitle", languageCode, "💡 Use Cases:", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.action.viewChunks", languageCode, "View Chunks", createdBy);
        createTranslationIfNotExists("admin.globalDoc.action.download", languageCode, "Download", createdBy);
        createTranslationIfNotExists("admin.globalDoc.action.analyze", languageCode, "Analyze Document", createdBy);
        createTranslationIfNotExists("admin.globalDoc.action.generateEmbedding", languageCode, "Generate Embedding",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.action.generateEmbeddings", languageCode, "Generate Embedding",
                createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.message.analyzeFailed", languageCode, "Failed to start analysis",
                createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.message.downloadFailed", languageCode, "Download failed",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.viewChunksFailed", languageCode, "Failed to view chunks",
                createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.message.maxSize", languageCode, "File size cannot exceed 50MB",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.fileSizeLimit", languageCode,
                "File size cannot exceed 50MB", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.unknownError", languageCode, "Unknown error", createdBy);
        createTranslationIfNotExists("admin.globalDoc.chunks.title", languageCode, "Document Chunks", createdBy);
        createTranslationIfNotExists("admin.globalDoc.chunks.chunkNumber", languageCode, "Chunk #{0}", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.preview.loading", languageCode, "Unable to load preview.",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.requests.title", languageCode, "📨 Global Document Requests",
                createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.requests.approveNote", languageCode, "Approval note (optional)",
                createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.requests.rejectNote", languageCode, "Rejection reason (optional)",
                createdBy);
