...
public class EnglishAdvancedFeaturesAndCommonUITranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("admin.llmConfig.createConfig", languageCode, "Create LLM Configuration", createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.noConfigs", languageCode, "No LLM configurations available", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.allFieldsRequired", languageCode, "Please fill in all required fields", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.connectionSuccess", languageCode, "Connection test successful!", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.connectionFailed", languageCode, "Connection test failed", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.invalidJson", languageCode, "Template is not valid JSON format", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.confirmDelete", languageCode, "Are you sure you want to delete this LLM configuration?", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.deleted", languageCode, "LLM configuration has been deleted", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.updated", languageCode, "LLM configuration has been updated", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.created", languageCode, "LLM configuration has been created", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.defaultChanged", languageCode, "Default LLM configuration has been changed", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.activeChanged", languageCode, "LLM configuration active status has been changed", createdBy);
        createTranslationIfNotExists("admin.llmConfig.tab.configList", languageCode, "LLM Configuration List", createdBy);
        createTranslationIfNotExists("admin.llmConfig.tab.template", languageCode, "Default Template", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.title", languageCode, "📋 Test Case Generation Default Template", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.description1", languageCode, "This template is automatically set when creating a new LLM configuration and is used as a reference format when requesting AI to generate test cases.", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.description2", languageCode, "You can modify this template for each LLM configuration.", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.label", languageCode, "Default Template JSON:", createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.template.usage1", languageCode, "1. This template is automatically applied when creating new LLM configurations.", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.usage2", languageCode, "2. You can modify this template individually for each LLM configuration.", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.usage3", languageCode, "3. When requesting \"test case\" in RAG chat, this template is automatically referenced.", createdBy);
        createTranslationIfNotExists("admin.globalDoc.title", languageCode, "🌐 Global RAG Document Management", createdBy);
        createTranslationIfNotExists("admin.globalDoc.description", languageCode, "Manage the global knowledge base automatically referenced by all projects. (Admin only)", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.noDocuments", languageCode, "No global documents yet. Upload your first document!", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.info.whatIsTitle", languageCode, "📚 What are Global Documents?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.whatIsDescription", languageCode, "A global knowledge base automatically referenced by all projects. Managed with a special project ID ({0}).", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.examplesTitle", languageCode, "💡 Use Cases:", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example1", languageCode, "Company-wide coding conventions and development guidelines", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example2", languageCode, "Testing standards and quality management documents", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example3", languageCode, "Common project reference documents (API specs, architecture guides, etc.)", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example4", languageCode, "Organization-wide best practices and learning materials", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.techSpecsTitle", languageCode, "⚙️ Technical Specifications:", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.supportedFormats", languageCode, "Supported formats: PDF, DOCX, DOC, TXT (max 50MB)", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.autoSearch", languageCode, "Automatically searched in all project RAG Q&A", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.adminOnly", languageCode, "Upload/delete available to admins only (ADMIN permission required)", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.action.generateEmbedding", languageCode, "Generate Embedding", createdBy);
        createTranslationIfNotExists("admin.globalDoc.action.generateEmbeddings", languageCode, "Generate Embedding", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.uploadSuccess", languageCode, "Global document \"{0}\" has been uploaded", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.uploadFailed", languageCode, "Failed to upload global document", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.deleteSuccess", languageCode, "Global document \"{0}\" has been deleted", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.deleteFailed", languageCode, "Failed to delete global document", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.uploaded", languageCode, "Global document \"{0}\" has been uploaded", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.deleted", languageCode, "Global document \"{0}\" has been deleted", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmDelete", languageCode, "Are you sure you want to delete the global document \"{0}\"?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmAnalyze", languageCode, "Are you sure you want to analyze the document \"{0}\"?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmEmbedding", languageCode, "Are you sure you want to generate embeddings for the document \"{0}\"?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmEmbeddings", languageCode, "Are you sure you want to generate embeddings for the document \"{0}\"?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.analyzeStarted", languageCode, "Document \"{0}\" analysis started", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.analyzeFailed", languageCode, "Failed to start analysis", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.embeddingStarted", languageCode, "Document \"{0}\" embedding generation started", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.embeddingsStarted", languageCode, "Document \"{0}\" embedding generation started", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.embeddingsFailed", languageCode, "Failed to generate embeddings", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.downloaded", languageCode, "Document \"{0}\" download completed", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.downloadSuccess", languageCode, "Document \"{0}\" download completed", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.downloadFailed", languageCode, "Download failed", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.viewChunksFailed", languageCode, "Failed to view chunks", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.previewFailed", languageCode, "Preview failed", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.pdfOnly", languageCode, "Only PDF files can be previewed.", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.supportedFormats", languageCode, "Supported file formats: PDF, DOCX, DOC, TXT", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.maxSize", languageCode, "File size cannot exceed 50MB", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.fileSizeLimit", languageCode, "File size cannot exceed 50MB", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.chunks.noChunks", languageCode, "No chunks available.", createdBy);
