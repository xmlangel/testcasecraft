...
public class TranslationDataInitializer {
  ...
  public void initialize() {
    ...
    step(
        "koreanTranslationManagementTranslations",
    ...
    step(
        "koreanTestCaseAndAutomationTranslations",
    ...
    step(
        "englishTranslationManagementTranslations",
    ...
    step(
        "englishTestCaseAndAutomationTranslations",
