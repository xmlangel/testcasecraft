...
public class EnglishTestResultTranslations {
  ...
  public void initialize() {
    ...
    createTranslationIfNotExists(
        "testResult.mainPage.title", languageCode, "Test Results", createdBy);
    createTranslationIfNotExists(
        "testResult.mainPage.description",
        languageCode,
        "Analyze and manage all test results of the project in an integrated way.",
        createdBy);
    createTranslationIfNotExists(
        "testResult.tab.statistics", languageCode, "Statistics", createdBy);
    createTranslationIfNotExists(
        "testResult.tab.statisticsFull", languageCode, "Statistics Dashboard", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testResult.form.testResult", languageCode, "Test Result", createdBy);
    createTranslationIfNotExists(
        "testResult.form.preCondition", languageCode, "Pre-condition", createdBy);
    createTranslationIfNotExists(
        "testResult.form.testSteps", languageCode, "Test Steps", createdBy);
    createTranslationIfNotExists(
        "testResult.form.expectedResult", languageCode, "Expected Result", createdBy);
    createTranslationIfNotExists(
        "testResult.form.postCondition", languageCode, "Post Condition", createdBy);
    createTranslationIfNotExists(
        "testResult.form.automationStatus", languageCode, "Automation Status", createdBy);
    ...
    createTranslationIfNotExists(
        "testResult.form.executionType", languageCode, "Execution Type", createdBy);
    createTranslationIfNotExists("testResult.form.tags", languageCode, "Tags", createdBy);
    createTranslationIfNotExists(
        "testResult.form.testTechnique", languageCode, "Test Technique", createdBy);
    createTranslationIfNotExists("testResult.form.notes", languageCode, "Notes", createdBy);
    createTranslationIfNotExists(
        "testResult.form.notesPlaceholder", languageCode, "Notes ({length}/10,000)", createdBy);
    createTranslationIfNotExists(
        "testResult.form.notesHelp",
        languageCode,
        "Please record any special findings or additional information from the test process.",
        createdBy);
    createTranslationIfNotExists(
        "testResult.form.notesLimitWarning",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Exceeded 10,000 characters. Please attach long content as a file.",
        createdBy);
    createTranslationIfNotExists(
        "testResult.form.notesFileRecommendation",
        languageCode,
        "For long content, file attachment is recommended.",
        createdBy);
    createTranslationIfNotExists("testResult.form.mode.text", languageCode, "Text", createdBy);

    // Latest Result Badge and Statistics
    createTranslationIfNotExists(
        "testResult.badge.latest", languageCode, "Latest Result", createdBy);
    createTranslationIfNotExists("testResult.badge.latestShort", languageCode, "LATEST", createdBy);
    createTranslationIfNotExists(
        "testResult.statistics.latestSuccessRate", languageCode, "Latest Success Rate", createdBy);
    createTranslationIfNotExists(
        "testResult.statistics.totalCaseCount", languageCode, "Total Case Count", createdBy);
    createTranslationIfNotExists(
        "testResult.statistics.totalExecutionCount",
        languageCode,
        "Total Execution Count",
        createdBy);
    createTranslationIfNotExists(
        "testResult.pieChart.totalCaseCount", languageCode, "Total TestCase Count", createdBy);
    createTranslationIfNotExists(
        "testResult.pieChart.totalExecutionCount",
        languageCode,
        "Total Execution Count",
        createdBy);
    ...
    createTranslationIfNotExists(
        "testResult.filteredCases.failTitle", languageCode, "Failed Test Cases", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Save test result to view attachments.",
        createdBy);
    createTranslationIfNotExists(
        "testResult.error.saveFailed", languageCode, "Failed to save result.", createdBy);
    createTranslationIfNotExists(
        "testResult.error.testCaseLoadFailed",
        languageCode,
    ...
    createTranslationIfNotExists(
        "testResult.button.jiraStatusCheck", languageCode, "Check JIRA Status", createdBy);
    ...
    createTranslationIfNotExists(
        "testResult.button.advancedExport", languageCode, "Advanced Export", createdBy);
    createTranslationIfNotExists(
        "testResult.button.viewDetail", languageCode, "View Details", createdBy);
    createTranslationIfNotExists("testResult.button.edit", languageCode, "Edit", createdBy);

    // Column Display Settings Menu
    createTranslationIfNotExists(
        "testResult.columnMenu.title", languageCode, "Column Display Settings", createdBy);
    createTranslationIfNotExists(
        "testResult.columnMenu.description", languageCode, "Select columns to display", createdBy);
    createTranslationIfNotExists(
        "testResult.columnMenu.showAll", languageCode, "Show All", createdBy);
    createTranslationIfNotExists(
        "testResult.columnMenu.showEssential", languageCode, "Show Essential Only", createdBy);
    createTranslationIfNotExists(
        "testResult.columnMenu.required", languageCode, "Required Column", createdBy);
    createTranslationIfNotExists(
        "testResult.columnMenu.summary",
        languageCode,
        "Displaying {visible}/{total} columns",
        createdBy);
    createTranslationIfNotExists(
        "testResult.columnMenu.tip",
        languageCode,
        "Tip: Test Case and Result are always displayed as required columns",
        createdBy);
    ...
    createTranslationIfNotExists(
        "testResult.tooltip.noPostCondition", languageCode, "No post-condition", createdBy);
    createTranslationIfNotExists("testResult.steps.empty", languageCode, "No steps", createdBy);
    createTranslationIfNotExists(
        "testResult.steps.description", languageCode, "Description", createdBy);
    ...
    createTranslationIfNotExists(
        "testResult.column.preCondition", languageCode, "Pre-condition", createdBy);
    createTranslationIfNotExists(
        "testResult.column.postCondition", languageCode, "Post Condition", createdBy);
    createTranslationIfNotExists("testResult.column.steps", languageCode, "Step Info", createdBy);
    createTranslationIfNotExists(
        "testResult.column.linkedDocuments", languageCode, "Linked RAG Docs", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testResult.chart.tooltip",
        languageCode,
        "Compare results by test plan or executor.",
        createdBy);
    createTranslationIfNotExists("testResult.chart.yAxisCount", languageCode, "Count", createdBy);
    createTranslationIfNotExists(
        "testResult.chart.yAxisPercent", languageCode, "Percentage (%)", createdBy);
    createTranslationIfNotExists(
        "testResult.chart.compareItems", languageCode, "Total {count} items compared", createdBy);
    createTranslationIfNotExists(
        "testResult.chart.loadingData", languageCode, "Loading chart data...", createdBy);
    createTranslationIfNotExists(
        "testResult.chart.noCompareData", languageCode, "No data to compare.", createdBy);
    createTranslationIfNotExists(
        "testResult.statistics.title", languageCode, "Test Result Statistics", createdBy);
    createTranslationIfNotExists(
        "testResult.statistics.loading", languageCode, "Loading...", createdBy);
    createTranslationIfNotExists(
        "testResult.statistics.error", languageCode, "Error: {error}", createdBy);
    createTranslationIfNotExists(
        "testResult.statistics.noData", languageCode, "No data", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testResult.pieChart.loading", languageCode, "Loading chart data...", createdBy);
    createTranslationIfNotExists(
        "testResult.pieChart.noData", languageCode, "No chart data available.", createdBy);
    createTranslationIfNotExists("testResult.pieChart.count", languageCode, "Count", createdBy);
    createTranslationIfNotExists(
        "testResult.pieChart.percentage", languageCode, "Percentage", createdBy);
    createTranslationIfNotExists(
        "testResult.pieChart.totalTestCases", languageCode, "Total test cases: {total}", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.title", languageCode, "Statistics Filter", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.applied", languageCode, "{count} applied", createdBy);
    createTranslationIfNotExists("testResult.filter.refresh", languageCode, "Refresh", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.refreshTooltip", languageCode, "Refresh data", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.apply", languageCode, "Apply Filter", createdBy);
    createTranslationIfNotExists("testResult.filter.clear", languageCode, "Clear", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.clearTooltip", languageCode, "Clear all filters", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.testPlan", languageCode, "Test Plan", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.allPlans", languageCode, "All Plans", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.testExecution", languageCode, "Test Execution", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.allExecutions", languageCode, "All Executions", createdBy);
    createTranslationIfNotExists("testResult.filter.allView", languageCode, "All", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.errorLoadPlans",
        languageCode,
        "Unable to load test plan list.",
        createdBy);
    createTranslationIfNotExists("testResult.filter.period", languageCode, "Period", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.allPeriod", languageCode, "All Time", createdBy);
    ...
    createTranslationIfNotExists(
        "testResult.filter.quarter", languageCode, "Last 3 Months", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.viewType", languageCode, "View Type", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.overviewView", languageCode, "Overview", createdBy);
    createTranslationIfNotExists("testResult.filter.planView", languageCode, "By Plan", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.executorView", languageCode, "By Executor", createdBy);
    createTranslationIfNotExists(
        "testResult.filter.activeFilters", languageCode, "Active filters:", createdBy);
    ...
    createTranslationIfNotExists("testResult.column.result", languageCode, "Result", createdBy);
    createTranslationIfNotExists(
        "testResult.column.preCondition", languageCode, "Precondition", createdBy);
    createTranslationIfNotExists(
        "testResult.column.steps", languageCode, "Step Information", createdBy);
    createTranslationIfNotExists(
        "testResult.column.expectedResults", languageCode, "Expected Results", createdBy);
    ...
    createTranslationIfNotExists(
        "testResult.column.attachments", languageCode, "Attachments", createdBy);
    createTranslationIfNotExists(
        "testResult.column.executedDate", languageCode, "Executed Date", createdBy);
    createTranslationIfNotExists(
        "testResult.column.jiraStatus", languageCode, "JIRA Status", createdBy);
    createTranslationIfNotExists("testResult.button.edit", languageCode, "Edit", createdBy);
    createTranslationIfNotExists(
        "testResult.button.viewDetail", languageCode, "View Details", createdBy);
    createTranslationIfNotExists(
        "testResult.button.viewAttachments", languageCode, "View Attachments", createdBy);
    createTranslationIfNotExists(
        "testResult.button.columnSettings", languageCode, "Column Settings", createdBy);
    createTranslationIfNotExists(
        "testResult.button.changeOrder", languageCode, "Change Order", createdBy);
    ...
    createTranslationIfNotExists(
        "testResult.title.detailList", languageCode, "Test Results Detail List", createdBy);
    createTranslationIfNotExists(
        "testResult.count.results", languageCode, "{count} test results{filtered}", createdBy);
    createTranslationIfNotExists(
        "testResult.error.loadFailure", languageCode, "Unable to load test results", createdBy);
    createTranslationIfNotExists("testResult.defaultValue.root", languageCode, "Root", createdBy);
    createTranslationIfNotExists(
        "testResult.defaultValue.unknownTestCase", languageCode, "Unknown Test Case", createdBy);
    createTranslationIfNotExists(
        "testResult.defaultValue.system", languageCode, "System", createdBy);
    createTranslationIfNotExists("testResult.steps.empty", languageCode, "No steps", createdBy);
    createTranslationIfNotExists(
        "testResult.steps.description", languageCode, "Description", createdBy);
    createTranslationIfNotExists(
        "testResult.steps.expectedResult", languageCode, "Expected Result", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists("testResult.status.skipped", languageCode, "Skipped", createdBy);
    createTranslationIfNotExists(
        "testResult.export.dialog.title", languageCode, "Export Test Results", createdBy);
    createTranslationIfNotExists(
        "testResult.export.section.format", languageCode, "📄 Select Export Format", createdBy);
    createTranslationIfNotExists(
        "testResult.export.section.info", languageCode, "📋 Export Information", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.excel.title", languageCode, "Excel (.xlsx)", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.excel.description",
        languageCode,
        "Includes formatting and charts, optimal for business reports",
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.excel.feature1",
        languageCode,
        "Statistical charts included",
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.excel.feature2", languageCode, "Formatting preserved", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.excel.feature3", languageCode, "Filtering enabled", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "For printing and sharing, fixed layout",
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.pdf.feature1", languageCode, "Print optimized", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.pdf.feature2", languageCode, "Fixed layout", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.pdf.feature3",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "🖨️ PDF is optimized for A4 paper and great for printing.",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "For data analysis, lightweight file size",
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.csv.feature1",
        languageCode,
        "Data analysis optimized",
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.csv.feature2", languageCode, "Lightweight size", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.csv.feature3",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "📈 CSV contains data only; open with Excel or Google Sheets.",
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.html.title", languageCode, "HTML (.html)", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.html.description",
        languageCode,
        "Web report, keeps current theme · open directly in a browser",
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.html.feature1", languageCode, "Report layout", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.html.feature2", languageCode, "Light/Dark theme", createdBy);
    createTranslationIfNotExists(
        "testResult.export.format.html.feature3", languageCode, "Single-file sharing", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.info.totalRows", languageCode, "📊 Total Data Count:", createdBy);
    createTranslationIfNotExists(
        "testResult.export.info.totalRowsValue", languageCode, "{count} rows", createdBy);
    createTranslationIfNotExists(
        "testResult.export.info.columns", languageCode, "🔍 Visible Columns:", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.button.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
        "testResult.export.button.export", languageCode, "Export {format}", createdBy);
    createTranslationIfNotExists(
        "testResult.export.button.exporting", languageCode, "Generating...", createdBy);
    createTranslationIfNotExists(
        "testResult.export.error.noProject", languageCode, "No project selected.", createdBy);
    createTranslationIfNotExists(
        "testResult.export.error.failed",
        languageCode,
        "An error occurred while exporting the file: {message}",
        createdBy);
    createTranslationIfNotExists(
        "testResult.export.error.response",
        languageCode,
        "Export failed: {status} {statusText}",
        createdBy);
    createTranslationIfNotExists(
        "testResult.orderDialog.title", languageCode, "Change Column Order", createdBy);
    createTranslationIfNotExists(
        "testResult.orderDialog.description",
        languageCode,
        "Use the up/down arrow buttons to change the column order",
        createdBy);
    createTranslationIfNotExists(
        "testResult.orderDialog.visible", languageCode, "Visible", createdBy);
    createTranslationIfNotExists(
        "testResult.orderDialog.hidden", languageCode, "Hidden", createdBy);
    createTranslationIfNotExists(
        "testResult.orderDialog.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Test case name, folder path, executor, etc.",
        createdBy);
    createTranslationIfNotExists(
        "testResult.form.title", languageCode, "Test Result Input", createdBy);
    createTranslationIfNotExists(
        "testResult.pieChart.title", languageCode, "Test Result Pie Chart", createdBy);
    createTranslationIfNotExists(
        "testResult.error.testCaseLoadFailed",
        languageCode,
        ...
        createdBy);
    createTranslationIfNotExists(
        "testResult.error.saveFailed", languageCode, "Save failed", createdBy);
    createTranslationIfNotExists(
        "testResult.error.resultRequired", languageCode, "Test result is required", createdBy);
    createTranslationIfNotExists(
        "testResult.pieChart.loading", languageCode, "Loading chart...", createdBy);
    createTranslationIfNotExists(
        "testResult.pieChart.noData", languageCode, "No chart data", createdBy);
    createTranslationIfNotExists("testResult.pieChart.count", languageCode, "Count", createdBy);
    createTranslationIfNotExists(
        "testResult.pieChart.percentage", languageCode, "Percentage", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testResult.form.notesLimitError",
        languageCode,
        "Notes must be within 10,000 characters",
        createdBy);
    createTranslationIfNotExists(
        "testResult.form.notesHelp",
        languageCode,
        "Enter any special notes or additional information during test execution",
        createdBy);
    createTranslationIfNotExists(
        "testResult.form.fileAttachment", languageCode, "File Attachment", createdBy);
    createTranslationIfNotExists(
        "testResult.form.fileUploading", languageCode, "Uploading file...", createdBy);
    createTranslationIfNotExists(
        "testResult.form.fileSelect", languageCode, "Select File", createdBy);
    createTranslationIfNotExists(
        "testResult.form.jiraIntegration", languageCode, "JIRA Integration", createdBy);
    createTranslationIfNotExists(
        "testResult.form.jiraComment", languageCode, "JIRA Comment", createdBy);
  }
