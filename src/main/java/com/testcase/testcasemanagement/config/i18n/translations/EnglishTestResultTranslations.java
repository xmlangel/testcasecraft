...
public class EnglishTestResultTranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("testResult.tab.trendDescription", languageCode,
                "Analyze and compare results by test plan and executor with performance trend analysis", createdBy);
        ...
        createTranslationIfNotExists("testResult.tab.reportDescription", languageCode,
                "Support detailed results by folder and case with JIRA integration status management", createdBy);
        ...
        createTranslationIfNotExists("testResult.form.postCondition", languageCode, "Post Condition", createdBy);
        createTranslationIfNotExists("testResult.form.automationStatus", languageCode, "Automation Status", createdBy);
        ...
        createTranslationIfNotExists("testResult.form.executionType", languageCode, "Execution Type", createdBy);
        createTranslationIfNotExists("testResult.form.tags", languageCode, "Tags", createdBy);
        createTranslationIfNotExists("testResult.form.testTechnique", languageCode, "Test Technique", createdBy);
        createTranslationIfNotExists("testResult.form.notes", languageCode, "Notes", createdBy);
        createTranslationIfNotExists("testResult.form.notesPlaceholder", languageCode, "Notes ({length}/10,000)",
                createdBy);
        createTranslationIfNotExists("testResult.form.notesHelp", languageCode,
                "Please record any special findings or additional information from the test process.", createdBy);
        ...
        createTranslationIfNotExists("testResult.form.jiraIntegration", languageCode, "JIRA Issue Integration",
                createdBy);
        createTranslationIfNotExists("testResult.form.jiraIssueId", languageCode, "JIRA Issue ID (e.g., ICT-123)",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.jira.issueIdLabel", languageCode, "JIRA Issue ID (e.g., ICT-123)",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.file.sizeError", languageCode, "File size must be 10MB or less",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.error.testCaseLoadFailed", languageCode, "Failed to load test case.",
                createdBy);
        createTranslationIfNotExists("testResult.error.resultRequired", languageCode, "Please select a test result.",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.chart.compareItems", languageCode, "Total {count} items compared",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.pieChart.totalTestCases", languageCode, "Total test cases: {total}",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.filter.errorLoadPlans", languageCode, "Unable to load test plan list.",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.tooltip.noExpectedResults", languageCode, "No expected results",
                createdBy);
        createTranslationIfNotExists("testResult.tooltip.noNotes", languageCode, "No notes", createdBy);
        createTranslationIfNotExists("testResult.tooltip.multipleJiraIds", languageCode, "Total {count} JIRA IDs",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.count.results", languageCode, "{count} test results{filtered}",
                createdBy);
        createTranslationIfNotExists("testResult.error.loadFailure", languageCode, "Unable to load test results",
                createdBy);
        createTranslationIfNotExists("testResult.defaultValue.root", languageCode, "Root", createdBy);
        createTranslationIfNotExists("testResult.defaultValue.unknownTestCase", languageCode, "Unknown Test Case",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.dialog.attachmentsTitle", languageCode, "Test Result Attachments",
                createdBy);
        createTranslationIfNotExists("testResult.status.pass", languageCode, "Pass", createdBy);
        createTranslationIfNotExists("testResult.status.fail", languageCode, "Fail", createdBy);
        createTranslationIfNotExists("testResult.status.blocked", languageCode, "Blocked", createdBy);
        ...
        createTranslationIfNotExists("testResult.export.section.format", languageCode, "📄 Select Export Format",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.export.format.excel.feature2", languageCode, "Formatting preserved",
                createdBy);
        createTranslationIfNotExists("testResult.export.format.excel.feature3", languageCode, "Filtering enabled",
                createdBy);
        createTranslationIfNotExists("testResult.export.format.excel.alert", languageCode,
                "💡 Excel format includes statistical charts and summary sheets separately.", createdBy);
        ...
        createTranslationIfNotExists("testResult.export.format.pdf.feature3", languageCode, "Universal compatibility",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.export.format.csv.feature1", languageCode, "Data analysis optimized",
                createdBy);
        createTranslationIfNotExists("testResult.export.format.csv.feature2", languageCode, "Lightweight size",
                createdBy);
        createTranslationIfNotExists("testResult.export.format.csv.feature3", languageCode, "Excellent compatibility",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.export.info.columnsList", languageCode, "📂 Columns to Export:",
                createdBy);
        ...
        createTranslationIfNotExists("testResult.error.testCaseLoadFailed", languageCode, "Failed to load test cases",
                createdBy);
