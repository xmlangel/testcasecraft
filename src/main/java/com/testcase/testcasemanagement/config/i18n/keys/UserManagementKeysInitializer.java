...
public class UserManagementKeysInitializer {
    ...
    public void initialize() {
        ...
        createTranslationKeyIfNotExists("userDetail.password.requirements.length", "userDetail", "비밀번호 길이 요구사항",
                "8-100자 길이");
        createTranslationKeyIfNotExists("userDetail.password.requirements.complexity", "userDetail", "비밀번호 복잡도 요구사항",
        ...
        createTranslationKeyIfNotExists("userDetail.password.validation.minLength", "userDetail", "비밀번호 최소 길이 검증",
                "최소 8자 이상이어야 합니다");
        createTranslationKeyIfNotExists("userDetail.password.validation.maxLength", "userDetail", "비밀번호 최대 길이 검증",
                "최대 100자까지 입력 가능합니다");
        createTranslationKeyIfNotExists("userDetail.password.validation.complexity", "userDetail", "비밀번호 복잡도 검증",
        ...
        createTranslationKeyIfNotExists("userDetail.password.validation.mismatch", "userDetail", "비밀번호 불일치 검증",
                "새 비밀번호와 일치하지 않습니다");
        createTranslationKeyIfNotExists("userDetail.password.validation.currentRequired", "userDetail", "현재 비밀번호 필수 검증",
                "현재 비밀번호를 입력해주세요");
        createTranslationKeyIfNotExists("userDetail.password.validation.newRequired", "userDetail", "새 비밀번호 필수 검증",
                "새 비밀번호를 입력해주세요");
        createTranslationKeyIfNotExists("userDetail.password.validation.confirmRequired", "userDetail", "비밀번호 확인 필수 검증",
                "비밀번호 확인을 입력해주세요");
        ...
        createTranslationKeyIfNotExists("profile.version.error", "profile", "버전 정보 로드 실패", "버전 정보를 불러올 수 없습니다.");
    }
