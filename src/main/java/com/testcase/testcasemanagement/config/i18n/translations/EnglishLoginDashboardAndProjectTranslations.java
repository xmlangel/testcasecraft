...
public class EnglishLoginDashboardAndProjectTranslations {
  ...
  public void initialize() {
    ...
    createTranslationIfNotExists(
        "register.confirm_password", languageCode, "Confirm Password", createdBy);
    ...
    createTranslationIfNotExists(
        "register.success", languageCode, "Registration successful. Please log in.", createdBy);
    createTranslationIfNotExists(
    ...
    // Session Expiry
    createTranslationIfNotExists(
        "auth.session.expired.title", languageCode, "Session Expired", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "auth.session.expired.cause", languageCode, "Reason: {cause}", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "project.dialog.createTitle", languageCode, "Create New Project", createdBy);
    createTranslationIfNotExists(
        "project.dialog.editTitle", languageCode, "Edit Project", createdBy);
    ...
    createTranslationIfNotExists(
        "project.form.codePlaceholder", languageCode, "e.g., PROJ001", createdBy);
    createTranslationIfNotExists(
        "project.form.organization", languageCode, "Organization", createdBy);
    createTranslationIfNotExists(
        "project.form.noOrganization",
        languageCode,
        "Independent Project (No Organization)",
        createdBy);
    createTranslationIfNotExists(
        "project.form.description", languageCode, "Description", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists("common.buttons.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
        "dashboard.lastUpdated", languageCode, "Last updated: {date}", createdBy);
    createTranslationIfNotExists(
        "dashboard.refresh.tooltip", languageCode, "Refresh dashboard data", createdBy);
    createTranslationIfNotExists("dashboard.refresh.button", languageCode, "Refresh", createdBy);
    createTranslationIfNotExists(
        "dashboard.loading.data", languageCode, "Loading dashboard data...", createdBy);
    createTranslationIfNotExists(
        "dashboard.loading.chart", languageCode, "Loading chart data...", createdBy);
    createTranslationIfNotExists(
        "dashboard.error.solution", languageCode, "Solution: {action}", createdBy);
    ...
    createTranslationIfNotExists(
        "dashboard.noData.message", languageCode, "No dashboard data to display.", createdBy);
    createTranslationIfNotExists(
        "dashboard.noData.chart", languageCode, "No chart data available.", createdBy);
    createTranslationIfNotExists(
        "dashboard.noData.noActiveTestRuns",
        languageCode,
        "No active test runs available.",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "dashboard.charts.testResultsTrend", languageCode, "Test Results Trend", createdBy);
    createTranslationIfNotExists(
        "dashboard.charts.last15Days", languageCode, "Last 15 days", createdBy);
    createTranslationIfNotExists(
        "dashboard.charts.openTestRunResults", languageCode, "Open Test Run Results", createdBy);
    createTranslationIfNotExists(
        "dashboard.charts.assigneeResults", languageCode, "Results by Assignee", createdBy);
    createTranslationIfNotExists(
        "dashboard.charts.testPlanResults", languageCode, "Test Plan Results", createdBy);
    createTranslationIfNotExists(
        "dashboard.charts.notRunTrend", languageCode, "Not Run Trend", createdBy);
    ...
    createTranslationIfNotExists(
        "dashboard.status.failureRate", languageCode, "Failure rate {rate}%", createdBy);
    createTranslationIfNotExists(
        "dashboard.status.completedCount",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Please select a project to view test plan results.",
        createdBy);
    createTranslationIfNotExists("project.title", languageCode, "Project Management", createdBy);
    createTranslationIfNotExists(
        "project.tabs.byOrganization", languageCode, "Projects by Organization", createdBy);
    createTranslationIfNotExists(
        "project.tabs.independent", languageCode, "Independent Projects", createdBy);
    createTranslationIfNotExists("project.tabs.all", languageCode, "All Projects", createdBy);
    createTranslationIfNotExists(
        "project.stats.projectCount", languageCode, "{count} projects", createdBy);
    createTranslationIfNotExists(
        "project.stats.totalProjectCount", languageCode, "Total {count} projects", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Try creating a personal project that doesn't belong to an organization.",
        createdBy);
    createTranslationIfNotExists(
        "project.buttons.openProject", languageCode, "Open Project", createdBy);
    createTranslationIfNotExists(
        "project.buttons.addProject", languageCode, "Add Project", createdBy);
    createTranslationIfNotExists(
        "project.buttons.createProject", languageCode, "Create Project", createdBy);
    createTranslationIfNotExists(
        "project.buttons.createNew", languageCode, "Create New Project", createdBy);
    createTranslationIfNotExists(
        "project.buttons.createIndependent", languageCode, "Create Independent Project", createdBy);
    createTranslationIfNotExists(
        "project.buttons.createFirstIndependent",
        languageCode,
        "Create First Independent Project",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "userList.loading", languageCode, "Loading user list...", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "userList.stats.totalUsers", languageCode, "Total Users", createdBy);
    createTranslationIfNotExists(
        "userList.stats.activeUsers", languageCode, "Active Users", createdBy);
    createTranslationIfNotExists(
        "userList.stats.inactiveUsers", languageCode, "Inactive Users", createdBy);
    createTranslationIfNotExists(
        "userList.stats.recentRegistrations", languageCode, "Recent Registrations", createdBy);
    ...
    createTranslationIfNotExists(
        "userList.action.moreActions", languageCode, "More Actions", createdBy);
    createTranslationIfNotExists("userList.action.activate", languageCode, "Activate", createdBy);
    createTranslationIfNotExists(
        "userList.action.deactivate", languageCode, "Deactivate", createdBy);
    createTranslationIfNotExists(
        "userList.empty.message", languageCode, "No users match the search criteria.", createdBy);
    createTranslationIfNotExists(
        "userList.empty.resetButton", languageCode, "Reset Search Criteria", createdBy);
    createTranslationIfNotExists(
        "userList.pagination.rowsPerPage", languageCode, "Rows per page:", createdBy);
    createTranslationIfNotExists(
        "userList.pagination.displayedRows", languageCode, "{from}-{to} of {count}", createdBy);
    createTranslationIfNotExists(
        "userDetail.loading", languageCode, "Loading user information...", createdBy);
    createTranslationIfNotExists("userDetail.title", languageCode, "User Information", createdBy);
    createTranslationIfNotExists(
        "userDetail.notFound", languageCode, "User information not found.", createdBy);
    createTranslationIfNotExists(
        "userDetail.editCancel.title", languageCode, "Cancel Edit", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "userDetail.validation.required",
        languageCode,
        "Name and email are required fields.",
        createdBy);
    createTranslationIfNotExists(
        "userDetail.validation.emailFormat",
        languageCode,
        "Please enter a valid email format.",
        createdBy);
    createTranslationIfNotExists(
        "userDetail.error.saveError", languageCode, "An error occurred while saving.", createdBy);
    createTranslationIfNotExists(
        "userDetail.section.basicInfo", languageCode, "Basic Information", createdBy);
    ...
    createTranslationIfNotExists(
        "userDetail.section.statusInfo", languageCode, "Status Information", createdBy);
    createTranslationIfNotExists("userDetail.status.role", languageCode, "Role", createdBy);
    createTranslationIfNotExists(
        "userDetail.status.account", languageCode, "Account Status", createdBy);
    ...
    createTranslationIfNotExists(
        "userDetail.status.activity", languageCode, "Activity Status", createdBy);
    createTranslationIfNotExists(
        "userDetail.section.timeInfo", languageCode, "Time Information", createdBy);
    createTranslationIfNotExists(
        "userDetail.time.createdAt", languageCode, "Created At", createdBy);
    createTranslationIfNotExists(
        "userDetail.time.updatedAt", languageCode, "Last Updated", createdBy);
    createTranslationIfNotExists(
        "userDetail.time.lastLogin", languageCode, "Last Login", createdBy);
    createTranslationIfNotExists(
        "userDetail.time.daysSinceLogin", languageCode, "Days Since Login", createdBy);
    ...
    createTranslationIfNotExists("common.save", languageCode, "Save", createdBy);
    createTranslationIfNotExists(
        "testCaseResult.page.title", languageCode, "Enter Test Result", createdBy);
    ...
    createTranslationIfNotExists(
        "projectHeader.breadcrumb.projects", languageCode, "Projects", createdBy);
    createTranslationIfNotExists(
        "projectHeader.tabs.dashboard", languageCode, "Dashboard", createdBy);
    createTranslationIfNotExists(
        "projectHeader.tabs.testCases", languageCode, "Test Cases", createdBy);
    createTranslationIfNotExists(
        "projectHeader.tabs.testExecution", languageCode, "Test Execution", createdBy);
    createTranslationIfNotExists(
        "projectHeader.tabs.testResults", languageCode, "Test Results", createdBy);
    createTranslationIfNotExists(
        "projectHeader.tabs.automation", languageCode, "Test Automation", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.chart.planComparison",
        languageCode,
        "Test Plan Comparison",
        createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.chart.executorComparison",
        languageCode,
        "Executor Comparison",
        createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.title", languageCode, "Statistics Summary", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.executionRate", languageCode, "Execution Rate", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.successRate", languageCode, "Success Rate", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.jiraLinkRate", languageCode, "JIRA Link Rate", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.lastUpdated", languageCode, "Last Updated", createdBy);
    createTranslationIfNotExists(
        "testResultDashboard.summary.unknown", languageCode, "Unknown", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.error.comparisonLoadFailed",
        languageCode,
        "Failed to load comparison data.",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.error.trendLoadFailed",
        languageCode,
        "Failed to load trend data.",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.loading.trendData", languageCode, "Loading trend data...", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.noData.title", languageCode, "No trend data available", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.noData.description",
        languageCode,
        "No test execution records found for the selected period.",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.label", languageCode, "Period", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last7days", languageCode, "Last 7 days", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last15days", languageCode, "Last 15 days", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last30days", languageCode, "Last 30 days", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last60days", languageCode, "Last 60 days", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.period.last90days", languageCode, "Last 90 days", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chartType.line", languageCode, "Line", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chartType.area", languageCode, "Area", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.summary.avgSuccessRate",
        languageCode,
        "Average Success Rate",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.summary.avgCompletionRate",
        languageCode,
        "Average Completion Rate",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.summary.dataPoints", languageCode, "Data Points", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.summary.successRateChange",
        languageCode,
        "Success Rate Change",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.overallTrend", languageCode, "Test Result Trend", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.testPlanComparison",
        languageCode,
        "Test Plan Comparison",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.assigneeComparison",
        languageCode,
        "Assignee Comparison",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.successAndCompletionRate",
        languageCode,
        "Success and Completion Rate Trend",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.successRate", languageCode, "Success Rate", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.chart.completionRate", languageCode, "Completion Rate", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.tooltip.overallSuccessRate",
        languageCode,
    ...
    createTranslationIfNotExists(
        "testTrendAnalysis.tooltip.unit", languageCode, "cases", createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.legend.overallSuccessRate",
        languageCode,
        "Overall Success Rate",
        createdBy);
    ...
    createTranslationIfNotExists(
        "testTrendAnalysis.prompt.selectTestPlan",
        languageCode,
        "Please select test plans to compare",
        createdBy);
    createTranslationIfNotExists(
        "testTrendAnalysis.prompt.selectAssignee",
        languageCode,
        "Please select assignees to compare",
        createdBy);
    ...
    createTranslationIfNotExists(
        "header.nav.mailSettings", languageCode, "Mail Settings", createdBy);
    createTranslationIfNotExists(
        "header.nav.translationManagement", languageCode, "Translation Management", createdBy);
    createTranslationIfNotExists("header.nav.llmConfig", languageCode, "LLM Settings", createdBy);
    createTranslationIfNotExists(
        "header.nav.managementMenu", languageCode, "Management Menu", createdBy);
    ...
    createTranslationIfNotExists(
        "common.search.keyword", languageCode, "Keyword Search", createdBy);
    createTranslationIfNotExists("common.buttons.import", languageCode, "Import", createdBy);
    createTranslationIfNotExists(
        "header.nav.projectSelection", languageCode, "Project Selection", createdBy);
    ...
    createTranslationIfNotExists(
        "organization.dashboard.title", languageCode, "Dashboard", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalOrganizations",
        languageCode,
        "Total Organizations",
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalOrganizations.subtitle",
        languageCode,
        "Active Organizations",
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalProjects", languageCode, "Total Projects", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalProjects.subtitle",
        languageCode,
        "All Projects",
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalTestCases",
        languageCode,
        "Total Test Cases",
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalTestCases.subtitle",
        languageCode,
        "Created Test Cases",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalUsers.subtitle",
        languageCode,
        "Registered Users",
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalMembers",
        languageCode,
        "Total Project Memberships",
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.metrics.totalMembers.subtitle",
        languageCode,
        "Project Membership Count",
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.tabs.organizationStatus",
        languageCode,
        "Organization Status",
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.tabs.testStatistics", languageCode, "Test Statistics", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.charts.projectDistribution",
        languageCode,
        "Project Distribution by Organization",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.charts.organizationList",
        languageCode,
        "Organization List",
        createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.charts.testResultDetails",
        languageCode,
        "Test Result Details",
        createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.list.projectCount", languageCode, "Projects: {count}", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.list.memberCount", languageCode, "Members: {count}", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.testResults.success", languageCode, "Success", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.testResults.failure", languageCode, "Failure", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.testResults.blocked", languageCode, "Blocked", createdBy);
    createTranslationIfNotExists(
        "organization.dashboard.testResults.notRun", languageCode, "Not Run", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.createNew", languageCode, "Create Organization", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.view", languageCode, "View Organization", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.edit", languageCode, "Edit Organization", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.invite", languageCode, "Invite Member", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.createProject", languageCode, "Create Project", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.buttons.firstProject", languageCode, "Create First Project", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.inviteMember", languageCode, "Invite Member", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.removeMember", languageCode, "Remove Member", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.backToList", languageCode, "Back to Organizations", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.transferOwnership", languageCode, "Transfer Ownership", createdBy);
    createTranslationIfNotExists(
        "organization.buttons.transfer", languageCode, "Transfer", createdBy);
    createTranslationIfNotExists(
        "organization.messages.noOrganizations",
        languageCode,
        "No organizations available",
        createdBy);
    createTranslationIfNotExists(
        "organization.messages.noProjects",
        languageCode,
        "This organization has no projects yet.",
        createdBy);
    createTranslationIfNotExists(
        "organization.messages.createHint",
        languageCode,
        "Create a new organization to manage projects and teams.",
        createdBy);
    createTranslationIfNotExists(
        "organization.messages.joinHint",
        languageCode,
        "Contact your system administrator to join an organization.",
        createdBy);
    createTranslationIfNotExists(
        "organization.messages.accessDenied",
        languageCode,
        "You don't belong to any organization. Contact your system administrator to be added as a"
            + " member or create a new organization.",
        createdBy);
    createTranslationIfNotExists(
        "organization.messages.canCreateNew",
        languageCode,
        "You cannot access existing organizations, but you can create a new one.",
        createdBy);
    createTranslationIfNotExists(
        "organization.messages.noAccessContact",
        languageCode,
        "No available organizations. Contact your system administrator.",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.form.nameRequired",
        languageCode,
        "Please enter organization name.",
        createdBy);
    createTranslationIfNotExists(
        "organization.form.usernameRequired", languageCode, "Please enter username.", createdBy);
    ...
    createTranslationIfNotExists(
        "organization.form.projectCode", languageCode, "Project Code", createdBy);
    createTranslationIfNotExists(
        "organization.form.projectName", languageCode, "Project Name", createdBy);
    createTranslationIfNotExists(
        "organization.form.projectDescription", languageCode, "Project Description", createdBy);
    createTranslationIfNotExists(
        "organization.form.projectCodePlaceholder", languageCode, "e.g., WEB_APP_TEST", createdBy);
    createTranslationIfNotExists(
        "organization.form.projectNamePlaceholder",
        languageCode,
        "e.g., Web Application Test",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.form.namePlaceholder", languageCode, "Enter organization name...", createdBy);
    createTranslationIfNotExists(
        "organization.form.projectCodeRequired",
        languageCode,
        "Please enter project code.",
        createdBy);
    createTranslationIfNotExists(
        "organization.form.projectNameRequired",
        languageCode,
        "Please enter project name.",
        createdBy);
    createTranslationIfNotExists(
        "organization.dialog.create.title", languageCode, "Create New Organization", createdBy);
    createTranslationIfNotExists(
        "organization.dialog.edit.title", languageCode, "Edit Organization", createdBy);
    createTranslationIfNotExists(
        "organization.dialog.delete.title",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "A new project will be created in the '{organizationName}' organization.",
        createdBy);
    createTranslationIfNotExists(
        "organization.dialog.transferOwnership.title",
        languageCode,
        "Transfer Ownership",
        createdBy);
    createTranslationIfNotExists(
        ...
        languageCode,
        "Do you want to transfer organization ownership to {name}? This action cannot be undone and"
            + " your role will be changed to administrator.",
        createdBy);
    createTranslationIfNotExists(
        "organization.dialog.transferOwnership.newOwner", languageCode, "New Owner", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "This action cannot be undone. All projects and data in this organization will also be"
            + " deleted.",
        createdBy);
    ...
    createTranslationIfNotExists(
        "organization.table.joinDate", languageCode, "Join Date", createdBy);
    ...
    createTranslationIfNotExists(
        "organization.project.organizationLabel", languageCode, "Organization", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "dashboard.source.automated", languageCode, "Automated Test", createdBy);
    createTranslationIfNotExists(
        "dashboard.source.total", languageCode, "Total Aggregate", createdBy);

    // Test Plan Automation Test Integration
    createTranslationIfNotExists(
        "testPlan.list.table.automationCount", languageCode, "Automated Tests", createdBy);
    createTranslationIfNotExists(
        "testPlan.list.table.linkAutomated", languageCode, "Link Automated Test", createdBy);
    createTranslationIfNotExists(
