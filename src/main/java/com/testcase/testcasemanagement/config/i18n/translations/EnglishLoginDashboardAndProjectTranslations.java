...
public class EnglishLoginDashboardAndProjectTranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("register.success", languageCode, "Registration successful. Please log in.",
                createdBy);
        createTranslationIfNotExists("register.error.general", languageCode, "An error occurred during registration.",
                createdBy);
        ...
        createTranslationIfNotExists("dashboard.project.totalTestCases", languageCode, "Total {count} test cases",
                createdBy);
        ...
        createTranslationIfNotExists("dashboard.charts.openTestRunResults", languageCode, "Open Test Run Results",
                createdBy);
        ...
        createTranslationIfNotExists("dashboard.status.completedCount", languageCode, "{completed}/{total} completed",
                createdBy);
        ...
        createTranslationIfNotExists("project.stats.totalProjectCount", languageCode, "Total {count} projects",
                createdBy);
        createTranslationIfNotExists("project.messages.noIndependentProjects", languageCode, "No independent projects",
                createdBy);
        ...
        createTranslationIfNotExists("project.buttons.createIndependent", languageCode, "Create Independent Project",
                createdBy);
        ...
        createTranslationIfNotExists("userList.search.placeholder", languageCode, "Search by name, username, email...",
                createdBy);
        ...
        createTranslationIfNotExists("userList.empty.message", languageCode, "No users match the search criteria.",
                createdBy);
        ...
        createTranslationIfNotExists("userList.pagination.displayedRows", languageCode, "{from}-{to} of {count}",
                createdBy);
        ...
        createTranslationIfNotExists("userDetail.error.saveError", languageCode, "An error occurred while saving.",
                createdBy);
        ...
        createTranslationIfNotExists("userDetail.success.passwordChanged", languageCode, "Password Change Complete",
                createdBy);
        ...
        createTranslationIfNotExists("testPlan.form.projectSelectFirst", languageCode, "Please select a project first",
                createdBy);
        ...
        createTranslationIfNotExists("testPlan.validation.nameRequired", languageCode, "Test plan name is required",
                createdBy);
        ...
        createTranslationIfNotExists("testPlan.list.empty.message", languageCode, "No test plans registered.",
                createdBy);
        createTranslationIfNotExists("testPlan.execution.dialog.title", languageCode, "Test Execution - {planName}",
                createdBy);
        createTranslationIfNotExists("testPlan.execution.button.newExecution", languageCode, "Create New Execution",
                createdBy);
        ...
        createTranslationIfNotExists("testPlan.delete.dialog.message", languageCode,
                "Are you sure you want to delete this test plan? This action cannot be undone.", createdBy);
        ...
        createTranslationIfNotExists("testResultDashboard.chart.planComparison", languageCode, "Test Plan Comparison",
                createdBy);
        ...
        createTranslationIfNotExists("testResultDashboard.summary.title", languageCode, "Statistics Summary",
                createdBy);
        createTranslationIfNotExists("testResultDashboard.summary.executionRate", languageCode, "Execution Rate",
                createdBy);
        ...
        createTranslationIfNotExists("testTrendAnalysis.loading.trendData", languageCode, "Loading trend data...",
                createdBy);
        ...
        createTranslationIfNotExists("testTrendAnalysis.summary.avgSuccessRate", languageCode, "Average Success Rate",
                createdBy);
        ...
        createTranslationIfNotExists("testTrendAnalysis.summary.successRateChange", languageCode, "Success Rate Change",
                createdBy);
        createTranslationIfNotExists("testTrendAnalysis.chart.overallTrend", languageCode, "Test Result Trend",
                createdBy);
        createTranslationIfNotExists("testTrendAnalysis.chart.testPlanComparison", languageCode, "Test Plan Comparison",
                createdBy);
        createTranslationIfNotExists("testTrendAnalysis.chart.assigneeComparison", languageCode, "Assignee Comparison",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dashboard.metrics.totalProjects", languageCode, "Total Projects",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.metrics.totalProjects.subtitle", languageCode,
                "All Projects", createdBy);
        createTranslationIfNotExists("organization.dashboard.metrics.totalTestCases", languageCode, "Total Test Cases",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dashboard.tabs.testStatistics", languageCode, "Test Statistics",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dashboard.list.projectCount", languageCode, "Projects: {count}",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.list.memberCount", languageCode, "Members: {count}",
                createdBy);
        ...
        createTranslationIfNotExists("organization.buttons.backToList", languageCode, "Back to Organizations",
                createdBy);
        createTranslationIfNotExists("organization.buttons.transferOwnership", languageCode, "Transfer Ownership",
                createdBy);
        ...
        createTranslationIfNotExists("organization.form.nameRequired", languageCode, "Please enter organization name.",
                createdBy);
        createTranslationIfNotExists("organization.form.usernameRequired", languageCode, "Please enter username.",
                createdBy);
        ...
        createTranslationIfNotExists("organization.form.projectDescription", languageCode, "Project Description",
                createdBy);
        createTranslationIfNotExists("organization.form.projectCodePlaceholder", languageCode, "e.g., WEB_APP_TEST",
                createdBy);
        ...
        createTranslationIfNotExists("organization.form.namePlaceholder", languageCode, "Enter organization name...",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dialog.create.title", languageCode, "Create New Organization",
                createdBy);
        createTranslationIfNotExists("organization.dialog.edit.title", languageCode, "Edit Organization", createdBy);
        createTranslationIfNotExists("organization.dialog.delete.title", languageCode, "Confirm Organization Deletion",
                createdBy);
        ...
        createTranslationIfNotExists("organization.dialog.transferOwnership.title", languageCode, "Transfer Ownership",
                createdBy);
        createTranslationIfNotExists("organization.dialog.transferOwnership.warning", languageCode,
                ...
                createdBy);
        createTranslationIfNotExists("organization.dialog.transferOwnership.newOwner", languageCode, "New Owner",
                createdBy);
        ...
        createTranslationIfNotExists("dashboard.usage.activeWindow", languageCode, "Based on last {minutes} minutes",
                createdBy);
        ...
        createTranslationIfNotExists("dashboard.usage.noData", languageCode, "No aggregated visit data available.",
                createdBy);
        ...
        createTranslationIfNotExists("testPlan.list.table.automationCount", languageCode, "Automated Tests", createdBy);
        createTranslationIfNotExists("testPlan.list.table.linkAutomated", languageCode, "Link Automated Test",
                createdBy);
        createTranslationIfNotExists("testPlan.execution.automated.title", languageCode, "Linked Automated Tests",
                createdBy);
        createTranslationIfNotExists("testPlan.execution.automated.empty", languageCode, "No linked automated tests.",
                createdBy);
    }
