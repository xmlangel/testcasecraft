...
public class EnglishTestCaseAndAutomationTranslations {
        ...
        public void initialize() {
                ...
                createTranslationIfNotExists("junit.testcase.previousNotes.alert", languageCode,
                                ...
                                createdBy);
                createTranslationIfNotExists("junit.testcase.previousNotes.copyBtn", languageCode,
                                "Copy to current notes", createdBy);
                ...
                createTranslationIfNotExists("testcase.spreadsheet.button.insertAbove", languageCode, "Insert Above",
                                createdBy);
                createTranslationIfNotExists("testcase.spreadsheet.button.insertBelow", languageCode, "Insert Below",
                                createdBy);
                ...
                createTranslationIfNotExists("testcase.spreadsheet.column.priority", languageCode, "Priority",
                                createdBy);
                ...
                createTranslationIfNotExists("testcase.spreadsheet.usage.title", languageCode, "Usage Guide",
                                createdBy);
                createTranslationIfNotExists("testcase.spreadsheet.usage.expand", languageCode, "Expand", createdBy);
                createTranslationIfNotExists("testcase.spreadsheet.usage.collapse", languageCode, "Collapse",
                                createdBy);
                createTranslationIfNotExists("testcase.spreadsheet.usage.basicUsage", languageCode,
