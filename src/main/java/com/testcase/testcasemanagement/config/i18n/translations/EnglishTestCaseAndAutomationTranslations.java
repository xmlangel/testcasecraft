...
public class EnglishTestCaseAndAutomationTranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("organization.error.idNotProvided", languageCode, "Organization ID not provided.",
                createdBy);
        ...
        createTranslationIfNotExists("organization.error.editDialogFailed", languageCode, "Failed to open edit dialog.",
                createdBy);
        createTranslationIfNotExists("organization.error.accessDenied", languageCode, "Organization Access Denied",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.tree.message.selectProject", languageCode, "Please select a project.",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.tree.message.noTestcases", languageCode, "No test cases found.",
                createdBy);
        createTranslationIfNotExists("testcase.tree.validation.nameRequired", languageCode, "Please enter a name.",
                createdBy);
        createTranslationIfNotExists("testcase.tree.error.renameFailed", languageCode, "Failed to rename: ", createdBy);
        createTranslationIfNotExists("testcase.tree.error.deleteFailed", languageCode, "Error occurred while deleting.",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.form.overallExpectedResults", languageCode, "Overall Expected Results",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.message.selectProject", languageCode, "Please select a project first.",
                createdBy);
        createTranslationIfNotExists("testcase.message.selectOrCreate", languageCode, "Select or create a test case.",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.version.error.createFailed", languageCode, "Failed to create version.",
                createdBy);
        createTranslationIfNotExists("testcase.version.error.createError", languageCode, "Version creation failed:",
                createdBy);
        createTranslationIfNotExists("testcase.version.validation.labelRequired", languageCode,
                "Please enter version label.", createdBy);
        createTranslationIfNotExists("testcase.version.defaultDescription", languageCode, "Manual version creation",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.spreadsheet.button.stepManagement", languageCode, "Step Management",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.spreadsheet.column.preCondition", languageCode, "Pre-condition",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.column.postCondition", languageCode, "Post-condition",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.column.expectedResults", languageCode, "Expected Results",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.column.isAutomated", languageCode, "Automation Flag",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.column.executionType", languageCode, "Manual/Automation",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.column.testTechnique", languageCode, "Test Technique",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.advancedGrid.multiSelect.title", languageCode, "Multi-Selection:",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.spreadsheet.stepMenu.addStep", languageCode, "Add Step ({count})",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.stepMenu.removeStep", languageCode, "Remove Step ({count})",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.spreadsheet.stepDialog.helper", languageCode, "Can be set from 1 to 10.",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.spreadsheet.folderDialog.title", languageCode, "Create New Folder",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.spreadsheet.fallback.title", languageCode, "Enhanced Spreadsheet Mode",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.fallback.description", languageCode,
                "All features work normally. Supports cell editing, copy/paste, and bulk save.", createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.error.title", languageCode, "Spreadsheet Loading Error",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.spreadsheet.placeholder.columnInput", languageCode, "Enter {title}...",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.spreadsheet.message.noChanges", languageCode, "No changes detected.",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.message.batchSaveSuccess", languageCode,
                "✅ Batch save completed: {folderCount} folder(s), {testCaseCount} test case(s)", createdBy);
        ...
        createTranslationIfNotExists("testcase.spreadsheet.stepMenu.removeStep", languageCode, "Remove Step ({count})",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.stepMenu.settings", languageCode, "Set Step Count...",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.stepDialog.title", languageCode, "Set Step Count",
                createdBy);
        createTranslationIfNotExists("testcase.spreadsheet.stepDialog.description", languageCode,
        ...
        createTranslationIfNotExists("testcase.spreadsheet.status.lineBreakSupport", languageCode, "Line Break Support",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.inputMode.advancedSpreadsheet.description", languageCode,
                "Advanced spreadsheet mode: Spreadsheet with line break and advanced editing features.", createdBy);
        ...
        createTranslationIfNotExists("attachments.delete.message", languageCode, "Do you want to delete this file?",
                createdBy);
        createTranslationIfNotExists("attachments.delete.warning", languageCode, "Deleted files cannot be recovered.",
                createdBy);
        createTranslationIfNotExists("attachments.error.loadFailed", languageCode, "Unable to load attachment list.",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.inputMode.advancedSpreadsheet.description", languageCode,
                "Advanced Spreadsheet Mode: A spreadsheet with line breaks and advanced editing features.", createdBy);
        ...
        createTranslationIfNotExists("testcase.inputMode.spreadsheet.ariaLabel", languageCode, "Spreadsheet Mode",
                createdBy);
        createTranslationIfNotExists("testcase.inputMode.advancedSpreadsheet.ariaLabel", languageCode,
                "Advanced Spreadsheet Mode", createdBy);
        ...
        createTranslationIfNotExists("junit.header.testResultDashboard", languageCode, "Test Result Dashboard",
                createdBy);
        createTranslationIfNotExists("junit.header.automationAnalysis", languageCode, "Automation Test Result Analysis",
                createdBy);
        ...
        createTranslationIfNotExists("junit.chart.testStatusDistribution", languageCode, "Test Status Distribution",
                createdBy);
        createTranslationIfNotExists("junit.chart.recentExecutionResults", languageCode, "Recent Execution Results",
                createdBy);
        ...
        createTranslationIfNotExists("junit.message.selectProject", languageCode, "Please select a project first.",
                createdBy);
        ...
        createTranslationIfNotExists("junit.upload.dragDrop", languageCode, "Drag JUnit XML file or click to select",
                createdBy);
        ...
        createTranslationIfNotExists("junit.detail.loadingDetail", languageCode, "Loading test result details...",
                createdBy);
        ...
        createTranslationIfNotExists("junit.detail.dateProcessingError", languageCode, "Date processing error",
                createdBy);
        createTranslationIfNotExists("junit.detail.loadTestCasesFailed", languageCode, "Failed to load test cases.",
                createdBy);
        ...
        createTranslationIfNotExists("junit.detail.failureMessagePreview", languageCode, "Failure message preview:",
                createdBy);
        createTranslationIfNotExists("junit.detail.clickForDetails", languageCode, "Click the test name for details",
                createdBy);
        createTranslationIfNotExists("junit.detail.slowestTests", languageCode, "Slowest Test Cases", createdBy);
        createTranslationIfNotExists("junit.detail.slowestTestsTop", languageCode, "Slowest Test Cases (Top {count})",
                createdBy);
        ...
        createTranslationIfNotExists("junit.detail.exportPDFError", languageCode, "An error occurred during PDF export",
                createdBy);
        ...
        createTranslationIfNotExists("junit.detail.exportCSVError", languageCode, "An error occurred during CSV export",
                createdBy);
        ...
        createTranslationIfNotExists("junit.failed.failureMessage", languageCode, "Failure message preview:",
                createdBy);
        createTranslationIfNotExists("junit.failed.clickForDetail", languageCode, "Click test name to view details",
                createdBy);
        ...
        createTranslationIfNotExists("junit.testcase.loadingDetail", languageCode, "Loading test case details...",
                createdBy);
        ...
        createTranslationIfNotExists("rag.testcase.createSuccess", languageCode, "Test case created successfully!",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.form.tagsPlaceholder", languageCode, "Enter tags and press Enter",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.form.linkedDocumentsPlaceholder", languageCode, "Select RAG documents",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.helper.markdownSupported", languageCode, "Markdown syntax is supported.",
                createdBy);

        // JUnit Dashboard Sections
        createTranslationIfNotExists("junit.sections.statistics", languageCode, "Statistics Overview", createdBy);
        ...
        createTranslationIfNotExists("junit.dashboard.list.executionName", languageCode, "Execution Name", createdBy);
