...
public class EnglishTestCaseAndAutomationTranslations {
  ...
  public void initialize() {
    ...
    createTranslationIfNotExists(
        "organization.error.notFound", languageCode, "Organization not found.", createdBy);
    createTranslationIfNotExists(
        "organization.error.idNotProvided",
        languageCode,
        "Organization ID not provided.",
        createdBy);
    createTranslationIfNotExists(
        "organization.error.dataLoadFailed",
        languageCode,
        "Failed to load organization data.",
        createdBy);
    createTranslationIfNotExists(
        "organization.error.infoLoadFailed",
        languageCode,
        "Failed to load organization information.",
        createdBy);
    createTranslationIfNotExists(
        "organization.error.editDialogFailed",
        languageCode,
        "Failed to open edit dialog.",
        createdBy);
    createTranslationIfNotExists(
        "organization.error.accessDenied", languageCode, "Organization Access Denied", createdBy);
    createTranslationIfNotExists(
        "organization.error.authRequired", languageCode, "Authentication Required", createdBy);
    createTranslationIfNotExists(
        "organization.error.resourceNotFound", languageCode, "Resource Not Found", createdBy);
    createTranslationIfNotExists(
        "organization.error.general", languageCode, "Error Occurred", createdBy);
    createTranslationIfNotExists(
        "organization.error.authDescription",
        languageCode,
        "Login is required. Please log in again.",
        createdBy);
    createTranslationIfNotExists(
        "organization.error.notFoundDescription",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "organization.error.problemOccurred", languageCode, "A problem occurred", createdBy);
    createTranslationIfNotExists(
        "organization.error.occurredAt", languageCode, "Occurred at: {date}", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.tree.title.select", languageCode, "Select Test Cases", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.title.manage", languageCode, "Test Cases", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.message.selectProject", languageCode, "Please select a project.", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.message.loading", languageCode, "Loading...", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.message.noTestcases", languageCode, "No test cases found.", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.validation.nameRequired", languageCode, "Please enter a name.", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.error.renameFailed", languageCode, "Failed to rename: ", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.tree.button.saveOrder", languageCode, "Save Order", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.tree.action.addFolder", languageCode, "Add Folder", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.action.addTestcase", languageCode, "Add Test Case", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.action.addSubFolder", languageCode, "Add Sub Folder", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.action.addSubTestcase", languageCode, "Add Sub Test Case", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.tree.action.versionHistory", languageCode, "Version History", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.dialog.batchDelete.title", languageCode, "Delete Selected", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.dialog.batchDelete.message",
        languageCode,
        "Delete {count} items (including children)?",
        createdBy);
    createTranslationIfNotExists(
        "testcase.tree.dialog.deleteConfirm.title", languageCode, "Confirm Delete", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.tree.tooltip.close", languageCode, "Close Test Case Tree", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.count.testcases", languageCode, "Test Cases: {count}", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.count.folders", languageCode, "Folders: {count}", createdBy);
    createTranslationIfNotExists(
        "testcase.tree.count.total", languageCode, "Total: {count}", createdBy);
    createTranslationIfNotExists(
        "testcase.form.title.edit", languageCode, "Edit Test Case", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.form.description", languageCode, "Description", createdBy);
    createTranslationIfNotExists(
        "testcase.form.preCondition", languageCode, "Pre-condition", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.form.expectedResults", languageCode, "Expected Results", createdBy);
    createTranslationIfNotExists(
        "testcase.form.postCondition", languageCode, "Post-condition", createdBy);
    createTranslationIfNotExists(
        "testcase.form.isAutomated", languageCode, "Automation", createdBy);
    createTranslationIfNotExists(
        "testcase.form.executionType", languageCode, "Manual/Automation", createdBy);
    createTranslationIfNotExists(
        "testcase.form.testTechnique", languageCode, "Test Technique", createdBy);
    createTranslationIfNotExists(
        "testcase.form.preConditionPlaceholder", languageCode, "Pre-condition", createdBy);
    createTranslationIfNotExists(
        "testcase.form.postConditionPlaceholder", languageCode, "Post-condition", createdBy);
    createTranslationIfNotExists(
        "testcase.form.testTechniquePlaceholder",
        languageCode,
        "e.g., Boundary Value Analysis, Decision Table",
        createdBy);
    createTranslationIfNotExists(
        "testcase.executionType.manual", languageCode, "Manual", createdBy);
    createTranslationIfNotExists(
        "testcase.executionType.automation", languageCode, "Automation", createdBy);
    createTranslationIfNotExists(
        "testcase.executionType.hybrid", languageCode, "Hybrid", createdBy);
    createTranslationIfNotExists(
        "testcase.form.stepDescription", languageCode, "Step description", createdBy);
    createTranslationIfNotExists(
        "testcase.form.expectedResult", languageCode, "Expected result", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.form.folderName", languageCode, "Folder name", createdBy);
    createTranslationIfNotExists(
        "testcase.form.folderDescription", languageCode, "Folder description", createdBy);
    createTranslationIfNotExists(
        "testcase.form.testcaseName", languageCode, "Test case name", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.helper.preCondition", languageCode, "Enter pre-conditions.", createdBy);
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.message.addSteps", languageCode, "Add steps.", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Please enter overall expected results.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.error.saveError", languageCode, "Error occurred while saving.", createdBy);
    createTranslationIfNotExists(
        "testcase.folder.info.title", languageCode, "Folder Information", createdBy);
    createTranslationIfNotExists(
        "testcase.info.title", languageCode, "Test Case Information", createdBy);
    createTranslationIfNotExists(
        "testcase.form.folder.edit", languageCode, "Edit Test Folder", createdBy);
    createTranslationIfNotExists(
        "testcase.form.folder.create", languageCode, "Create Test Folder", createdBy);
    createTranslationIfNotExists(
        "testcase.version.button.create", languageCode, "Create Version", createdBy);
    createTranslationIfNotExists(
        "testcase.version.button.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
        "testcase.version.button.creating", languageCode, "Creating...", createdBy);
    createTranslationIfNotExists(
        "testcase.version.current.fetchError",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Versions can only be created for saved test cases.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.version.error.folderNotAllowed",
        languageCode,
        "Versions cannot be created for folders. Only for actual test cases.",
        createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.version.error.createError", languageCode, "Version creation failed:", createdBy);
    createTranslationIfNotExists(
        "testcase.version.validation.labelRequired",
        languageCode,
        "Please enter version label.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.version.defaultDescription", languageCode, "Manual version creation", createdBy);
    createTranslationIfNotExists(
        "testcase.version.dialog.title", languageCode, "Manual Version Creation", createdBy);
    createTranslationIfNotExists(
        "testcase.version.form.label", languageCode, "Version Label", createdBy);
    createTranslationIfNotExists(
        "testcase.version.form.labelPlaceholder",
        languageCode,
        "e.g., v2.1 with modifications",
        createdBy);
    createTranslationIfNotExists(
        "testcase.version.form.labelHelperText",
        languageCode,
        "Enter a label to identify this version.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.version.form.description", languageCode, "Version Description", createdBy);
    createTranslationIfNotExists(
        "testcase.version.form.descriptionPlaceholder",
        languageCode,
        "Describe in detail what changed in this version.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.version.form.descriptionHelperText",
        languageCode,
        "Optional. If left blank, it will be set to 'Manual version creation'.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.header.title", languageCode, "Test Case Spreadsheet", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.status.rows", languageCode, "{count} rows", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.status.steps", languageCode, "{count} steps", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.status.changed", languageCode, "Modified", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.refresh", languageCode, "Refresh", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.addRows", languageCode, "Add Rows", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.addFolder", languageCode, "Add Folder", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.validate", languageCode, "Validate", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.export", languageCode, "Export", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.save", languageCode, "Batch Save", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.saving", languageCode, "Saving...", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.stepManagement", languageCode, "Step Management", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.fullscreen", languageCode, "Fullscreen", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.exitFullscreen", languageCode, "Exit Fullscreen", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.createdBy", languageCode, "Created By", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.updatedBy", languageCode, "Updated By", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.order", languageCode, "Order", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.type", languageCode, "Type", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.parentFolder", languageCode, "Parent Folder", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.name", languageCode, "Name", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.description", languageCode, "Description", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.preCondition", languageCode, "Pre-condition", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.postCondition", languageCode, "Post-condition", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.expectedResults", languageCode, "Expected Results", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.isAutomated", languageCode, "Automation Flag", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.executionType", languageCode, "Manual/Automation", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.testTechnique", languageCode, "Test Technique", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.title", languageCode, "Usage:", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.basicUsage",
        languageCode,
        "Click cells to edit directly like Excel. Use Tab/Enter to move to next cell, Ctrl+C/V for"
            + " copy/paste.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.folderFunction",
        languageCode,
        "Folder function: Click \"Add Folder\" button or type \"📁 FolderName\" in name cell to"
            + " create a folder.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.stepManagement",
        languageCode,
        "Step management: Click ⚙️ button to adjust the number of steps (max 10).",
        createdBy);
    createTranslationIfNotExists(
        "testcase.advancedGrid.features.title", languageCode, "Advanced Features:", createdBy);
    createTranslationIfNotExists(
        "testcase.advancedGrid.features.lineBreak",
        languageCode,
        "Press Enter within cells for line breaks.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.advancedGrid.features.navigation",
        languageCode,
        "Use Tab to move to next cell, Ctrl+C/V for copy/paste.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.advancedGrid.multiSelect.title", languageCode, "Multi-Selection:", createdBy);
    createTranslationIfNotExists(
        "testcase.advancedGrid.multiSelect.range",
        languageCode,
        "Shift+Click for range selection, Ctrl+Click for individual selection.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.advancedGrid.multiSelect.resize",
        languageCode,
        "Drag to resize cells and auto-fill data.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.stepMenu.addStep", languageCode, "Add Step ({count})", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Set step count directly...",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.stepDialog.title", languageCode, "Set Step Count", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.stepDialog.description",
        languageCode,
        "Set the number of steps for test cases. Existing data will be preserved.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.stepDialog.label", languageCode, "Step Count", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.stepDialog.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.stepDialog.apply", languageCode, "Apply", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.folderDialog.title", languageCode, "Create New Folder", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.folderDialog.description",
        languageCode,
        "Enter the name for the new folder. The folder will be added to the top of the"
            + " spreadsheet.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.folderDialog.label", languageCode, "Folder Name", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.folderDialog.placeholder",
        languageCode,
        "e.g., API Test, UI Test",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.folderDialog.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.folderDialog.create", languageCode, "Create", createdBy);

    // Row Count Dialog (RowCountDialog) English translations
    createTranslationIfNotExists(
        "testcase.spreadsheet.rowCountDialog.titleAbove",
        languageCode,
        "Add {count} Row(s) Above",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.rowCountDialog.titleBelow",
        languageCode,
        "Add {count} Row(s) Below",
        createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.rowCountDialog.confirm", languageCode, "Add", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.rowCountDialog.description",
        languageCode,
        "Enter the number of rows to add (1-100).",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.rowCountDialog.label", languageCode, "Number of Rows", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.rowCountDialog.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.export.csv.title", languageCode, "Export to CSV", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.export.excel.title", languageCode, "Export to Excel", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.title", languageCode, "Data Validation Result", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.summary", languageCode, "Validation Summary", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.close", languageCode, "Close", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.gotoError", languageCode, "Go to Error", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.rows", languageCode, "{count} row(s)", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.folders", languageCode, "{count} folder(s)", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.errorCount", languageCode, "{count} error(s)", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.column", languageCode, "Column", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Row {row}: Test case name \"{name}\" is duplicated in the same folder. Test case names"
            + " must be unique within the same folder.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.error.circularReference",
        languageCode,
        "Row {row}: \"{name}\" refers to itself as parent folder.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.error.missingParentFolder",
        languageCode,
        "Row {row}: Parent folder \"{parent}\" not found.",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Row {row}: \"{parent}\" is not a folder.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.warning.missingExpectedResult",
        languageCode,
        "Row {row}: Expected result for Step {step} is empty.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.warning.noSteps",
        languageCode,
        "Row {row}: No execution steps defined for test case.",
        createdBy);
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Create the \"{parent}\" folder first or enter the correct folder name/ID.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.suggestion.addExpectedResult",
        languageCode,
        "Adding expected results for each step improves test clarity.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.suggestion.addSteps",
        languageCode,
        "Add at least one test step.",
        createdBy);

    // Validation column names English
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.columnName.name", languageCode, "Name", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.validation.columnName.type", languageCode, "Type", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.error.title", languageCode, "Spreadsheet Loading Error", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "An error occurred while refreshing: {error}",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.message.noChanges", languageCode, "No changes detected.", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.message.failureDetails",
        languageCode,
        "Failure details:\n",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.message.moreErrors",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.stepMenu.settings", languageCode, "Set Step Count...", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.stepDialog.title", languageCode, "Set Step Count", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.stepDialog.description",
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "* Advanced spreadsheet based on react-datasheet-grid • {count} step(s) • Line break and"
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Advanced Spreadsheet (Line break support, react-datasheet-grid)",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "🚀 Advanced Spreadsheet - Supports line breaks and multi-selection.",
        createdBy);
    createTranslationIfNotExists(
        "attachments.loading", languageCode, "Loading attachments...", createdBy);
    ...
    createTranslationIfNotExists(
        "attachments.button.download", languageCode, "Download", createdBy);
    createTranslationIfNotExists("attachments.button.delete", languageCode, "Delete", createdBy);
    createTranslationIfNotExists(
        "attachments.delete.title", languageCode, "Delete Attachment", createdBy);
    createTranslationIfNotExists(
        "attachments.delete.message", languageCode, "Do you want to delete this file?", createdBy);
    createTranslationIfNotExists(
        "attachments.delete.warning",
        languageCode,
        "Deleted files cannot be recovered.",
        createdBy);
    createTranslationIfNotExists(
        "attachments.error.loadFailed", languageCode, "Unable to load attachment list.", createdBy);
    createTranslationIfNotExists(
        "attachments.error.loadError",
        languageCode,
        "An error occurred while loading the attachment list.",
        createdBy);
    createTranslationIfNotExists(
        "attachments.error.downloadError",
        languageCode,
        "An error occurred while downloading the file.",
        createdBy);
    createTranslationIfNotExists(
        "attachments.error.deleteError",
        languageCode,
    ...
    createTranslationIfNotExists(
        "testcase.inputMode.form.title", languageCode, "Individual Form", createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.spreadsheet.title", languageCode, "Spreadsheet", createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.advancedSpreadsheet.title",
        languageCode,
        "Advanced Spreadsheet",
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Individual Form Mode: You can input test cases one by one in detail.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.spreadsheet.description",
        languageCode,
        "Spreadsheet Mode: You can input multiple test cases at once in bulk.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.advancedSpreadsheet.description",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Detailed input with individual form (traditional method)",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.spreadsheet.tooltip",
        languageCode,
        "Bulk input with spreadsheet (basic version)",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.advancedSpreadsheet.tooltip",
        languageCode,
        "Advanced spreadsheet (with line break support, react-datasheet-grid)",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.form.ariaLabel", languageCode, "Form Mode", createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.spreadsheet.ariaLabel", languageCode, "Spreadsheet Mode", createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.advancedSpreadsheet.ariaLabel",
        languageCode,
        "Advanced Spreadsheet Mode",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.form.status",
        languageCode,
        "📝 Currently there are {count} test cases.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.form.features",
        languageCode,
        "• All fields supported • No step limits • Detailed input available",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.spreadsheet.status",
        languageCode,
        "📊 Provides an Excel-like editing environment. (Basic version)",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.spreadsheet.features",
        languageCode,
        "• 50+ simultaneous editing on one screen • Dynamic management of 1-10 steps • Fast bulk"
            + " input",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.advancedSpreadsheet.status",
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "• Line breaks in cells (Enter) • Multi-selection (Shift+Click) • Drag resize • Advanced"
            + " copy/paste",
        createdBy);
    createTranslationIfNotExists(
        "testcase.inputMode.warning.modeSwitch",
        languageCode,
        "⚠️ Data currently being edited will be preserved when switching modes.",
        createdBy);
    ...
    createTranslationIfNotExists(
        "junit.dashboard.title", languageCode, "Test Result Dashboard", createdBy);
    createTranslationIfNotExists(
        "junit.dashboard.subtitle",
        languageCode,
        "{projectName} - Automation Test Result Analysis",
        createdBy);
    createTranslationIfNotExists("junit.dashboard.upload", languageCode, "Upload", createdBy);
    createTranslationIfNotExists(
        "junit.dashboard.uploading", languageCode, "Uploading...", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists("junit.stats.total", languageCode, "Total", createdBy);
    createTranslationIfNotExists(
        "junit.stats.successRate", languageCode, "Success Rate", createdBy);
    createTranslationIfNotExists(
        "junit.stats.passedTests", languageCode, "Passed Tests", createdBy);
    createTranslationIfNotExists(
        "junit.stats.failedTests", languageCode, "Failed Tests", createdBy);
    createTranslationIfNotExists("junit.stats.errorTests", languageCode, "Error Tests", createdBy);
    createTranslationIfNotExists(
        "junit.stats.averageSuccessRate", languageCode, "Average Success Rate", createdBy);
    ...
    createTranslationIfNotExists(
        "junit.table.successRate", languageCode, "Success Rate", createdBy);
    ...
    createTranslationIfNotExists(
        "junit.date.unknown", languageCode, "Unknown date format", createdBy);
    ...
    createTranslationIfNotExists(
        "junit.detail.loadFailedDetail",
        languageCode,
        "Failed to load test result details.",
        createdBy);
    createTranslationIfNotExists(
        "junit.detail.notFound", languageCode, "Test result not found.", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportPDF", languageCode, "Export to PDF", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportingPDF", languageCode, "Generating PDF...", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportCSV", languageCode, "Export to CSV", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportingCSV", languageCode, "Generating CSV...", createdBy);
    createTranslationIfNotExists(
        "junit.detail.versionManagement", languageCode, "Version Management", createdBy);
    createTranslationIfNotExists(
        "junit.detail.tab.testCases", languageCode, "Test Cases", createdBy);
    createTranslationIfNotExists(
        "junit.detail.tab.failedTests", languageCode, "Failed Tests", createdBy);
    createTranslationIfNotExists(
        "junit.detail.tab.slowTests", languageCode, "Slow Tests", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "junit.detail.invalidDate", languageCode, "Invalid date", createdBy);
    createTranslationIfNotExists(
        "junit.detail.dateProcessingError", languageCode, "Date processing error", createdBy);
    createTranslationIfNotExists(
        "junit.detail.loadTestCasesFailed", languageCode, "Failed to load test cases.", createdBy);
    createTranslationIfNotExists("junit.detail.testSuite", languageCode, "Test Suite", createdBy);
    createTranslationIfNotExists(
        "junit.detail.testCaseSearch", languageCode, "Search test cases...", createdBy);
    ...
    createTranslationIfNotExists(
        "junit.detail.failedTestCases", languageCode, "Failed Test Cases", createdBy);
    createTranslationIfNotExists(
        "junit.detail.noFailedTests", languageCode, "No failed test cases!", createdBy);
    createTranslationIfNotExists(
        "junit.detail.failureMessagePreview", languageCode, "Failure message preview:", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "junit.detail.noExecutionTimeData",
        languageCode,
        "No execution time data available.",
        createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportPDFAlert", languageCode, "Test result not found.", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportPDFComplete", languageCode, "PDF export complete", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportPDFFailed", languageCode, "PDF export failed", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportPDFError",
        languageCode,
        "An error occurred during PDF export",
        createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportCSVAlert", languageCode, "No test result to export.", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportCSVComplete", languageCode, "CSV export complete", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportCSVFailed", languageCode, "CSV export failed", createdBy);
    createTranslationIfNotExists(
        "junit.detail.exportCSVError",
        languageCode,
    ...
    createTranslationIfNotExists(
        "junit.testcase.loadingDetail", languageCode, "Loading test case details...", createdBy);
    createTranslationIfNotExists(
        "junit.testcase.errorOccurred", languageCode, "Error Occurred", createdBy);
    createTranslationIfNotExists("junit.testcase.noData", languageCode, "No Data", createdBy);
    createTranslationIfNotExists(
        "junit.testcase.noDetailInfo",
        languageCode,
    ...
    createTranslationIfNotExists(
        "junit.testcase.previous", languageCode, "Previous Test Case", createdBy);
    createTranslationIfNotExists("junit.testcase.next", languageCode, "Next Test Case", createdBy);
    createTranslationIfNotExists(
        "junit.testcase.previousNotes.alert",
        languageCode,
        "Previous notes exist for this test case (Execution: {execution}, Date: {date})",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "rag.testcase.preview.title", languageCode, "✨ AI Generated Test Case", createdBy);
    createTranslationIfNotExists(
        "rag.testcase.addButton", languageCode, "Add Test Case", createdBy);
    createTranslationIfNotExists(
        "rag.testcase.addToProject", languageCode, "Add to Project", createdBy);
    ...
    createTranslationIfNotExists(
        "rag.testcase.createSuccess", languageCode, "Test case created successfully!", createdBy);
    createTranslationIfNotExists(
        "rag.testcase.createError", languageCode, "Failed to create test case.", createdBy);
    createTranslationIfNotExists(
        "rag.testcase.dialog.title", languageCode, "Add Test Case", createdBy);

    // Tags English Translations
    createTranslationIfNotExists("testcase.form.tags", languageCode, "Tags", createdBy);
    createTranslationIfNotExists(
        "testcase.form.tagsPlaceholder", languageCode, "Enter tags and press Enter", createdBy);
    createTranslationIfNotExists(
        "testcase.helper.tags", languageCode, "You can enter multiple tags", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.form.linkedDocuments", languageCode, "Linked RAG Documents", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "junit.sections.statistics", languageCode, "Statistics Overview", createdBy);
    createTranslationIfNotExists(
        "junit.sections.charts", languageCode, "Chart Analysis", createdBy);
    createTranslationIfNotExists(
        "junit.sections.list", languageCode, "Test Execution List", createdBy);
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "junit.dashboard.list.fileName", languageCode, "File Name", createdBy);
    createTranslationIfNotExists(
        "junit.dashboard.list.testPlan", languageCode, "Test Plan", createdBy);
    createTranslationIfNotExists(
        "junit.dashboard.list.executionName", languageCode, "Execution Name", createdBy);

    // JUnit Empty States
    createTranslationIfNotExists(
        "junit.empty.noResults", languageCode, "No test results", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.versionHistory.title", languageCode, "Test Case Version History", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.versionHistory.error.restoreError",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Failed to retrieve version details.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.versionHistory.error.viewError",
        languageCode,
        "Version details retrieval failed:",
        createdBy);
    createTranslationIfNotExists(
        "testcase.versionHistory.empty", languageCode, "No version history available.", createdBy);

    // Version Change Type Labels
    createTranslationIfNotExists(
        "testcase.versionHistory.changeType.create", languageCode, "Create", createdBy);
    createTranslationIfNotExists(
        "testcase.versionHistory.changeType.update", languageCode, "Update", createdBy);
    createTranslationIfNotExists(
        "testcase.versionHistory.changeType.manualSave", languageCode, "Manual Save", createdBy);
    createTranslationIfNotExists(
        "testcase.versionHistory.changeType.restore", languageCode, "Restore", createdBy);
    createTranslationIfNotExists(
        "testcase.versionHistory.changeType.unknown", languageCode, "Unknown", createdBy);

    // Version Status and Info
    createTranslationIfNotExists(
        "testcase.versionHistory.current", languageCode, "Current", createdBy);
    createTranslationIfNotExists(
        "testcase.versionHistory.changeSummary.empty", languageCode, "No changes", createdBy);
    createTranslationIfNotExists(
        "testcase.versionHistory.creator.unknown", languageCode, "Unknown", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.versionDetail.title", languageCode, "Version Details", createdBy);
    createTranslationIfNotExists(
        "testcase.versionDetail.section.basic", languageCode, "Basic Information", createdBy);
    createTranslationIfNotExists(
        "testcase.versionDetail.section.steps", languageCode, "Test Steps", createdBy);
    createTranslationIfNotExists(
        "testcase.versionDetail.section.version", languageCode, "Version Information", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.versionDetail.step.number", languageCode, "Step", createdBy);
    createTranslationIfNotExists(
        "testcase.versionDetail.step.expectedResult", languageCode, "Expected Result:", createdBy);

    // Version Detail Button
    createTranslationIfNotExists(
        "testcase.versionDetail.button.close", languageCode, "Close", createdBy);

    // Version Indicator - Status
    createTranslationIfNotExists(
        "testcase.version.status.current", languageCode, "Latest Version", createdBy);
    createTranslationIfNotExists(
        "testcase.version.status.outdated", languageCode, "Previous Version", createdBy);
    createTranslationIfNotExists("testcase.version.status.draft", languageCode, "Draft", createdBy);
    createTranslationIfNotExists(
        "testcase.version.status.none", languageCode, "No Version", createdBy);

    // Version Indicator - Tooltip
    createTranslationIfNotExists(
        "testcase.version.tooltip.current", languageCode, "This is the latest version", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testcase.version.tooltip.draft", languageCode, "This is a draft version", createdBy);
    createTranslationIfNotExists(
        "testcase.version.tooltip.none", languageCode, "No version has been created", createdBy);

    // Version Indicator - Menu
    createTranslationIfNotExists(
        "testcase.version.menu.history", languageCode, "Version History", createdBy);
    createTranslationIfNotExists(
        "testcase.version.menu.createNew", languageCode, "Create New Version", createdBy);
    createTranslationIfNotExists(
        "testcase.version.menu.restore", languageCode, "Restore to this version", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.bulkOps.dialog.title", languageCode, "Bulk Operations for Test Cases", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.dialog.selectedCount",
        languageCode,
        "Selected: {count} item(s)",
        createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.dialog.moreItems", languageCode, "and {count} more", createdBy);

    // Operation Types
    createTranslationIfNotExists(
        "testcase.bulkOps.operation.label", languageCode, "Operation Type", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.operation.update", languageCode, "Bulk Update Properties", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.operation.copy", languageCode, "Copy", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.operation.move", languageCode, "Move", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.operation.delete", languageCode, "Delete", createdBy);

    // Operation Descriptions
    createTranslationIfNotExists(
        "testcase.bulkOps.description.update",
        languageCode,
        "Bulk update properties of selected test cases.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.description.delete",
        languageCode,
        "Permanently delete selected test cases. This action cannot be undone.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.description.move",
        languageCode,
        "Move selected test cases to another project or folder.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.description.copy",
        languageCode,
        "Copy selected test cases to another project or folder.",
        createdBy);

    // Field Labels
    createTranslationIfNotExists(
        "testcase.bulkOps.field.priority", languageCode, "Priority", createdBy);
    createTranslationIfNotExists("testcase.bulkOps.field.type", languageCode, "Type", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.field.description",
        languageCode,
        "Description (append to existing)",
        createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.field.targetProject", languageCode, "Target Project", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.field.targetFolder", languageCode, "Target Folder (Optional)", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.field.rootFolder", languageCode, "Root Folder", createdBy);

    // Option Values
    createTranslationIfNotExists(
        "testcase.bulkOps.option.noChange", languageCode, "No Change", createdBy);
    createTranslationIfNotExists("testcase.bulkOps.priority.high", languageCode, "High", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.priority.medium", languageCode, "Medium", createdBy);
    createTranslationIfNotExists("testcase.bulkOps.priority.low", languageCode, "Low", createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.type.testcase", languageCode, "Test Case", createdBy);
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "This content will be appended to existing descriptions...",
        createdBy);

    // Error Messages
    createTranslationIfNotExists(
        "testcase.bulkOps.error.selectOperation",
        languageCode,
        "Please select an operation type.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.error.selectProject",
        languageCode,
        "Please select a target project.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.error.confirmDelete",
        languageCode,
        "Please check delete confirmation.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.error.unknownOperation",
        languageCode,
        "Unknown operation type.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.bulkOps.error.executionFailed",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "I confirm the permanent deletion of the selected test cases.",
        createdBy);

    // Status Messages
    createTranslationIfNotExists(
        "testcase.bulkOps.status.processing", languageCode, "Processing...", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.insertBelow", languageCode, "Insert Below", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.button.delete", languageCode, "Delete", createdBy);

    // Spreadsheet Additional Columns
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.priority", languageCode, "Priority", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.column.tags", languageCode, "Tags", createdBy);
    ...
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.title", languageCode, "Usage Guide", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.expand", languageCode, "Expand", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.collapse", languageCode, "Collapse", createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.basicUsage",
        languageCode,
        "Edit cells like Excel. Use Tab/Enter to move, Ctrl+C/V to copy/paste.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.folderFunction",
        languageCode,
        "Folder feature: Click 'Add Folder' button or enter '📁 FolderName' format in name cell.",
        createdBy);
    createTranslationIfNotExists(
        "testcase.spreadsheet.usage.stepManagement",
        languageCode,
    ...
    createTranslationIfNotExists(
        "profile.apiToken.title", languageCode, "Service API Token", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.description1",
        languageCode,
        "Service API tokens are used to access this service from external systems (e.g., Jira Forge"
            + " app).",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Up to 10 tokens can be issued per user.",
        createdBy);

    createTranslationIfNotExists(
        "profile.apiToken.new.title", languageCode, "Generate New API Token", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.new.label", languageCode, "Token Name", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.new.placeholder",
        languageCode,
        "e.g., Jira Integration, CI/CD Pipeline",
        createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.new.button", languageCode, "Generate", createdBy);

    createTranslationIfNotExists(
        "profile.apiToken.list.title", languageCode, "My API Token List", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.list.refresh", languageCode, "Refresh List", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.list.empty", languageCode, "No API tokens issued.", createdBy);
    ...
    createTranslationIfNotExists(
        "profile.apiToken.table.expiry", languageCode, "Expiry Date", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.table.created", languageCode, "Created At", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.table.actions", languageCode, "Actions", createdBy);

    createTranslationIfNotExists(
        "profile.apiToken.status.active", languageCode, "Active", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.status.inactive", languageCode, "Inactive", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.status.expired", languageCode, "Expired", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.tooltip.delete", languageCode, "Delete (Deactivate)", createdBy);

    createTranslationIfNotExists(
        "profile.apiToken.dialog.revealed.title",
        languageCode,
        "API Token Issuance Complete",
        createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.revealed.warning",
        languageCode,
        "This token can only be viewed now. Once you close this window, you will not be able to see"
            + " the full token again. Please save it securely.",
        createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.revealed.name", languageCode, "Token Name: {name}", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.revealed.expiry", languageCode, "Expiry Date: {date}", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.revealed.tokenLabel", languageCode, "Issued Token:", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.revealed.copiedTooltip", languageCode, "Copied!", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.revealed.copyButton", languageCode, "Copy Full Token", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.revealed.copySuccess",
        languageCode,
        "Copy successful!",
        createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.revealed.close", languageCode, "OK (Close)", createdBy);

    createTranslationIfNotExists(
        "profile.apiToken.dialog.delete.title", languageCode, "Delete API Token", createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.delete.warning",
        languageCode,
        "Deleted tokens will immediately cease to function.",
        createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.delete.confirm",
        languageCode,
        "Are you sure you want to deactivate the {name} token?",
        createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.dialog.delete.button", languageCode, "Delete", createdBy);

    createTranslationIfNotExists(
        "profile.apiToken.message.loadFailed",
        languageCode,
        "Failed to load API key list.",
        createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.message.nameRequired",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "An error occurred while issuing the API key.",
        createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "profile.apiToken.message.deleteFailed", languageCode, "Deactivation failed.", createdBy);
    createTranslationIfNotExists(
