...
public class AttachmentKeysInitializer {
  ...
  public void initialize() {
    ...
    createTranslationKeyIfNotExists(
        "attachment.success.upload", "attachment", "파일 업로드 성공 메시지", "파일이 성공적으로 업로드되었습니다.");

    createTranslationKeyIfNotExists(
        "attachment.success.delete", "attachment", "파일 삭제 성공 메시지", "첨부파일이 성공적으로 삭제되었습니다.");
    ...
    createTranslationKeyIfNotExists(
        "attachment.error.upload.general", "attachment", "파일 업로드 일반 오류 메시지", "서버 오류가 발생했습니다.");
    ...
    createTranslationKeyIfNotExists(
        "attachment.error.notfound", "attachment", "첨부파일을 찾을 수 없음 메시지", "첨부파일을 찾을 수 없습니다.");
