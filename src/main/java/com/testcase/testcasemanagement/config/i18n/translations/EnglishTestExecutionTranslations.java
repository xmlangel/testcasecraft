...
public class EnglishTestExecutionTranslations {
  ...
  public void initialize() {
    ...
    createTranslationIfNotExists(
        "testExecution.list.newExecution", languageCode, "New Execution", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.noExecutions", languageCode, "No execution history found.", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.delete.title", languageCode, "Delete Execution", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testExecution.list.delete.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.delete.delete", languageCode, "Delete", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.searchPlaceholder", languageCode, "Title Search", createdBy);
    createTranslationIfNotExists("testExecution.list.refresh", languageCode, "Refresh", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step2.title", languageCode, "2. Start Execution", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step3.title", languageCode, "3. Execute Test Cases", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step4.title", languageCode, "4. Complete Execution", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step4.description",
        languageCode,
        "When all tests are completed, click the 'Complete Execution' button to finish the"
            + " execution.",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step5.title", languageCode, "5. View Results", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step5.description",
        languageCode,
        "Check progress and result statistics. Use the 'Previous Results' button to view past"
            + " execution history if needed.",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step6.title",
        languageCode,
        "6. Re-execution (After Completion)",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step6.description",
        languageCode,
        "Completed test executions can be restarted by clicking the 'Restart' button to change back"
    ...
    createTranslationIfNotExists(
        "testExecution.actions.prevResults", languageCode, "Previous Results", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testExecution.table.executedAt", languageCode, "Executed At", createdBy);
    createTranslationIfNotExists(
        "testExecution.table.executedBy", languageCode, "Executed By", createdBy);
    ...
    createTranslationIfNotExists(
        "testExecution.table.enterResult", languageCode, "Enter Result", createdBy);
    createTranslationIfNotExists(
        "testExecution.table.prevResults", languageCode, "Previous Results", createdBy);
    createTranslationIfNotExists(
        "testExecution.table.attachments", languageCode, "Attachments", createdBy);
    createTranslationIfNotExists(
        "testExecution.table.executionId", languageCode, "Execution ID", createdBy);
    createTranslationIfNotExists(
        "testExecution.table.executionName", languageCode, "Execution Name", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.saveAndStart", languageCode, "Save and Start", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.executionName", languageCode, "Execution Name", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.testPlan", languageCode, "Test Plan", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.description", languageCode, "Description", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.progress", languageCode, "Progress", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.startImmediatelyLabel", languageCode, "Start Immediately", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testExecution.actions.restartExecution", languageCode, "Restart", createdBy);
    createTranslationIfNotExists(
        "testExecution.prevResults.title", languageCode, "Previous Execution Results", createdBy);
    createTranslationIfNotExists(
        "testExecution.prevResults.noResults",
        languageCode,
        "No previous execution results found.",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testExecution.status.completed", languageCode, "Completed", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.title", languageCode, "Test Executions", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.newExecution", languageCode, "New Execution", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.noExecutions", languageCode, "No test executions found.", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.delete.title", languageCode, "Delete Execution", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.delete.confirm",
        languageCode,
        "Are you sure you want to delete this test execution?",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.list.delete.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testExecution.guide.step3.description",
        languageCode,
        "Click 'Enter Result' button for each test case to record test results.",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step4.title", languageCode, "4. Complete Execution", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step5.title", languageCode, "5. Check Results", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step5.description",
        languageCode,
        "Check progress and result statistics. Use 'Previous Results' button to view past execution"
            + " history if needed.",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step6.title", languageCode, "6. Re-run (After Completion)", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step6.description",
        languageCode,
        "Completed test executions can be restarted by clicking 'Re-run' button to change back to"
            + " 'In Progress' status for additional testing.",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.table.viewAttachments", languageCode, "View Attachments", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.registerTitle", languageCode, "Register Test Execution", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.executionInfo", languageCode, "Execution Info", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.startDate", languageCode, "Start Date", createdBy);
    ...
    createTranslationIfNotExists(
        "testExecution.attachments.title", languageCode, "Test Result Attachments", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.totalCount", languageCode, "Total {count} items", createdBy);
    createTranslationIfNotExists(
        "testExecution.table.noData", languageCode, "No data to display.", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.title", languageCode, "Test Execution Guide", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.hideGuide", languageCode, "Hide Guide", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.showGuide", languageCode, "Show Guide", createdBy);
    createTranslationIfNotExists(
        "testExecution.form.description", languageCode, "Description", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step1.title", languageCode, "Step 1: Select Test Plan", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step2.title", languageCode, "Step 2: Enter Execution Info", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step2.description",
        languageCode,
        ...
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step3.title", languageCode, "Step 3: Review Test Cases", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step3.description",
        languageCode,
        ...
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step4.title", languageCode, "Step 4: Start Execution", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step4.description",
        languageCode,
        "After confirming all information, start the test execution",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step5.title", languageCode, "Step 5: Enter Results", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step5.description",
        languageCode,
        "Enter execution results for each test case",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step6.title", languageCode, "Step 6: Complete Execution", createdBy);
    createTranslationIfNotExists(
        "testExecution.guide.step6.description",
        languageCode,
        "Complete the entire execution when all test cases are finished",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.list.title", languageCode, "Test Execution List", createdBy);
    createTranslationIfNotExists(
        "testExecution.list.delete.title", languageCode, "Delete Test Execution", createdBy);
    createTranslationIfNotExists(
        "testExecution.status.notStarted", languageCode, "Not Started", createdBy);
    createTranslationIfNotExists(
        "testExecution.status.inProgress", languageCode, "In Progress", createdBy);
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "testExecution.helper.tags", languageCode, "You can enter multiple tags.", createdBy);
    ...
    createTranslationIfNotExists(
        "testExecution.bulk.dialog.title", languageCode, "Bulk Result Input", createdBy);
    createTranslationIfNotExists(
        "testExecution.bulk.dialog.selectedCases", languageCode, "Selected Test Cases", createdBy);
    createTranslationIfNotExists(
        "testExecution.bulk.dialog.selectResult", languageCode, "Select Result", createdBy);
    createTranslationIfNotExists(
        "testExecution.bulk.dialog.commonNotes", languageCode, "Common Notes", createdBy);
    createTranslationIfNotExists(
        "testExecution.bulk.dialog.commonTags", languageCode, "Common Tags", createdBy);
    createTranslationIfNotExists(
        "testExecution.bulk.dialog.commonJiraId", languageCode, "Common JIRA ID", createdBy);
    createTranslationIfNotExists(
        "testExecution.bulk.dialog.confirm", languageCode, "Confirm", createdBy);
    createTranslationIfNotExists(
        "testExecution.bulk.dialog.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testExecution.table.selectTestCase", languageCode, "Select test case:", createdBy);
    ...
    createTranslationIfNotExists(
        "testExecution.filter.priority.high", languageCode, "High", createdBy);
    createTranslationIfNotExists(
        "testExecution.filter.priority.medium", languageCode, "Medium", createdBy);
    createTranslationIfNotExists(
        "testExecution.filter.priority.low", languageCode, "Low", createdBy);
    ...
    createTranslationIfNotExists(
        "testExecution.filter.executedBy", languageCode, "Executed By", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "testExecution.previousResults.table.tags", languageCode, "Tags", createdBy);
    createTranslationIfNotExists(
        "testExecution.previousResults.table.actions", languageCode, "Actions", createdBy);
    createTranslationIfNotExists(
        "testExecution.previousResults.action.edit", languageCode, "Edit", createdBy);
    createTranslationIfNotExists(
        "testExecution.previousResults.action.delete", languageCode, "Delete", createdBy);
    createTranslationIfNotExists(
        "testExecution.previousResults.delete.title",
        languageCode,
        "Delete Test Result",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Result: {result} | Executed At: {executedAt}",
        createdBy);
    createTranslationIfNotExists(
        "testExecution.previousResults.delete.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
        "testExecution.previousResults.delete.delete", languageCode, "Delete", createdBy);
    createTranslationIfNotExists(
        "testExecution.previousResults.delete.deleting", languageCode, "Deleting...", createdBy);
    createTranslationIfNotExists(
