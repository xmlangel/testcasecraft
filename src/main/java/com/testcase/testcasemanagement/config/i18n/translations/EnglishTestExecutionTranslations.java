...
public class EnglishTestExecutionTranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("testExecution.list.noExecutions", languageCode, "No execution history found.",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.guide.title", languageCode, "📋 Test Execution Procedure Guide",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.close", languageCode, "Close", createdBy);
        createTranslationIfNotExists("testExecution.guide.step1.title", languageCode, "1. Test Execution Preparation",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step1.description", languageCode,
                "Enter execution name, test plan, and description, then click the 'Save' button.", createdBy);
        ...
        createTranslationIfNotExists("testExecution.guide.step2.description", languageCode,
                "Click the 'Start Execution' button to change the test execution status to 'In Progress'.", createdBy);
        ...
        createTranslationIfNotExists("testExecution.guide.step3.description", languageCode,
                "Click the 'Enter Result' button for each test case to record test results.", createdBy);
        ...
        createTranslationIfNotExists("testExecution.table.header.previousResults", languageCode, "Previous Results",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.table.button.previousResults", languageCode, "Previous Results",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.pagination.page", languageCode, "Page {current} / {total}",
                createdBy);
        createTranslationIfNotExists("testExecution.table.noTestCases", languageCode, "No test cases to display.",
                createdBy);
        createTranslationIfNotExists("testExecution.previousResults.title", languageCode, "Previous Execution Results",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.previousResults.table.executedAt", languageCode, "Executed At",
                createdBy);
        createTranslationIfNotExists("testExecution.previousResults.table.result", languageCode, "Result", createdBy);
        createTranslationIfNotExists("testExecution.previousResults.table.executionId", languageCode, "Execution ID",
                createdBy);
        createTranslationIfNotExists("testExecution.previousResults.table.executionName", languageCode,
                "Execution Name", createdBy);
        createTranslationIfNotExists("testExecution.previousResults.table.executedBy", languageCode, "Executed By",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.previousResults.table.attachments", languageCode, "Attachments",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.jira.urlNotSet", languageCode, "{issueKey} (JIRA URL not set)",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.actions.startExecution", languageCode, "Start Execution",
                createdBy);
        createTranslationIfNotExists("testExecution.actions.completeExecution", languageCode, "Complete Execution",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.form.startImmediatelyLabel", languageCode, "Start Immediately",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.prevResults.title", languageCode, "Previous Execution Results",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.list.newExecution", languageCode, "New Execution", createdBy);
        createTranslationIfNotExists("testExecution.list.noExecutions", languageCode, "No test executions found.",
                createdBy);
        createTranslationIfNotExists("testExecution.list.delete.title", languageCode, "Delete Execution", createdBy);
        createTranslationIfNotExists("testExecution.list.delete.confirm", languageCode,
        ...
        createTranslationIfNotExists("testExecution.guide.title", languageCode, "📋 Test Execution Procedure Guide",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step1.title", languageCode, "1. Enter Execution Information",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step1.description", languageCode,
                "Enter basic information such as execution name, test plan, and description.", createdBy);
        createTranslationIfNotExists("testExecution.guide.step2.title", languageCode, "2. Start Execution", createdBy);
        createTranslationIfNotExists("testExecution.guide.step2.description", languageCode,
                "Click 'Start Execution' button to change the test execution status to 'In Progress'.", createdBy);
        createTranslationIfNotExists("testExecution.guide.step3.title", languageCode, "3. Execute Test Cases",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step3.description", languageCode,
        ...
        createTranslationIfNotExists("testExecution.guide.step4.title", languageCode, "4. Complete Execution",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step4.description", languageCode,
                "Once all tests are completed, click 'Complete Execution' button to finish the execution.", createdBy);
        ...
        createTranslationIfNotExists("testExecution.guide.step5.description", languageCode,
                ...
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step6.title", languageCode, "6. Re-run (After Completion)",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step6.description", languageCode,
        ...
        createTranslationIfNotExists("testExecution.table.viewAttachments", languageCode, "View Attachments",
                createdBy);
        createTranslationIfNotExists("testExecution.form.registerTitle", languageCode, "Register Test Execution",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.form.description", languageCode, "Description", createdBy);
        createTranslationIfNotExists("testExecution.guide.step1.title", languageCode, "Step 1: Select Test Plan",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step2.title", languageCode, "Step 2: Enter Execution Info",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step2.description", languageCode,
                "Enter basic information such as test execution name, description, and assignee", createdBy);
        createTranslationIfNotExists("testExecution.guide.step3.title", languageCode, "Step 3: Review Test Cases",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step3.description", languageCode,
                "Review the test cases in the selected test plan and adjust execution order if needed", createdBy);
        ...
        createTranslationIfNotExists("testExecution.guide.step6.title", languageCode, "Step 6: Complete Execution",
                createdBy);
        createTranslationIfNotExists("testExecution.guide.step6.description", languageCode,
        ...
        createTranslationIfNotExists("testExecution.form.tagsPlaceholder", languageCode, "Enter tags and press Enter",
                createdBy);
        ...
        createTranslationIfNotExists("testExecution.bulk.selectedCount", languageCode, "{count} selected", createdBy);
        createTranslationIfNotExists("testExecution.bulk.actionToolbar.title", languageCode, "Bulk Actions", createdBy);
        createTranslationIfNotExists("testExecution.bulk.actionToolbar.deselect", languageCode, "Deselect", createdBy);
        createTranslationIfNotExists("testExecution.bulk.dialog.title", languageCode, "Bulk Result Input", createdBy);
        createTranslationIfNotExists("testExecution.bulk.dialog.selectedCases", languageCode, "Selected Test Cases",
                createdBy);
        createTranslationIfNotExists("testExecution.bulk.dialog.selectResult", languageCode, "Select Result",
                createdBy);
        createTranslationIfNotExists("testExecution.bulk.dialog.commonNotes", languageCode, "Common Notes", createdBy);
        createTranslationIfNotExists("testExecution.bulk.dialog.commonTags", languageCode, "Common Tags", createdBy);
        ...
        createTranslationIfNotExists("testExecution.bulk.success", languageCode, "Results saved for {count} test cases",
                createdBy);
        createTranslationIfNotExists("testExecution.bulk.error", languageCode, "Error during bulk result save: {error}",
                createdBy);
        createTranslationIfNotExists("testExecution.bulk.processing", languageCode, "Processing {current}/{total}...",
                createdBy);
