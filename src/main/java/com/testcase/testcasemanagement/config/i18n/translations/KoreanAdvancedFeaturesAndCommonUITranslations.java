...
public class KoreanAdvancedFeaturesAndCommonUITranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("admin.llmConfig.message.allFieldsRequired", languageCode, "모든 필수 필드를 입력해주세요", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.connectionSuccess", languageCode, "연결 테스트 성공!", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.connectionFailed", languageCode, "연결 테스트 실패", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.invalidJson", languageCode, "템플릿이 유효한 JSON 형식이 아닙니다", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.confirmDelete", languageCode, "정말 이 LLM 설정을 삭제하시겠습니까?", createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.message.defaultChanged", languageCode, "기본 LLM 설정이 변경되었습니다", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.activeChanged", languageCode, "LLM 설정 활성 상태가 변경되었습니다", createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.template.description1", languageCode, "이 템플릿은 새로운 LLM 설정 생성 시 자동으로 설정되며, AI에게 테스트 케이스 생성을 요청할 때 참고 형식으로 사용됩니다.", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.description2", languageCode, "각 LLM 설정별로 이 템플릿을 수정하여 사용할 수 있습니다.", createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.template.usage1", languageCode, "1. LLM 설정 생성 시 이 템플릿이 자동으로 적용됩니다.", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.usage2", languageCode, "2. 각 LLM 설정에서 개별적으로 템플릿을 수정할 수 있습니다.", createdBy);
        createTranslationIfNotExists("admin.llmConfig.template.usage3", languageCode, "3. RAG 채팅에서 \"테스트 케이스\"를 포함한 요청 시 자동으로 템플릿을 참고합니다.", createdBy);
        createTranslationIfNotExists("admin.globalDoc.title", languageCode, "🌐 공통 RAG 문서 관리", createdBy);
        createTranslationIfNotExists("admin.globalDoc.description", languageCode, "모든 프로젝트에서 자동으로 참조되는 글로벌 지식 베이스를 관리합니다. (관리자 전용)", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.noDocuments", languageCode, "아직 공통 문서가 없습니다. 첫 번째 문서를 업로드해보세요!", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.info.whatIsDescription", languageCode, "모든 프로젝트에서 자동으로 참조되는 글로벌 지식 베이스입니다. 특수 프로젝트 ID({0})로 관리됩니다.", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.examplesTitle", languageCode, "💡 활용 예시:", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example1", languageCode, "회사 공통 코딩 컨벤션 및 개발 가이드라인", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example2", languageCode, "테스트 작성 표준 및 품질 관리 문서", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example3", languageCode, "프로젝트 공통 참조 문서 (API 명세, 아키텍처 가이드 등)", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.info.supportedFormats", languageCode, "지원 형식: PDF, DOCX, DOC, TXT (최대 50MB)", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.autoSearch", languageCode, "모든 프로젝트의 RAG Q&A에서 자동 검색됨", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.adminOnly", languageCode, "관리자만 업로드/삭제 가능 (ADMIN 권한 필요)", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.message.uploadSuccess", languageCode, "공통 문서 \"{0}\"이 업로드되었습니다", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.uploadFailed", languageCode, "공통 문서 업로드 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.deleteSuccess", languageCode, "공통 문서 \"{0}\"이 삭제되었습니다", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.deleteFailed", languageCode, "공통 문서 삭제 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.uploaded", languageCode, "공통 문서 \"{0}\"이 업로드되었습니다", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.deleted", languageCode, "공통 문서 \"{0}\"이 삭제되었습니다", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmDelete", languageCode, "공통 문서 \"{0}\"을 삭제하시겠습니까?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmAnalyze", languageCode, "문서 \"{0}\"을 분석하시겠습니까?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmEmbedding", languageCode, "문서 \"{0}\"의 임베딩을 생성하시겠습니까?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmEmbeddings", languageCode, "문서 \"{0}\"의 임베딩을 생성하시겠습니까?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.analyzeStarted", languageCode, "문서 \"{0}\" 분석 시작됨", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.analyzeFailed", languageCode, "분석 시작 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.embeddingStarted", languageCode, "문서 \"{0}\" 임베딩 생성 시작됨", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.embeddingsStarted", languageCode, "문서 \"{0}\" 임베딩 생성 시작됨", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.embeddingsFailed", languageCode, "임베딩 생성 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.downloaded", languageCode, "문서 \"{0}\" 다운로드 완료", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.downloadSuccess", languageCode, "문서 \"{0}\" 다운로드 완료", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.message.pdfOnly", languageCode, "PDF 파일만 미리보기가 가능합니다.", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.supportedFormats", languageCode, "지원되는 파일 형식: PDF, DOCX, DOC, TXT", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.maxSize", languageCode, "파일 크기는 50MB를 초과할 수 없습니다", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.fileSizeLimit", languageCode, "파일 크기는 50MB를 초과할 수 없습니다", createdBy);
