...
public class KoreanAdvancedFeaturesAndCommonUITranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("organization.dashboard.charts.projectDistribution", languageCode, "프로젝트 분포",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.charts.projectDistribution.projects", languageCode, "프로젝트",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.charts.projectDistribution.members", languageCode, "멤버",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.charts.organizationList", languageCode, "조직 목록",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.charts.testResultDistribution", languageCode, "테스트 결과 분포",
                createdBy);
        createTranslationIfNotExists("organization.dashboard.charts.testResultDetails", languageCode, "테스트 결과 상세",
                createdBy);
        ...
        createTranslationIfNotExists("validation.password.complexity", languageCode, "비밀번호는 영문, 숫자, 특수문자를 포함해야 합니다",
                createdBy);
        ...
        createTranslationIfNotExists("junit.empty.uploadPrompt", languageCode, "JUnit XML 파일을 업로드하여 테스트 결과를 분석해보세요.",
                createdBy);
        ...
        createTranslationIfNotExists("junit.editor.tagsPlaceholder", languageCode, "쉼표로 구분하여 입력 (예: 버그, 회귀테스트, API)",
                createdBy);
        ...
        createTranslationIfNotExists("rag.upload.error.fileTooLarge", languageCode, "파일 크기가 너무 큽니다. (최대 {maxSize}MB)",
                createdBy);
        ...
        createTranslationIfNotExists("rag.upload.parser.pymupdf.description", languageCode, "다양한 기능을 갖춘 빠른 로컬 파서",
                createdBy);
        createTranslationIfNotExists("rag.upload.parser.pymupdf4llm.description", languageCode, "LLM 최적화 마크다운 추출",
                createdBy);
        ...
        createTranslationIfNotExists("rag.document.emptyDescription", languageCode, "상단의 업로드 영역을 사용하여 문서를 등록하세요",
                createdBy);
        ...
        createTranslationIfNotExists("rag.document.global.promoteSuccess", languageCode, "문서가 공통 RAG 문서로 이동되었습니다.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.similar.searchPlaceholder", languageCode, "예: 로그인 기능 테스트, 회원가입 유효성 검사",
                createdBy);
        ...
        createTranslationIfNotExists("rag.similar.metadata", languageCode, "문서 ID: {documentId} | 청크 순서: {chunkIndex}",
                createdBy);
        ...
        createTranslationIfNotExists("rag.similar.searchMethod.vector.description", languageCode, "의미적 유사도 기반 (순수 벡터)",
                createdBy);
        createTranslationIfNotExists("rag.similar.searchMethod.bm25", languageCode, "BM25 검색", createdBy);
        createTranslationIfNotExists("rag.similar.searchMethod.bm25.description", languageCode, "키워드 기반 (정확한 단어 매칭)",
                createdBy);
        createTranslationIfNotExists("rag.similar.searchMethod.hybrid", languageCode, "하이브리드 검색", createdBy);
        createTranslationIfNotExists("rag.similar.searchMethod.hybrid.description", languageCode, "벡터 + BM25 결합 (RRF)",
                createdBy);
        createTranslationIfNotExists("rag.similar.searchMethod.hybridRerank", languageCode, "하이브리드 + Reranker ⭐",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chat.deleteThreadConfirm", languageCode, "현재 스레드를 삭제하시겠습니까? 대화 내용이 모두 삭제됩니다.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.chat.deleteMessageConfirm", languageCode, "이 응답을 삭제하시겠습니까? 삭제 후 복구할 수 없습니다.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.analysis.defaultOnlyInfo", languageCode, "일반 사용자는 기본 LLM 설정만 사용할 수 있습니다.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.analysis.promptTemplateHelper", languageCode, "{chunk_text} 플레이스홀더를 사용하세요",
                createdBy);
        ...
        createTranslationIfNotExists("rag.analysis.pauseAfterBatchTooltip", languageCode, "배치마다 일시정지하고 사용자 확인을 기다립니다",
                createdBy);
        ...
        createTranslationIfNotExists("attachment.error.list.failed", languageCode, "첨부파일 목록을 조회하는 중 오류가 발생했습니다.",
                createdBy);
        createTranslationIfNotExists("attachment.error.notfound", languageCode, "첨부파일을 찾을 수 없습니다.", createdBy);
        createTranslationIfNotExists("attachment.error.info.failed", languageCode, "첨부파일 정보를 조회하는 중 오류가 발생했습니다.",
                createdBy);
        ...
        createTranslationIfNotExists("attachment.error.download.general", languageCode, "파일 다운로드 중 예상치 못한 오류가 발생했습니다.",
                createdBy);
        createTranslationIfNotExists("attachment.error.delete.failed", languageCode, "첨부파일을 삭제하는 중 오류가 발생했습니다.",
                createdBy);
        createTranslationIfNotExists("attachment.error.storage.failed", languageCode, "스토리지 정보를 조회하는 중 오류가 발생했습니다.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.document.summary.analyzedChunksLabel", languageCode, "분석 완료: {count}개",
                createdBy);
        ...
        createTranslationIfNotExists("rag.document.summary.chunkTemplate", languageCode, "📄 청크 {chunkNumber}",
                createdBy);
        createTranslationIfNotExists("rag.document.summary.progressFormat", languageCode, "{analyzed}/{total} 청크",
                createdBy);
        ...
        // Alert 메시지 관련 한국어 번역
        createTranslationIfNotExists("rag.document.alert.pauseUnavailable", languageCode, "진행 중인 작업만 일시정지할 수 있습니다.",
                createdBy);
        createTranslationIfNotExists("rag.document.alert.resumeUnavailable", languageCode, "일시정지된 작업만 재개할 수 있습니다.",
                createdBy);
        ...
        createTranslationIfNotExists("rag.document.confirm.analyze", languageCode, "문서 \"{fileName}\"을 분석하시겠습니까?",
                createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.message.allFieldsRequired", languageCode, "모든 필수 필드를 입력해주세요",
                createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.connectionSuccess", languageCode, "연결 테스트 성공!",
                createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.connectionFailed", languageCode, "연결 테스트 실패", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.invalidJson", languageCode, "템플릿이 유효한 JSON 형식이 아닙니다",
                createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.confirmDelete", languageCode, "정말 이 LLM 설정을 삭제하시겠습니까?",
                createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.deleted", languageCode, "LLM 설정이 삭제되었습니다", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.updated", languageCode, "LLM 설정이 수정되었습니다", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.created", languageCode, "LLM 설정이 생성되었습니다", createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.defaultChanged", languageCode, "기본 LLM 설정이 변경되었습니다",
                createdBy);
        createTranslationIfNotExists("admin.llmConfig.message.activeChanged", languageCode, "LLM 설정 활성 상태가 변경되었습니다",
                createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.template.title", languageCode, "📋 테스트 케이스 생성 기본 템플릿", createdBy);
        ...
        createTranslationIfNotExists("admin.llmConfig.template.downloadJson", languageCode, "JSON 다운로드", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.noDocuments", languageCode, "아직 공통 문서가 없습니다. 첫 번째 문서를 업로드해보세요!",
                createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.info.examplesTitle", languageCode, "💡 활용 예시:", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example1", languageCode, "회사 공통 코딩 컨벤션 및 개발 가이드라인",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example2", languageCode, "테스트 작성 표준 및 품질 관리 문서", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example3", languageCode,
                "프로젝트 공통 참조 문서 (API 명세, 아키텍처 가이드 등)", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.example4", languageCode, "조직 전체의 모범 사례 및 학습 자료", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.techSpecsTitle", languageCode, "⚙️ 기술 사양:", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.supportedFormats", languageCode,
                "지원 형식: PDF, DOCX, DOC, TXT (최대 50MB)", createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.autoSearch", languageCode, "모든 프로젝트의 RAG Q&A에서 자동 검색됨",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.info.adminOnly", languageCode, "관리자만 업로드/삭제 가능 (ADMIN 권한 필요)",
                createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.action.generateEmbedding", languageCode, "임베딩 생성", createdBy);
        createTranslationIfNotExists("admin.globalDoc.action.generateEmbeddings", languageCode, "임베딩 생성", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.uploadSuccess", languageCode, "공통 문서 \"{0}\"이 업로드되었습니다",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.uploadFailed", languageCode, "공통 문서 업로드 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.deleteSuccess", languageCode, "공통 문서 \"{0}\"이 삭제되었습니다",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.deleteFailed", languageCode, "공통 문서 삭제 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.uploaded", languageCode, "공통 문서 \"{0}\"이 업로드되었습니다",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.deleted", languageCode, "공통 문서 \"{0}\"이 삭제되었습니다",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmDelete", languageCode, "공통 문서 \"{0}\"을 삭제하시겠습니까?",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.confirmAnalyze", languageCode, "문서 \"{0}\"을 분석하시겠습니까?",
                createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.message.confirmEmbeddings", languageCode,
                "문서 \"{0}\"의 임베딩을 생성하시겠습니까?", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.analyzeStarted", languageCode, "문서 \"{0}\" 분석 시작됨",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.analyzeFailed", languageCode, "분석 시작 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.embeddingStarted", languageCode, "문서 \"{0}\" 임베딩 생성 시작됨",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.embeddingsStarted", languageCode, "문서 \"{0}\" 임베딩 생성 시작됨",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.embeddingsFailed", languageCode, "임베딩 생성 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.downloaded", languageCode, "문서 \"{0}\" 다운로드 완료",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.downloadSuccess", languageCode, "문서 \"{0}\" 다운로드 완료",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.downloadFailed", languageCode, "다운로드 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.viewChunksFailed", languageCode, "청크 조회 실패", createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.previewFailed", languageCode, "미리보기 실패", createdBy);
        ...
        createTranslationIfNotExists("admin.globalDoc.message.maxSize", languageCode, "파일 크기는 50MB를 초과할 수 없습니다",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.fileSizeLimit", languageCode, "파일 크기는 50MB를 초과할 수 없습니다",
                createdBy);
        createTranslationIfNotExists("admin.globalDoc.message.unknownError", languageCode, "알 수 없는 오류", createdBy);
