...
public class EnglishOrganizationAndUserManagementTranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("profile.appearance.description", languageCode, "Customize the theme of the application.", createdBy);
        ...
        createTranslationIfNotExists("profile.appearance.lightMode.description", languageCode, "Clean interface with bright background", createdBy);
        createTranslationIfNotExists("profile.appearance.darkMode.description", languageCode, "Comfortable interface with dark background", createdBy);
        ...
        createTranslationIfNotExists("profile.appearance.info", languageCode, "Theme changes are applied immediately and saved automatically to your browser.", createdBy);
