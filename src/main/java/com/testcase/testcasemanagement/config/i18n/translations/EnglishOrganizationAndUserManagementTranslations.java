...
public class EnglishOrganizationAndUserManagementTranslations {
  ...
  public void initialize() {
    ...
    createTranslationIfNotExists(
        "recentResults.status.unknown", languageCode, "Unknown", createdBy);
    createTranslationIfNotExists(
        "recentResults.message.noResults", languageCode, "No recent test results.", createdBy);
    createTranslationIfNotExists(
        "recentResults.title.withCount",
        languageCode,
        "Recent Test Results ({count} items)",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "recentResults.label.execution", languageCode, "Execution:", createdBy);
    createTranslationIfNotExists(
        "recentResults.label.executor", languageCode, "Executor:", createdBy);
    createTranslationIfNotExists("recentResults.label.notes", languageCode, "Notes:", createdBy);
    createTranslationIfNotExists(
        "recentResults.testcase.fallback", languageCode, "Test Case {id}", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "junit.error.loadFailed", languageCode, "Failed to load test results.", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "junit.comment.fileNameExtraction",
        languageCode,
        "Extract execution name from file name",
        createdBy);
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "mail.manager.title", languageCode, "Mail Settings Management", createdBy);
    createTranslationIfNotExists(
        "mail.manager.currentSettings", languageCode, "Current Mail Settings", createdBy);
    createTranslationIfNotExists(
        "mail.manager.subheader",
        languageCode,
        "System email sending configuration status",
        createdBy);
    createTranslationIfNotExists(
        "mail.manager.notConfigured",
        languageCode,
        "Mail settings are not configured. Please add new settings.",
        createdBy);
    ...
    createTranslationIfNotExists(
        "mail.status.activatedStatus", languageCode, "Activated", createdBy);
    createTranslationIfNotExists(
        "mail.status.deactivatedStatus", languageCode, "Deactivated", createdBy);
    ...
    createTranslationIfNotExists(
        "mail.smtp.security", languageCode, "Security Settings", createdBy);
    ...
    createTranslationIfNotExists(
        "mail.button.newSettings", languageCode, "New Settings", createdBy);
    createTranslationIfNotExists(
        "mail.button.modifySettings", languageCode, "Modify Settings", createdBy);
    ...
    createTranslationIfNotExists(
        "mail.button.detailedMethod", languageCode, "Detailed Setup Method", createdBy);
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.requirements", languageCode, "Required Requirements", createdBy);
    createTranslationIfNotExists(
        "mail.guide.gmailAccount", languageCode, "Gmail Account", createdBy);
    createTranslationIfNotExists(
        "mail.guide.twoFactorAuth", languageCode, "2-Factor Authentication Required", createdBy);
    createTranslationIfNotExists(
        "mail.guide.appPassword", languageCode, "Generate App Password", createdBy);
    createTranslationIfNotExists(
        "mail.config.title.new", languageCode, "New Mail Settings", createdBy);
    createTranslationIfNotExists(
        "mail.config.title.edit", languageCode, "Edit Mail Settings", createdBy);
    createTranslationIfNotExists(
        "mail.config.gmailInfo",
        languageCode,
        "This system only supports Gmail SMTP. Gmail 2-factor authentication and app password are"
            + " required.",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.enableMail", languageCode, "Enable Mail Function", createdBy);
    createTranslationIfNotExists(
        "mail.config.form.gmailAddress", languageCode, "Gmail Address", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "mail.config.form.gmailAddressHelper",
        languageCode,
        "Example: your-email@gmail.com",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.form.appPassword", languageCode, "Gmail App Password", createdBy);
    createTranslationIfNotExists(
        "mail.config.form.appPasswordPlaceholder", languageCode, "Gmail App Password", createdBy);
    createTranslationIfNotExists(
        "mail.config.form.appPasswordHelper",
        languageCode,
        "16-digit Gmail app password (no spaces)",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.form.senderName", languageCode, "Sender Name", createdBy);
    createTranslationIfNotExists(
        "mail.config.form.senderNamePlaceholder", languageCode, "TestCase Manager", createdBy);
    createTranslationIfNotExists(
        "mail.config.form.senderNameHelper",
        languageCode,
        "Sender name to be displayed in emails",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.form.testRecipient",
        languageCode,
        "Test Mail Recipient (Optional)",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.form.testRecipientPlaceholder", languageCode, "test@example.com", createdBy);
    createTranslationIfNotExists(
        "mail.config.form.testRecipientHelper",
        languageCode,
        "Email address to receive test mail after setup",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.validation.gmailRequired",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Only Gmail addresses are supported. (Must end with @gmail.com)",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.validation.passwordRequired",
        languageCode,
        "Gmail app password is required.",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.validation.passwordLength",
        languageCode,
        "App password must be at least 8 characters long.",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.validation.senderNameRequired",
        languageCode,
        "Sender name is required.",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.fixedSettings", languageCode, "Gmail Fixed Settings:", createdBy);
    createTranslationIfNotExists(
        "mail.config.fixedSettings.smtp",
        languageCode,
        "SMTP Server: smtp.gmail.com:587",
        createdBy);
    createTranslationIfNotExists(
        "mail.config.fixedSettings.tls", languageCode, "TLS Encryption: Used", createdBy);
    createTranslationIfNotExists(
        "mail.config.fixedSettings.auth", languageCode, "SMTP Authentication: Used", createdBy);
    ...
    createTranslationIfNotExists(
        "mail.guide.step1.title", languageCode, "Gmail Account Login", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step1.description", languageCode, "Log in to your Gmail account", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step2.title", languageCode, "Go to Google Account Management", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step2.description",
        languageCode,
        "Navigate to Google Account Management page for security settings",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step3.title", languageCode, "Enable 2-Factor Authentication", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step3.description",
        languageCode,
        "Enable 2-factor authentication to generate app passwords",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step4.title", languageCode, "Generate App Password", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step4.description",
        languageCode,
        "Generate an app password for TestCase Manager",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step5.title", languageCode, "Configure in TestCase Manager", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step5.description",
        languageCode,
        "Enter the generated information in TestCase Manager",
        createdBy);
    createTranslationIfNotExists(
        "mail.message.saveSuccess", languageCode, "Mail settings saved successfully.", createdBy);
    createTranslationIfNotExists(
        "mail.message.saveError", languageCode, "Failed to save mail settings.", createdBy);
    createTranslationIfNotExists(
        "mail.message.loadError", languageCode, "Failed to load mail settings.", createdBy);
    createTranslationIfNotExists(
        "mail.message.testSuccess", languageCode, "Test mail has been sent to {email}.", createdBy);
    createTranslationIfNotExists(
        "mail.message.testError", languageCode, "Failed to send test mail.", createdBy);
    createTranslationIfNotExists(
        "mail.message.disableSuccess", languageCode, "Mail function has been disabled.", createdBy);
    createTranslationIfNotExists(
        "mail.message.disableError", languageCode, "Failed to disable mail settings.", createdBy);
    createTranslationIfNotExists(
        "mail.message.disableConfirm",
        languageCode,
        "Are you sure you want to disable mail function?",
        createdBy);
    createTranslationIfNotExists(
        "mail.message.testRecipientPrompt",
        languageCode,
        "Enter email address to receive test mail:",
        createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "mail.troubleshoot.q1", languageCode, "I can't generate an app password", createdBy);
    createTranslationIfNotExists(
        "mail.troubleshoot.a1",
        languageCode,
        "Please check if 2-factor authentication is enabled. You cannot generate an app password"
            + " without 2-factor authentication.",
        createdBy);
    createTranslationIfNotExists(
        "mail.troubleshoot.q2", languageCode, "Mail sending fails", createdBy);
    createTranslationIfNotExists(
        "mail.troubleshoot.a2",
        languageCode,
        "Please verify that you entered the app password correctly. You must enter all 16 digits"
            + " without spaces.",
        createdBy);
    createTranslationIfNotExists(
        "mail.troubleshoot.q3", languageCode, "Can't I use my regular password?", createdBy);
    createTranslationIfNotExists(
        "mail.troubleshoot.a3",
        languageCode,
        "For security reasons, you cannot use your Gmail account's regular password. You must use"
            + " an app password.",
        createdBy);
    createTranslationIfNotExists(
        "mail.troubleshoot.q4", languageCode, "Can I use G Suite accounts?", createdBy);
    createTranslationIfNotExists(
        "mail.troubleshoot.a4",
        languageCode,
        "G Suite/Google Workspace accounts may vary depending on administrator settings. Please"
            + " check SMTP usage permissions with your administrator.",
        createdBy);
    createTranslationIfNotExists(
        "mail.security.warning1",
        languageCode,
        "App passwords have the same permissions as your Gmail account password.",
        createdBy);
    createTranslationIfNotExists(
        "mail.security.warning2",
        languageCode,
        "Do not share your app password with others.",
        createdBy);
    createTranslationIfNotExists(
        "mail.security.warning3",
        languageCode,
        "Regularly delete unnecessary app passwords.",
        createdBy);
    createTranslationIfNotExists(
        "mail.security.warning4",
        languageCode,
        "Delete app passwords immediately if suspicious activity is detected.",
        createdBy);
    createTranslationIfNotExists(
        "mail.security.warning5",
        languageCode,
        "Regularly review your Google account security activity.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step1.instruction1", languageCode, "1. Open Gmail (", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step1.instruction1.suffix", languageCode, ") in your web browser.", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step1.instruction2",
        languageCode,
        "2. Log in with the Gmail account you want to use for email settings.",
        createdBy);
    createTranslationIfNotExists("mail.guide.step1.alert.title", languageCode, "Note:", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step1.alert.message",
        languageCode,
        "Only personal Gmail accounts are supported. G Suite/Google Workspace accounts may require"
            + " additional setup.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step2.instruction1",
        languageCode,
        "1. Click your profile icon in the top right corner of Gmail.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step2.instruction2",
        languageCode,
        "2. Click the \"Manage your Google Account\" button.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step2.instruction3.prefix", languageCode, "Or directly visit ", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step2.instruction3.suffix", languageCode, ".", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step3.instruction1",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "2. Find the \"2-Step Verification\" section and click \"Get started\".",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step3.instruction3",
        languageCode,
        "3. Follow the instructions to register your phone number and complete verification.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step3.alert.title", languageCode, "Required Step:", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "1. On the \"Security\" page, click \"App passwords\".",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step4.instruction2",
        languageCode,
        "2. From the \"Select app\" dropdown, choose \"Mail\".",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step4.instruction3",
        languageCode,
        "3. From the \"Select device\" dropdown, choose \"Other (Custom name)\".",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step4.instruction4",
        languageCode,
        "4. Enter \"TestCase Manager\" and click \"Generate\".",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step4.instruction5",
        languageCode,
        "5. Copy the generated 16-character password.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step4.alert.title", languageCode, "Important:", createdBy);
    createTranslationIfNotExists(
        "mail.guide.step4.alert.message",
        languageCode,
        "The generated app password is shown only once. Store it in a safe place.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step5.instruction1",
        languageCode,
        "1. Enter the following information in the mail settings dialog:",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step5.instruction2",
        languageCode,
        "2. Click the \"Save\" button to complete the setup.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step5.instruction3",
        languageCode,
        "3. Use the \"Test Send\" button to verify that the settings are correct.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step5.gmail.address",
        languageCode,
        "Gmail Address: your-email@gmail.com",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step5.app.password",
        languageCode,
        "App Password: 16-character generated password",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.step5.sender.name",
        languageCode,
        "Sender Name: TestCase Manager (or desired name)",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.requirements.header", languageCode, "📋 Required Prerequisites", createdBy);
    createTranslationIfNotExists(
        "mail.guide.requirements.gmail", languageCode, "Gmail Account (@gmail.com)", createdBy);
    createTranslationIfNotExists(
        "mail.guide.requirements.twoFactor",
        languageCode,
        "2-Factor Authentication Enabled",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.requirements.appPassword", languageCode, "App Password Generated", createdBy);
    createTranslationIfNotExists(
        "mail.guide.requirements.https", languageCode, "HTTPS Connection", createdBy);
    createTranslationIfNotExists(
        "mail.guide.sections.stepGuide", languageCode, "🔧 Step-by-Step Setup Method", createdBy);
    createTranslationIfNotExists(
        "mail.guide.sections.troubleshooting", languageCode, "🔍 Troubleshooting", createdBy);
    createTranslationIfNotExists(
        "mail.guide.sections.security", languageCode, "🔒 Security Warnings", createdBy);
    ...
    createTranslationIfNotExists(
        "profile.form.usernameHelper", languageCode, "Username cannot be changed.", createdBy);
    ...
    createTranslationIfNotExists(
        "profile.validation.allRequired",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "language.interface", languageCode, "Interface Language", createdBy);
    createTranslationIfNotExists(
        "language.helperText",
        languageCode,
    ...
    createTranslationIfNotExists(
        "profile.jira.settings.title", languageCode, "JIRA Integration Settings", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "profile.jira.button.configure", languageCode, "Configure Settings", createdBy);
    createTranslationIfNotExists(
        "profile.jira.button.delete", languageCode, "Delete Settings", createdBy);
    createTranslationIfNotExists(
        "profile.jira.confirm.delete",
        languageCode,
        "Are you sure you want to delete JIRA settings?",
        createdBy);
    createTranslationIfNotExists(
        "profile.jira.success.saved", languageCode, "JIRA settings saved successfully.", createdBy);
    createTranslationIfNotExists(
        "profile.jira.success.deleted",
        languageCode,
        "JIRA settings deleted successfully.",
        createdBy);
    createTranslationIfNotExists(
        "profile.jira.error.saveFailed", languageCode, "Failed to save JIRA settings.", createdBy);
    createTranslationIfNotExists(
        "profile.jira.error.deleteFailed",
        languageCode,
        "Failed to delete JIRA settings.",
        createdBy);
    createTranslationIfNotExists(
        "profile.jira.error.network",
        languageCode,
        "Please check your network connection.",
        createdBy);
    createTranslationIfNotExists(
        "profile.jira.error.authentication",
        languageCode,
        "Your session has expired. Please log in again.",
        createdBy);
    createTranslationIfNotExists(
        "profile.jira.error.encryption",
        languageCode,
        "Server configuration issue. Please contact administrator.",
        createdBy);
    createTranslationIfNotExists(
        "password.requirements.title", languageCode, "Password Requirements:", createdBy);
    createTranslationIfNotExists(
        "password.requirements.length", languageCode, "8-100 characters long", createdBy);
    createTranslationIfNotExists(
        "password.requirements.letter", languageCode, "Contains letters", createdBy);
    createTranslationIfNotExists(
        "password.requirements.digit", languageCode, "Contains numbers", createdBy);
    createTranslationIfNotExists(
        "password.requirements.special", languageCode, "Contains special characters", createdBy);
    createTranslationIfNotExists(
        "password.requirements.combination", languageCode, "At least 2 combinations", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "password.error.changeFailed",
        languageCode,
        "An error occurred while changing the password.",
        createdBy);
    createTranslationIfNotExists(
        "password.validation.newRequired", languageCode, "Please enter a new password", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "user.role.admin.description", languageCode, "Access to all system functions", createdBy);
    createTranslationIfNotExists(
        "user.role.manager.description",
        languageCode,
        "Project management and team leadership",
        createdBy);
    createTranslationIfNotExists(
        "user.role.tester.description",
        languageCode,
        "Test case creation and execution",
        createdBy);
    createTranslationIfNotExists(
        "user.role.user.description", languageCode, "Basic system usage", createdBy);
    ...
    createTranslationIfNotExists(
        "userDetail.password.title", languageCode, "Change Password (Admin)", createdBy);
    createTranslationIfNotExists(
        "userDetail.password.targetUser", languageCode, "Target User:", createdBy);
    createTranslationIfNotExists(
        "userDetail.password.skipCurrent",
        languageCode,
        "Skip current password confirmation (Admin privilege)",
        createdBy);
    createTranslationIfNotExists(
        "userDetail.password.current", languageCode, "Current Password", createdBy);
    createTranslationIfNotExists(
        "userDetail.password.new", languageCode, "New Password", createdBy);
    createTranslationIfNotExists(
        "userDetail.password.confirm", languageCode, "Confirm New Password", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "userDetail.password.requirements.length",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "userDetail.password.button.cancel", languageCode, "Cancel", createdBy);
    createTranslationIfNotExists(
        "userDetail.password.button.changing", languageCode, "Changing...", createdBy);
    createTranslationIfNotExists(
        "userDetail.password.button.change", languageCode, "Change Password", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Must include at least 2 of: letters, numbers, special characters",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "userDetail.activity.active", languageCode, "Active Recently", createdBy);
    createTranslationIfNotExists(
        "userDetail.activity.recent", languageCode, "Active within a week", createdBy);
    createTranslationIfNotExists(
        "userDetail.activity.moderate", languageCode, "Active within a month", createdBy);
    createTranslationIfNotExists(
        "userDetail.activity.inactive", languageCode, "Inactive for a long time", createdBy);
    ...
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "password.validation.maxLength", languageCode, "Cannot exceed 100 characters", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "password.validation.mismatch", languageCode, "Does not match the new password", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "password.change.title", languageCode, "Change Password", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "password.form.current", languageCode, "Current Password", createdBy);
    createTranslationIfNotExists("password.form.new", languageCode, "New Password", createdBy);
    createTranslationIfNotExists(
        "password.form.confirm", languageCode, "Confirm New Password", createdBy);
    createTranslationIfNotExists(
        "password.placeholder.current", languageCode, "Enter your current password", createdBy);
    createTranslationIfNotExists(
        "password.placeholder.new", languageCode, "Enter new password (8+ characters)", createdBy);
    createTranslationIfNotExists(
        "password.placeholder.confirm", languageCode, "Re-enter new password", createdBy);
    createTranslationIfNotExists(
        "password.button.change", languageCode, "Change Password", createdBy);
    createTranslationIfNotExists(
        "password.button.changing", languageCode, "Changing...", createdBy);
    createTranslationIfNotExists("profile.title", languageCode, "User Profile", createdBy);
    createTranslationIfNotExists("profile.tabs.basicInfo", languageCode, "Basic Info", createdBy);
    createTranslationIfNotExists("profile.tabs.password", languageCode, "Password", createdBy);
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "You need an invitation to participate in projects.",
        createdBy);
    createTranslationIfNotExists(
        "project.messages.requestInvitation",
        languageCode,
        "Please request an invitation from the project manager.",
        createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "userDetail.tooltip.passwordChange", languageCode, "Change Password", createdBy);
    ...
    createTranslationIfNotExists(
        "userDetail.form.accountActive", languageCode, "Account Active", createdBy);
    createTranslationIfNotExists(
        "project.dialog.transferTitle", languageCode, "Project Organization Transfer", createdBy);
    createTranslationIfNotExists(
        "project.dialog.transferDescription",
        languageCode,
        "You can transfer '<strong>{projectName}</strong>' project to another organization or make"
            + " it an independent project.",
        createdBy);
    createTranslationIfNotExists(
        "project.dialog.forceDeleteTitle", languageCode, "Confirm Force Delete Project", createdBy);
    createTranslationIfNotExists(
        ...
        createdBy);
    createTranslationIfNotExists(
        "project.dialog.forceDeleteWarningTitle",
        languageCode,
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "All associated test plans, test cases, and execution history will be deleted together!"
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "This action cannot be undone. All test cases and data belonging to this project will also"
            + " be deleted.",
        createdBy);
    createTranslationIfNotExists(
        "mail.guide.dialog.title", languageCode, "Gmail App Password Setup Guide", createdBy);
    ...
    createTranslationIfNotExists(
        "junit.dashboard.uploadResult", languageCode, "Upload Result", createdBy);
    ...
    createTranslationIfNotExists(
        "organization.form.descriptionPlaceholder",
        languageCode,
        "Enter organization description",
        createdBy);
    createTranslationIfNotExists(
        "junit.placeholder.executionName", languageCode, "Enter execution name", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        ...
        languageCode,
        "Search test case name, description, step content...",
        createdBy);
    createTranslationIfNotExists(
        "preset.name.placeholder", languageCode, "Example: My Test Cases", createdBy);
    createTranslationIfNotExists(
        "common.unauthorized.title", languageCode, "Unauthorized", createdBy);
    createTranslationIfNotExists(
        "common.unauthorized.message",
        languageCode,
    ...
    createTranslationIfNotExists(
        "organization.dashboard.title", languageCode, "Organization Dashboard", createdBy);
    createTranslationIfNotExists(
        "organization.management.title", languageCode, "Organization Management", createdBy);
    createTranslationIfNotExists(
        "organization.dialog.edit.title", languageCode, "Edit Organization", createdBy);
    createTranslationIfNotExists(
        "organization.dialog.create.title", languageCode, "Create Organization", createdBy);

    // Timezone English Translations
    createTranslationIfNotExists(
        "timezone.settings.title", languageCode, "Timezone Settings", createdBy);
    createTranslationIfNotExists(
    ...
    createTranslationIfNotExists(
        "timezone.newYork", languageCode, "New York (UTC-5/-4)", createdBy);
    createTranslationIfNotExists(
        "timezone.losAngeles", languageCode, "Los Angeles (UTC-8/-7)", createdBy);
    ...
    createTranslationIfNotExists(
        "timezone.singapore", languageCode, "Singapore (UTC+8)", createdBy);
    ...
    createTranslationIfNotExists(
        "organization.dashboard.tabs.performanceMetrics",
        languageCode,
        "Performance Metrics",
        createdBy);
    ...
    createTranslationIfNotExists(
        "performance.title", languageCode, "System Performance Metrics", createdBy);
    createTranslationIfNotExists(
        "performance.lastUpdated", languageCode, "Last Updated: {time}", createdBy);
    createTranslationIfNotExists("performance.refresh", languageCode, "Refresh", createdBy);
    createTranslationIfNotExists(
        "performance.systemResources", languageCode, "System Resources", createdBy);
    ...
    createTranslationIfNotExists(
        "performance.cache.project", languageCode, "Project Cache", createdBy);
    createTranslationIfNotExists(
        "performance.cache.testcase", languageCode, "Test Case Cache", createdBy);
    ...
    createTranslationIfNotExists(
        "performance.application", languageCode, "Application Performance", createdBy);
    createTranslationIfNotExists(
        "performance.avgResponseTime", languageCode, "Avg Response Time", createdBy);
    createTranslationIfNotExists(
        "performance.requestsPerSecond", languageCode, "Requests/sec", createdBy);
    createTranslationIfNotExists(
        "performance.activeConnections", languageCode, "Active Connections", createdBy);
    createTranslationIfNotExists("performance.usage", languageCode, "Usage Summary", createdBy);
    createTranslationIfNotExists(
        "performance.usage.todayVisits", languageCode, "Today's Visits", createdBy);
    createTranslationIfNotExists(
        "performance.usage.uniqueVisitors", languageCode, "Unique Visitors Today", createdBy);
    createTranslationIfNotExists(
        "performance.usage.activeSessions", languageCode, "Active Sessions", createdBy);
    createTranslationIfNotExists(
        "performance.usage.recentMinutes", languageCode, "Last {minutes} minutes", createdBy);
    createTranslationIfNotExists(
        "performance.usage.topPages", languageCode, "Top Pages", createdBy);
    createTranslationIfNotExists(
        "performance.usage.totalAccumulated", languageCode, "Total {total}", createdBy);
    createTranslationIfNotExists(
        "performance.usage.dailySummary", languageCode, "Daily Visit Summary", createdBy);
    createTranslationIfNotExists(
        "performance.usage.uniqueCount", languageCode, "Unique {count}", createdBy);
    createTranslationIfNotExists(
        "performance.error.loadFailed",
        languageCode,
    ...
    createTranslationIfNotExists(
        "profile.version.title", languageCode, "Version Information", createdBy);
