...
public class EnglishOrganizationAndUserManagementTranslations {
    ...
    public void initialize() {
        ...
        createTranslationIfNotExists("junit.tracelog.noErrorLog", languageCode, "No error logs for this test case.",
                createdBy);
        ...
        createTranslationIfNotExists("junit.testbody.noOutput", languageCode, "No system output for this test case.",
                createdBy);
        ...
        createTranslationIfNotExists("mail.guide.description", languageCode,
                "TestCase Manager only supports Gmail SMTP. Gmail app password setup is required.", createdBy);
        ...
        createTranslationIfNotExists("mail.guide.twoFactorAuth", languageCode, "2-Factor Authentication Required",
                createdBy);
        ...
        createTranslationIfNotExists("mail.config.form.gmailAddressPlaceholder", languageCode, "your-email@gmail.com",
                createdBy);
        ...
        createTranslationIfNotExists("mail.config.form.appPasswordPlaceholder", languageCode, "Gmail App Password",
                createdBy);
        ...
        createTranslationIfNotExists("mail.config.form.testRecipient", languageCode, "Test Mail Recipient (Optional)",
                createdBy);
        createTranslationIfNotExists("mail.config.form.testRecipientPlaceholder", languageCode, "test@example.com",
                createdBy);
        ...
        createTranslationIfNotExists("mail.config.validation.gmailRequired", languageCode, "Gmail address is required.",
                createdBy);
        ...
        createTranslationIfNotExists("mail.config.fixedSettings.smtp", languageCode, "SMTP Server: smtp.gmail.com:587",
                createdBy);
        createTranslationIfNotExists("mail.config.fixedSettings.tls", languageCode, "TLS Encryption: Used", createdBy);
        createTranslationIfNotExists("mail.config.fixedSettings.auth", languageCode, "SMTP Authentication: Used",
                createdBy);
        ...
        createTranslationIfNotExists("mail.guide.step1.description", languageCode, "Log in to your Gmail account",
                createdBy);
        ...
        createTranslationIfNotExists("mail.message.saveSuccess", languageCode, "Mail settings saved successfully.",
                createdBy);
        ...
        createTranslationIfNotExists("mail.message.loadError", languageCode, "Failed to load mail settings.",
                createdBy);
        createTranslationIfNotExists("mail.message.testSuccess", languageCode, "Test mail has been sent to {email}.",
                createdBy);
        createTranslationIfNotExists("mail.message.testError", languageCode, "Failed to send test mail.", createdBy);
        createTranslationIfNotExists("mail.message.disableSuccess", languageCode, "Mail function has been disabled.",
                createdBy);
        createTranslationIfNotExists("mail.message.disableError", languageCode, "Failed to disable mail settings.",
                createdBy);
        ...
        createTranslationIfNotExists("mail.message.setupComplete", languageCode,
                "All setup is complete! You can now use the mail function in TestCase Manager.", createdBy);
        ...
        createTranslationIfNotExists("mail.guide.step1.instruction1.suffix", languageCode, ") in your web browser.",
                createdBy);
        ...
        createTranslationIfNotExists("mail.guide.step3.instruction3", languageCode,
                "3. Follow the instructions to register your phone number and complete verification.", createdBy);
        ...
        createTranslationIfNotExists("mail.guide.requirements.header", languageCode, "📋 Required Prerequisites",
                createdBy);
        createTranslationIfNotExists("mail.guide.requirements.gmail", languageCode, "Gmail Account (@gmail.com)",
                createdBy);
        createTranslationIfNotExists("mail.guide.requirements.twoFactor", languageCode,
                "2-Factor Authentication Enabled", createdBy);
        createTranslationIfNotExists("mail.guide.requirements.appPassword", languageCode, "App Password Generated",
                createdBy);
        createTranslationIfNotExists("mail.guide.requirements.https", languageCode, "HTTPS Connection", createdBy);
        createTranslationIfNotExists("mail.guide.sections.stepGuide", languageCode, "🔧 Step-by-Step Setup Method",
                createdBy);
        ...
        createTranslationIfNotExists("profile.error.updateFailed", languageCode, "Failed to update profile.",
                createdBy);
        createTranslationIfNotExists("profile.appearance.title", languageCode, "Appearance Settings", createdBy);
        ...
        createTranslationIfNotExists("profile.appearance.info", languageCode,
                "Theme changes are applied immediately and saved automatically to your browser.", createdBy);
        ...
        createTranslationIfNotExists("language.settings.description", languageCode,
                "Select your preferred language to display the entire application in that language.", createdBy);
        ...
        createTranslationIfNotExists("profile.jira.success.saved", languageCode, "JIRA settings saved successfully.",
                createdBy);
        createTranslationIfNotExists("profile.jira.success.deleted", languageCode,
                "JIRA settings deleted successfully.", createdBy);
        createTranslationIfNotExists("profile.jira.error.saveFailed", languageCode, "Failed to save JIRA settings.",
                createdBy);
        createTranslationIfNotExists("profile.jira.error.deleteFailed", languageCode, "Failed to delete JIRA settings.",
                createdBy);
        ...
        createTranslationIfNotExists("password.requirements.special", languageCode, "Contains special characters",
                createdBy);
        createTranslationIfNotExists("password.requirements.combination", languageCode, "At least 2 combinations",
                createdBy);
        ...
        createTranslationIfNotExists("password.validation.newRequired", languageCode, "Please enter a new password",
                createdBy);
        ...
        createTranslationIfNotExists("user.role.admin.description", languageCode, "Access to all system functions",
                createdBy);
        createTranslationIfNotExists("user.role.manager.description", languageCode,
                "Project management and team leadership", createdBy);
        createTranslationIfNotExists("user.role.tester.description", languageCode, "Test case creation and execution",
                createdBy);
        ...
        createTranslationIfNotExists("userDetail.password.requirements.title", languageCode, "Password Requirements:",
                createdBy);
        createTranslationIfNotExists("userDetail.password.requirements.length", languageCode, "8-100 characters long",
                createdBy);
        createTranslationIfNotExists("userDetail.password.requirements.complexity", languageCode,
                "Must include at least 2 of the following: letters, numbers, special characters", createdBy);
        ...
        createTranslationIfNotExists("password.validation.minLength", languageCode,
                "Must be at least 8 characters long", createdBy);
        createTranslationIfNotExists("password.validation.maxLength", languageCode, "Cannot exceed 100 characters",
                createdBy);
        createTranslationIfNotExists("password.validation.complexity", languageCode,
                "Must include at least 2 of: letters, numbers, special characters", createdBy);
        createTranslationIfNotExists("password.validation.mismatch", languageCode, "Does not match the new password",
                createdBy);
        ...
        createTranslationIfNotExists("password.placeholder.current", languageCode, "Enter your current password",
                createdBy);
        createTranslationIfNotExists("password.placeholder.new", languageCode, "Enter new password (8+ characters)",
                createdBy);
        ...
        createTranslationIfNotExists("common.unauthorized.redirecting", languageCode, "Redirecting to login page...",
                createdBy);
        ...
        createTranslationIfNotExists("common.confirm.delete", languageCode, "Are you sure you want to delete this?",
                createdBy);
        ...
        createTranslationIfNotExists("common.unauthorized.backToProjects", languageCode, "Back to Project Selection",
                createdBy);
        ...
        createTranslationIfNotExists("project.dialog.transferTitle", languageCode, "Project Organization Transfer",
                createdBy);
        createTranslationIfNotExists("project.dialog.transferDescription", languageCode,
                ...
                createdBy);
        createTranslationIfNotExists("project.dialog.forceDeleteTitle", languageCode, "Confirm Force Delete Project",
                createdBy);
        createTranslationIfNotExists("project.dialog.forceDeleteConfirm", languageCode,
                "Are you sure you want to force delete '<strong>{projectName}</strong>' project?", createdBy);
        createTranslationIfNotExists("project.dialog.forceDeleteWarningTitle", languageCode, "⚠️ Force Delete Warning",
                createdBy);
        ...
        createTranslationIfNotExists("testcase.validation.stepRequired", languageCode, "Please enter step content.",
                createdBy);
        ...
        createTranslationIfNotExists("timezone.settings.description", languageCode,
                "When you set a timezone, all times will be displayed in the selected timezone.", createdBy);
        ...
        createTranslationIfNotExists("timezone.helperText", languageCode,
                "The default timezone is UTC. Changes will be applied after clicking the save button.", createdBy);
        ...
        createTranslationIfNotExists("profile.version.loading", languageCode, "Loading version information...",
                createdBy);
        createTranslationIfNotExists("profile.version.error", languageCode, "Unable to load version information.",
                createdBy);
    }
