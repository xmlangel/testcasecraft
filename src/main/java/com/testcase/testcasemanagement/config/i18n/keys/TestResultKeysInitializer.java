...
public class TestResultKeysInitializer {
    ...
    public void initialize() {
        ...
        createTranslationKeyIfNotExists("testResult.form.notesFileRecommendation", "testResult", "비고 파일 첨부 권장 메시지",
                "긴 내용은 파일 첨부를 권장합니다.");
        ...
        createTranslationKeyIfNotExists("testResultDashboard.chart.planComparison", "testResult", "테스트 플랜별 결과 비교",
                "테스트 플랜별 결과 비교");
        createTranslationKeyIfNotExists("testResultDashboard.chart.executorComparison", "testResult", "실행자별 결과 비교",
                "실행자별 결과 비교");
        ...
        createTranslationKeyIfNotExists("testTrendAnalysis.error.comparisonLoadFailed", "testResult", "비교 데이터 로드 실패",
        ...
        createTranslationKeyIfNotExists("testTrendAnalysis.prompt.selectTestPlan", "testResult", "테스트 플랜 선택 프롬프트",
                "비교할 테스트 플랜을 선택해주세요");
        ...
        createTranslationKeyIfNotExists("testResult.export.format.excel.title", "testResult", "Excel 형식 제목",
                "Excel (.xlsx)");
        createTranslationKeyIfNotExists("testResult.export.format.excel.description", "testResult", "Excel 형식 설명",
