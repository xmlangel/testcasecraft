...
public class TestResultKeysInitializer {
  ...
  public void initialize() {
    ...
    createTranslationKeyIfNotExists(
        "testResult.mainPage.title", "testResult", "테스트 결과 페이지 제목", "테스트 결과");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "testResult.tab.statisticsFull", "testResult", "통계 대시보드 탭", "통계 대시보드");
    createTranslationKeyIfNotExists(
    ...
    // 테스트케이스 결과 페이지
    createTranslationKeyIfNotExists(
        "testCaseResult.page.title", "testResult", "테스트케이스 결과 페이지 제목", "테스트 케이스 결과");
    ...
    createTranslationKeyIfNotExists(
        "testResult.form.automationStatus", "testResult", "자동화 여부", "자동화 여부");
    ...
    createTranslationKeyIfNotExists(
        "testResult.form.executionType", "testResult", "실행 타입", "실행 타입");
    createTranslationKeyIfNotExists("testResult.form.tags", "testResult", "태그", "태그");
    createTranslationKeyIfNotExists(
        "testResult.form.testTechnique", "testResult", "테스트 기법", "테스트 기법");
    createTranslationKeyIfNotExists(
        "testResult.form.notes", "testResult", "비고", "비고 ({current}/{max})");
    createTranslationKeyIfNotExists(
        "testResult.form.notesPlaceholder", "testResult", "비고 입력란", "테스트 결과에 대한 추가 정보를 입력하세요");
    createTranslationKeyIfNotExists(
        "testResult.form.notesHelp", "testResult", "비고 도움말", "테스트 과정에서 발견한 특이사항이나 추가 정보를 기록해주세요.");
    createTranslationKeyIfNotExists(
        "testResult.form.notesLimitWarning", "testResult", "비고 글자수 경고", "{remaining}자 남음");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "testResult.form.notesFileRecommendation",
        "testResult",
        "비고 파일 첨부 권장 메시지",
        "긴 내용은 파일 첨부를 권장합니다.");
    ...
    // 최신 결과 배지 및 통계
    createTranslationKeyIfNotExists(
        "testResult.badge.latest", "testResult", "최신 결과 배지 툴팁", "최신 결과");
    createTranslationKeyIfNotExists(
        "testResult.badge.latestShort", "testResult", "최신 결과 배지 라벨", "LATEST");
    createTranslationKeyIfNotExists(
        "testResult.statistics.latestSuccessRate", "testResult", "최근 성공률", "최종 성공률");
    createTranslationKeyIfNotExists(
        "testResult.statistics.totalCaseCount", "testResult", "전체 케이스 수", "전체 케이스");
    createTranslationKeyIfNotExists(
        "testResult.statistics.totalExecutionCount", "testResult", "누적 수행 횟수", "누적 수행 횟수");
    createTranslationKeyIfNotExists(
        "testResult.pieChart.totalCaseCount", "testResult", "파이차트 전체 케이스 수", "전체 테스트케이스");
    createTranslationKeyIfNotExists(
        "testResult.pieChart.totalExecutionCount", "testResult", "파이차트 누적 수행 횟수", "누적 수행 횟수");
    ...
    // 에러 메시지
    createTranslationKeyIfNotExists(
        "testResult.error.saveFailed", "testResult", "저장 실패", "결과 저장에 실패했습니다.");
    createTranslationKeyIfNotExists(
        "testResult.error.testCaseLoadFailed", "testResult", "테스트케이스 로드 실패", "테스트케이스를 불러오지 못했습니다.");
    createTranslationKeyIfNotExists(
        "testResult.error.resultRequired", "testResult", "결과 필수", "테스트 결과를 선택해주세요.");
    ...
    // 테스트 결과 버튼 (확장)
    createTranslationKeyIfNotExists(
        "testResult.button.jiraStatusCheck", "testResult", "JIRA 상태 체크 버튼", "JIRA 상태 체크");
    ...
    // 컬럼 표시 설정 메뉴
    createTranslationKeyIfNotExists(
        "testResult.columnMenu.title", "testResult", "컬럼 설정 제목", "컬럼 표시 설정");
    createTranslationKeyIfNotExists(
        "testResult.columnMenu.description", "testResult", "컬럼 설정 설명", "표시할 컬럼을 선택해주세요");
    createTranslationKeyIfNotExists(
        "testResult.columnMenu.showAll", "testResult", "전체 표시 버튼", "전체 표시");
    createTranslationKeyIfNotExists(
        "testResult.columnMenu.showEssential", "testResult", "필수만 표시 버튼", "필수만 표시");
    createTranslationKeyIfNotExists(
        "testResult.columnMenu.required", "testResult", "필수 컬럼 라벨", "필수 컬럼");
    createTranslationKeyIfNotExists(
        "testResult.columnMenu.summary", "testResult", "컬럼 요약", "표시 중: {visible}/{total}개 컬럼");
    createTranslationKeyIfNotExists(
    ...
    // 툴팁
    createTranslationKeyIfNotExists(
        "testResult.tooltip.noPreCondition", "testResult", "사전조건 없음 툴팁", "사전설정 없음");
    createTranslationKeyIfNotExists(
        "testResult.tooltip.noPostCondition", "testResult", "사후조건 없음 툴팁", "사후조건 없음");
    ...
    createTranslationKeyIfNotExists(
        "testResult.column.preCondition", "testResult", "사전조건 컬럼", "사전설정");
    createTranslationKeyIfNotExists(
        "testResult.column.postCondition", "testResult", "사후조건 컬럼", "사후 조건");
    createTranslationKeyIfNotExists("testResult.column.steps", "testResult", "스텝 정보 컬럼", "스텝 정보");
    createTranslationKeyIfNotExists(
        "testResult.column.linkedDocuments", "testResult", "연결된 문서 컬럼", "연결된 RAG 문서");
    createTranslationKeyIfNotExists(
        "testResult.column.linkedDocCount", "testResult", "연결된 문서 개수", "{count}건");
    ...
    createTranslationKeyIfNotExists(
        "testResult.chart.tooltip", "testResult", "차트 툴팁", "테스트 플랜별 또는 실행자별 결과를 비교합니다.");
    createTranslationKeyIfNotExists("testResult.chart.yAxisCount", "testResult", "Y축 개수", "개수 (건)");
    createTranslationKeyIfNotExists(
        "testResult.chart.yAxisPercent", "testResult", "Y축 비율", "비율 (%)");
    createTranslationKeyIfNotExists(
        "testResult.chart.compareItems", "testResult", "비교 항목", "총 {count}개 항목 비교");
    createTranslationKeyIfNotExists(
        "testResult.chart.loadingData", "testResult", "차트 데이터 로딩", "차트 데이터를 불러오는 중...");
    createTranslationKeyIfNotExists(
        "testResult.chart.noCompareData", "testResult", "비교 데이터 없음", "비교할 데이터가 없습니다.");

    // 테스트 결과 통계 카드
    createTranslationKeyIfNotExists(
        "testResult.statistics.title", "testResult", "통계 제목", "테스트 결과 통계");
    createTranslationKeyIfNotExists(
        "testResult.statistics.loading", "testResult", "통계 로딩", "로딩 중...");
    createTranslationKeyIfNotExists(
        "testResult.statistics.error", "testResult", "통계 에러", "에러: {error}");
    createTranslationKeyIfNotExists(
        "testResult.statistics.noData", "testResult", "통계 데이터 없음", "데이터 없음");
    createTranslationKeyIfNotExists(
    ...
    // 테스트 결과 파이차트
    createTranslationKeyIfNotExists(
        "testResult.pieChart.title", "testResult", "파이차트 제목", "테스트 결과 분포");
    createTranslationKeyIfNotExists(
        "testResult.pieChart.loading", "testResult", "파이차트 로딩", "차트 데이터를 불러오는 중...");
    createTranslationKeyIfNotExists(
        "testResult.pieChart.noData", "testResult", "파이차트 데이터 없음", "차트 데이터가 없습니다.");
    ...
    createTranslationKeyIfNotExists(
        "testResult.pieChart.totalTestCases", "testResult", "총 테스트케이스", "총 테스트 케이스: {total}건");
    ...
    createTranslationKeyIfNotExists(
        "testResult.filteredCases.goToExecution", "testResult", "실행으로 이동 버튼 툴팁", "실행으로 이동");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "testResult.filter.applied", "testResult", "필터 적용됨", "{count}개 적용");
    createTranslationKeyIfNotExists("testResult.filter.refresh", "testResult", "새로고침", "새로고침");
    createTranslationKeyIfNotExists(
        "testResult.filter.refreshTooltip", "testResult", "새로고침 툴팁", "데이터 새로고침");
    ...
    createTranslationKeyIfNotExists(
        "testResult.filter.clearTooltip", "testResult", "초기화 툴팁", "모든 필터 초기화");
    ...
    createTranslationKeyIfNotExists(
        "testResult.filter.testExecution", "testResult", "테스트 실행", "테스트 실행");
    createTranslationKeyIfNotExists(
        "testResult.filter.allExecutions", "testResult", "전체 실행", "전체 실행");
    createTranslationKeyIfNotExists("testResult.filter.allView", "testResult", "전체 보기", "전체 보기");
    createTranslationKeyIfNotExists(
        "testResult.filter.errorLoadPlans", "testResult", "플랜 로드 오류", "테스트 플랜 목록을 불러올 수 없습니다.");
    ...
    createTranslationKeyIfNotExists(
        "testResult.filter.overviewView", "testResult", "전체 개요", "전체 개요");
    createTranslationKeyIfNotExists("testResult.filter.planView", "testResult", "플랜별 비교", "플랜별 비교");
    createTranslationKeyIfNotExists(
        "testResult.filter.executorView", "testResult", "실행자별 비교", "실행자별 비교");
    createTranslationKeyIfNotExists(
        "testResult.filter.activeFilters", "testResult", "적용 중인 필터", "적용 중인 필터:");
    createTranslationKeyIfNotExists("testResult.filter.planPrefix", "testResult", "플랜 접두사", "플랜:");
    createTranslationKeyIfNotExists(
        "testResult.filter.executionPrefix", "testResult", "실행 접두사", "실행:");
    createTranslationKeyIfNotExists(
        "testResult.filter.periodPrefix", "testResult", "기간 접두사", "기간:");
    ...
    createTranslationKeyIfNotExists(
        "jira.summary.testResult", "jira", "테스트 결과", "테스트 결과 ({count}개)");
    ...
    createTranslationKeyIfNotExists(
        "testResultDashboard.chart.planComparison", "testResult", "테스트 플랜별 결과 비교", "테스트 플랜별 결과 비교");
    createTranslationKeyIfNotExists(
        "testResultDashboard.chart.executorComparison", "testResult", "실행자별 결과 비교", "실행자별 결과 비교");
    createTranslationKeyIfNotExists(
        "testResultDashboard.summary.title", "testResult", "통계 요약 제목", "통계 요약");
    createTranslationKeyIfNotExists(
        "testResultDashboard.summary.executionRate", "testResult", "실행률", "실행률");
    createTranslationKeyIfNotExists(
        "testResultDashboard.summary.successRate", "testResult", "성공률", "성공률");
    createTranslationKeyIfNotExists(
        "testResultDashboard.summary.jiraLinkRate", "testResult", "JIRA 연동률", "JIRA 연동률");
    createTranslationKeyIfNotExists(
        "testResultDashboard.summary.lastUpdated", "testResult", "최종 업데이트", "최종 업데이트");
    createTranslationKeyIfNotExists(
        "testResultDashboard.summary.unknown", "testResult", "알 수 없음", "알 수 없음");
    ...
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.loading.trendData", "testResult", "추이 데이터 로딩", "추이 데이터를 불러오는 중...");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.noData.title", "testResult", "추이 데이터 없음 제목", "추이 데이터가 없습니다");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.period.last7days", "testResult", "최근 7일", "최근 7일");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.period.last15days", "testResult", "최근 15일", "최근 15일");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.period.last30days", "testResult", "최근 30일", "최근 30일");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.period.last60days", "testResult", "최근 60일", "최근 60일");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.period.last90days", "testResult", "최근 90일", "최근 90일");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.chartType.line", "testResult", "라인 차트", "라인");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.chartType.area", "testResult", "영역 차트", "영역");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.summary.avgSuccessRate", "testResult", "평균 성공률", "평균 성공률");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.summary.avgCompletionRate", "testResult", "평균 완료율", "평균 완료율");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.summary.dataPoints", "testResult", "데이터 포인트", "데이터 포인트");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.summary.successRateChange", "testResult", "성공률 변화", "성공률 변화");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.chart.overallTrend", "testResult", "전체 추이", "테스트 결과 변화 추이");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.chart.testPlanComparison", "testResult", "테스트 플랜 비교", "테스트 플랜별 결과 비교");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.chart.assigneeComparison", "testResult", "실행자 비교", "실행자별 결과 비교");
    createTranslationKeyIfNotExists(
        ...
        "성공률 및 완료율 추이");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.chart.successRate", "testResult", "성공률", "성공률");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.chart.completionRate", "testResult", "완료율", "완료율");
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.tooltip.overallSuccessRate", "testResult", "전체 성공률", "전체 성공률");
    ...
    createTranslationKeyIfNotExists(
        "testTrendAnalysis.legend.overallSuccessRate", "testResult", "전체 성공률", "전체 성공률");
    ...
    // 컬럼 순서 변경 다이얼로그
    createTranslationKeyIfNotExists(
        "testResult.orderDialog.title", "testResult", "컬럼 순서 변경 다이얼로그 제목", "컬럼 순서 변경");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "testResult.orderDialog.visible", "testResult", "표시 상태 라벨", "표시");
    createTranslationKeyIfNotExists(
        "testResult.orderDialog.hidden", "testResult", "숨김 상태 라벨", "숨김");
    createTranslationKeyIfNotExists(
        "testResult.orderDialog.cancel", "testResult", "컬럼 순서 변경 취소 버튼", "취소");
    createTranslationKeyIfNotExists(
        "testResult.orderDialog.apply", "testResult", "컬럼 순서 변경 적용 버튼", "순서 적용");

    // 테스트 결과 내보내기 다이얼로그 번역 키들
    createTranslationKeyIfNotExists(
        "testResult.export.dialog.title", "testResult", "내보내기 다이얼로그 제목", "테스트 결과 내보내기");
    createTranslationKeyIfNotExists(
        "testResult.export.section.format", "testResult", "형식 선택 섹션 제목", "📄 내보내기 형식 선택");
    createTranslationKeyIfNotExists(
        "testResult.export.section.info", "testResult", "정보 섹션 제목", "📋 내보내기 정보");

    // Excel 형식
    createTranslationKeyIfNotExists(
        "testResult.export.format.excel.title", "testResult", "Excel 형식 제목", "Excel (.xlsx)");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "testResult.export.format.excel.feature1", "testResult", "Excel 기능1", "통계 차트 포함");
    createTranslationKeyIfNotExists(
        "testResult.export.format.excel.feature2", "testResult", "Excel 기능2", "서식 유지");
    createTranslationKeyIfNotExists(
        "testResult.export.format.excel.feature3", "testResult", "Excel 기능3", "필터링 가능");
    createTranslationKeyIfNotExists(
    ...
    // PDF 형식
    createTranslationKeyIfNotExists(
        "testResult.export.format.pdf.title", "testResult", "PDF 형식 제목", "PDF (.pdf)");
    createTranslationKeyIfNotExists(
        "testResult.export.format.pdf.description", "testResult", "PDF 형식 설명", "인쇄 및 공유용, 레이아웃 고정");
    createTranslationKeyIfNotExists(
        "testResult.export.format.pdf.feature1", "testResult", "PDF 기능1", "인쇄 최적화");
    createTranslationKeyIfNotExists(
        "testResult.export.format.pdf.feature2", "testResult", "PDF 기능2", "레이아웃 고정");
    createTranslationKeyIfNotExists(
        "testResult.export.format.pdf.feature3", "testResult", "PDF 기능3", "범용 호환성");
    createTranslationKeyIfNotExists(
    ...
    // CSV 형식
    createTranslationKeyIfNotExists(
        "testResult.export.format.csv.title", "testResult", "CSV 형식 제목", "CSV (.csv)");
    createTranslationKeyIfNotExists(
        ...
        "데이터 분석용, 가벼운 파일 크기");
    createTranslationKeyIfNotExists(
        "testResult.export.format.csv.feature1", "testResult", "CSV 기능1", "데이터 분석 최적");
    createTranslationKeyIfNotExists(
        "testResult.export.format.csv.feature2", "testResult", "CSV 기능2", "가벼운 용량");
    createTranslationKeyIfNotExists(
        "testResult.export.format.csv.feature3", "testResult", "CSV 기능3", "호환성 우수");
    createTranslationKeyIfNotExists(
    ...
    // HTML 형식
    createTranslationKeyIfNotExists(
        "testResult.export.format.html.title", "testResult", "HTML 형식 제목", "HTML (.html)");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "testResult.export.format.html.feature1", "testResult", "HTML 기능1", "리포트 레이아웃");
    createTranslationKeyIfNotExists(
        "testResult.export.format.html.feature2", "testResult", "HTML 기능2", "라이트/다크 테마");
    createTranslationKeyIfNotExists(
        "testResult.export.format.html.feature3", "testResult", "HTML 기능3", "단일 파일 공유");
    createTranslationKeyIfNotExists(
    ...
    // 내보내기 정보
    createTranslationKeyIfNotExists(
        "testResult.export.info.totalRows", "testResult", "총 데이터 건수 라벨", "📊 총 데이터 건수:");
    createTranslationKeyIfNotExists(
        "testResult.export.info.totalRowsValue", "testResult", "총 데이터 건수 값", "{count}건");
    createTranslationKeyIfNotExists(
        "testResult.export.info.columns", "testResult", "표시 컬럼 수 라벨", "🔍 표시 컬럼 수:");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "junit.empty.noResults", "testResult", "테스트 결과 없음 메시지", "테스트 결과가 없습니다");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "junit.empty.firstUpload", "testResult", "첫 업로드 버튼", "첫 번째 테스트 결과 업로드");

    // JUnit 업로드 다이얼로그 번역 키들
    createTranslationKeyIfNotExists("junit.upload.fileSize", "testResult", "파일 크기 라벨", "크기");
    createTranslationKeyIfNotExists(
        "junit.upload.changeFile", "testResult", "파일 변경 버튼", "다른 파일 선택");
    createTranslationKeyIfNotExists(
        "junit.upload.executionInfo", "testResult", "실행 정보 라벨", "테스트 실행 정보");
    createTranslationKeyIfNotExists(
        "junit.placeholder.description", "testResult", "설명 입력란", "설명 (선택사항)");
    createTranslationKeyIfNotExists(
        "junit.upload.uploadingFile", "testResult", "파일 업로드 중 메시지", "\"{fileName}\" 업로드 중...");
    ...
    createTranslationKeyIfNotExists(
        "junit.editor.viewOriginalData", "testResult", "원본 데이터 보기 툴팁", "원본 데이터 보기");
    createTranslationKeyIfNotExists("junit.editor.editHistory", "testResult", "편집 이력 툴팁", "편집 이력");

    // 상태 설명
    createTranslationKeyIfNotExists(
        "junit.editor.status.passedDesc", "testResult", "통과 상태 설명", "테스트가 성공적으로 통과했습니다");
    createTranslationKeyIfNotExists(
        "junit.editor.status.failedDesc", "testResult", "실패 상태 설명", "테스트가 실패했습니다");
    createTranslationKeyIfNotExists(
        "junit.editor.status.errorDesc", "testResult", "오류 상태 설명", "테스트 실행 중 오류가 발생했습니다");
    createTranslationKeyIfNotExists(
        "junit.editor.status.skippedDesc", "testResult", "건너뛴 상태 설명", "테스트가 건너뛰어졌습니다");
    ...
    createTranslationKeyIfNotExists(
        "junit.editor.tagsPlaceholder", "testResult", "태그 입력란", "쉼표로 구분하여 입력 (예: 버그, 회귀테스트, API)");
    createTranslationKeyIfNotExists(
        "junit.editor.tagsHelp", "testResult", "태그 도움말", "쉼표로 구분하여 여러 태그를 입력할 수 있습니다");
    createTranslationKeyIfNotExists("junit.editor.notes", "testResult", "노트 라벨", "노트");
    createTranslationKeyIfNotExists(
        "junit.editor.notesPlaceholder", "testResult", "노트 입력란", "테스트 케이스에 대한 추가 메모를 입력하세요");
    ...
    // 오류 메시지
    createTranslationKeyIfNotExists(
        "junit.editor.error.noTestCase", "testResult", "테스트 케이스 없음 오류", "테스트 케이스를 찾을 수 없습니다");
    createTranslationKeyIfNotExists(
        "junit.editor.error.saveFailed", "testResult", "저장 실패 오류", "테스트 케이스 저장에 실패했습니다");
  }
