...
public class ProjectKeysInitializer {
  ...
  public void initialize() {
    ...
    createTranslationKeyIfNotExists(
        "project.buttons.createNew", "project", "새 프로젝트 생성 버튼", "새 프로젝트 생성");
    createTranslationKeyIfNotExists(
        "project.tabs.byOrganization", "project", "조직별 프로젝트 탭", "조직별 프로젝트");
    ...
    createTranslationKeyIfNotExists(
        "project.types.independent", "project", "독립 프로젝트 타입", "독립 프로젝트");
    ...
    createTranslationKeyIfNotExists(
        "project.messages.noIndependentProjects", "project", "독립 프로젝트 없음", "독립 프로젝트가 없습니다");
    createTranslationKeyIfNotExists(
        "project.messages.addIndependentProjectsHint",
        "project",
        "독립 프로젝트 추가 힌트",
        "독립 프로젝트를 생성해보세요.");
    createTranslationKeyIfNotExists(
        "project.messages.noAllProjects", "project", "전체 프로젝트 없음", "등록된 프로젝트가 없습니다");
    createTranslationKeyIfNotExists(
        "project.messages.addFirstProjectHint", "project", "첫 프로젝트 생성 힌트", "첫 번째 프로젝트를 생성해보세요.");
    createTranslationKeyIfNotExists(
        "project.form.nameRequired", "project", "프로젝트 이름 필수 입력", "프로젝트 이름을 입력해주세요.");
    createTranslationKeyIfNotExists(
        "project.dialog.create.title", "project", "프로젝트 생성 다이얼로그 제목", "새 프로젝트 생성");
    createTranslationKeyIfNotExists(
        "project.dialog.edit.title", "project", "프로젝트 편집 다이얼로그 제목", "프로젝트 편집");
    createTranslationKeyIfNotExists(
        "project.dialog.transfer.title", "project", "프로젝트 이전 다이얼로그 제목", "프로젝트 이전");
    createTranslationKeyIfNotExists(
        "project.dialog.delete.title", "project", "프로젝트 삭제 다이얼로그 제목", "프로젝트 삭제 확인");

    // 추가 프로젝트 관련 키들
    createTranslationKeyIfNotExists(
        "project.form.codeRequired", "project", "프로젝트 코드 필수 입력", "프로젝트 코드를 입력해주세요.");
    createTranslationKeyIfNotExists(
        "project.tooltips.automationTestCount", "project", "자동화 테스트 결과 수 툴팁", "자동화 테스트 결과 수");
    createTranslationKeyIfNotExists(
        "project.buttons.openProject", "project", "프로젝트 열기 버튼", "프로젝트 열기");
    createTranslationKeyIfNotExists(
        "project.buttons.addProject", "project", "프로젝트 추가 버튼", "프로젝트 추가");
    createTranslationKeyIfNotExists(
        "project.buttons.createIndependent", "project", "독립 프로젝트 생성 버튼", "독립 프로젝트 생성");
    createTranslationKeyIfNotExists(
        ...
        "첫 번째 독립 프로젝트 생성");
    createTranslationKeyIfNotExists(
        "project.buttons.createProject", "project", "프로젝트 생성 버튼", "프로젝트 생성");
    createTranslationKeyIfNotExists(
        "project.stats.totalProjectCount", "project", "총 프로젝트 수 통계", "총 {count}개 프로젝트");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "project.messages.noParticipatingProjects", "project", "참여 중인 프로젝트 없음", "참여 중인 프로젝트가 없습니다");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        "project.messages.requestInvitation", "project", "프로젝트 초대 요청", "시스템관리자에게 프로젝트 초대를 요청하세요.");
    ...
    createTranslationKeyIfNotExists(
        "project.dialog.editTitle", "project", "프로젝트 편집 다이얼로그 제목", "프로젝트 수정");
    createTranslationKeyIfNotExists(
        "project.dialog.createTitle", "project", "프로젝트 생성 다이얼로그 제목", "새 프로젝트 생성");
    ...
    createTranslationKeyIfNotExists(
        "project.form.codePlaceholder", "project", "프로젝트 코드 플레이스홀더", "예: PROJ001");
    createTranslationKeyIfNotExists("project.form.organization", "project", "소속 조직 폼", "소속 조직");
    createTranslationKeyIfNotExists(
        "project.form.noOrganization", "project", "조직 없음 옵션", "독립 프로젝트 (조직 없음)");
    createTranslationKeyIfNotExists("project.form.description", "project", "설명 폼", "설명");
    createTranslationKeyIfNotExists(
        "project.form.descriptionPlaceholder", "project", "설명 플레이스홀더", "프로젝트에 대한 설명을 입력하세요...");
    createTranslationKeyIfNotExists(
        "project.dialog.transferTitle", "project", "프로젝트 이전 다이얼로그 제목", "프로젝트 조직 이전");
    createTranslationKeyIfNotExists(
        "project.form.targetOrganization", "project", "대상 조직 폼", "대상 조직");
    createTranslationKeyIfNotExists(
        "project.form.convertToIndependent", "project", "독립 프로젝트 전환 옵션", "독립 프로젝트로 전환");
    createTranslationKeyIfNotExists(
        "project.dialog.forceDeleteTitle", "project", "강제 삭제 다이얼로그 제목", "프로젝트 강제 삭제 확인");
    createTranslationKeyIfNotExists(
        "project.dialog.deleteTitle", "project", "삭제 다이얼로그 제목", "프로젝트 삭제 확인");
    createTranslationKeyIfNotExists(
        "project.dialog.forceDeleteWarningTitle", "project", "강제 삭제 경고 제목", "⚠️ 강제 삭제 경고");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        ...
        "project",
        "조직이전 설명",
        "'{projectName}' 프로젝트를 다른 조직으로 이전하거나 독립 프로젝트로 만들 수 있습니다.");
    createTranslationKeyIfNotExists(
    ...
    createTranslationKeyIfNotExists(
        ...
        "project",
        "프로젝트 강제 삭제 확인 메시지",
        "'{projectName}' 프로젝트를 정말 강제 삭제하시겠습니까?");

    // ProjectHeader 번역 키들
    createTranslationKeyIfNotExists(
        "projectHeader.breadcrumb.projects", "project", "프로젝트 브레드크럼", "프로젝트");
    createTranslationKeyIfNotExists("projectHeader.tabs.dashboard", "project", "대시보드 탭", "대시보드");
    createTranslationKeyIfNotExists(
        "projectHeader.tabs.testCases", "project", "테스트케이스 탭", "테스트케이스");
    createTranslationKeyIfNotExists(
        "projectHeader.tabs.testExecution", "project", "테스트실행 탭", "테스트실행");
    createTranslationKeyIfNotExists(
        "projectHeader.tabs.testResults", "project", "테스트결과 탭", "테스트결과");
    createTranslationKeyIfNotExists(
        "projectHeader.tabs.automation", "project", "자동화 테스트 탭", "자동화 테스트");
  }
