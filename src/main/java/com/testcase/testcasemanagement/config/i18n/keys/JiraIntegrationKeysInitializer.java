...
public class JiraIntegrationKeysInitializer {
    ...
    public void initialize() {
        ...
        createTranslationKeyIfNotExists("jira.comment.error.issueKeyRequired", "jira", "이슈 키 필수", "JIRA 이슈 키를 입력하세요.");
        createTranslationKeyIfNotExists("jira.comment.error.invalidIssueKey", "jira", "잘못된 이슈 키",
                "올바른 JIRA 이슈 키 형식이 아닙니다. (예: TEST-123)");
        createTranslationKeyIfNotExists("jira.comment.error.commentRequired", "jira", "코멘트 필수", "코멘트 내용을 입력하세요.");
