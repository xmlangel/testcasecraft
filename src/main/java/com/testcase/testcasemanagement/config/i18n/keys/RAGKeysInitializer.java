...
public class RAGKeysInitializer {
    ...
    public void initialize() {
        ...
        createTranslationKeyIfNotExists("rag.llmAnalysis.status.errorMessage", "rag", "LLM 분석 중 오류 발생 메시지",
                "분석 중 오류가 발생했습니다.");
        createTranslationKeyIfNotExists("rag.llmAnalysis.status.processingPausedMessage", "rag", "LLM 분석 진행/일시정지 중 메시지",
        ...
        createTranslationKeyIfNotExists("rag.similar.searchMethod.hybridRerank.info", "rag", "하이브리드 + Reranker 정보",
        ...
        // 공통 문서 요청 관련 키들
        createTranslationKeyIfNotExists("rag.document.global.requestTitle", "rag", "공통 문서 등록 요청 제목", "공통 문서 등록 요청");
        createTranslationKeyIfNotExists("rag.document.global.requestAction", "rag", "공통 문서 등록 요청 액션", "공통 문서 등록 요청");
