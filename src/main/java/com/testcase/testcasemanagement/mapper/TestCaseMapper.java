...
public class TestCaseMapper {
  ...
  public static List<TestCaseDto> toTreeDtoList(List<TestCase> entities) {
    List<TestCaseDto> dtos =
        entities.stream().map(TestCaseMapper::toDto).collect(Collectors.toList());
  ...
  public static List<TestCaseDto> toDtoList(List<TestCase> entities) {
    return entities.stream().map(TestCaseMapper::toDto).collect(Collectors.toList());
  }
  ...
  private static List<TestStep> toStepEntityList(List<TestStepDto> dtos) {
    return dtos.stream().map(TestCaseMapper::toStepEntity).collect(Collectors.toList());
  }
}
