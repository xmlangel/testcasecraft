...
public class AuditService {
  ...
  public void logAction(
      AuditEntityType entityType, String entityId, AuditAction action, String details) {
  ...
  public void logAction(String entityType, String entityId, String action, String details) {
    try {
      ...
      logger.debug(
          "Audit log recorded: entityType={}, entityId={}, action={}, user={}",
          entityType,
          entityId,
          action,
          currentUsername);
      ...
      logger.error(
          "Failed to record audit log: entityType={}, entityId={}, action={}",
          entityType,
          entityId,
          action,
          e);
  ...
  /** 조직 멤버 관리 감사 로그 기록 */
  public void logOrganizationMemberAction(
      String organizationId, String memberId, AuditAction action, String role) {
    logMemberAction(AuditEntityType.ORGANIZATION_USER, organizationId, memberId, action, role);
  }

  /** 프로젝트 멤버 관리 감사 로그 기록 */
  public void logProjectMemberAction(
      String projectId, String memberId, AuditAction action, String role) {
    logMemberAction(AuditEntityType.PROJECT_USER, projectId, memberId, action, role);
  }

  /** 그룹 멤버 관리 감사 로그 기록 */
  public void logGroupMemberAction(
      String groupId, String memberId, AuditAction action, String role) {
  ...
  public void logActionWithJson(
      AuditEntityType entityType, String entityId, AuditAction action, Object detailsObject) {
    try {
