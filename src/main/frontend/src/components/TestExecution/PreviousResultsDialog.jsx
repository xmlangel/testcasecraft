...
function PreviousResultsDialog({
  ...
  const canEdit = (result) => {
    ...
    return (
      result.executedBy === user.username ||
      user.role === "ADMIN" ||
      user.role === "MANAGER"
    );
  };
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await api(
        `/api/test-executions/results/${resultToDelete.id}`,
        {
          method: "DELETE",
        },
      );
  ...
  return (
    <>
      ...
      >
              ...
              <Table size="small">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>
                      {t("testExecution.table.executionId")}
                    </TableCell>
                    <TableCell>
                      {t("testExecution.table.executionName")}
                    </TableCell>
                    <TableCell>{t("testExecution.table.executedBy")}</TableCell>
                    <TableCell>{t("testExecution.table.notes")}</TableCell>
                    <TableCell>
                      {t("testExecution.previousResults.table.tags")}
                    </TableCell>
                    ...
                    <TableCell align="center">
                      {t("testExecution.previousResults.table.actions")}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
        ...
        <DialogActions>
          <Button
            onClick={onClose}
            color="primary"
            data-testid="prev-result-close-button"
          >
            {t("common.close")}
          </Button>
        </DialogActions>
      ...
      >
        <DialogTitle>
          {t("testExecution.previousResults.delete.title")}
        </DialogTitle>
        <DialogContent>
          <Typography>
        ...
        <DialogActions>
          <Button
            ...
            disabled={deleting}
            data-testid="prev-result-delete-cancel-button"
          >
          ...
          >
            {deleting
              ? t("testExecution.previousResults.delete.deleting")
              : t("testExecution.previousResults.delete.delete")}
          </Button>
        </DialogActions>
      </Dialog>
    </>
