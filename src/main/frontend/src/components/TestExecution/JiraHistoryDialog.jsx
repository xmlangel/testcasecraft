...
import {
    ...
    Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tooltip, Paper, CircularProgress, IconButton, Link
} from "@mui/material";
import { useTheme } from '@mui/material/styles';
import { AttachFile as AttachFileIcon, OpenInNew as OpenInNewIcon } from "@mui/icons-material";
                            ...
                            <Table size="small">
                                <TableHead>
                                    <TableRow sx={{ backgroundColor: theme.palette.action.hover }}>
                                        <TableCell sx={{ fontWeight: 'bold' }}>{t('jira.history.column.date')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold' }}>{t('jira.history.column.result')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold' }}>{t('jira.history.column.execution')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold' }}>{t('jira.history.column.testcase')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold' }}>{t('jira.history.column.executor')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold' }}>{t('jira.history.column.notes')}</TableCell>
                                ...
                                <TableBody>
                                    {sortedResults.map((r, idx) => (
                                        <TableRow key={r.id || idx} hover>
                                            ...
                                            <TableCell sx={{ whiteSpace: 'nowrap' }}>{r.executedBy}</TableCell>
