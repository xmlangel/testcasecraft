...
const BulkResultDialog = ({
  ...
  const resultButtons = [
    ...
    {
      value: TestResult.BLOCKED,
      label: "BLOCKED",
      icon: <BlockedIcon />,
      color: RESULT_COLORS.BLOCKED,
    },
    {
      value: TestResult.NOT_RUN,
      label: "NOT RUN",
      icon: <NotRunIcon />,
      ...
      <DialogContent>
        <Box sx={{ mt: 2 }}>
          ...
          <Typography variant="subtitle2" gutterBottom>
            {t(
              "testExecution.bulk.dialog.selectedCases",
              "선택된 테스트케이스",
            )}{" "}
                ...
                <Button
                  ...
                  sx={{
                    ...
                    boxShadow: isSelected
                      ? `0 6px 16px ${alpha(btn.color, 0.4)}, 0 0 0 2px ${alpha(
                          btn.color,
                          0.2,
                        )}`
