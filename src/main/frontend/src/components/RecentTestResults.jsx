...
const RecentTestResults = ({
  ...
  const getResultConfig = (result) =>
    getLocalizedResultConfig(result, t) ||
    getLocalizedResultConfig("NOT_RUN", t);

  // Accordion state
  const [expanded, setExpanded] = React.useState(() => {
    const saved = localStorage.getItem(
      "testcase-manager-recent-results-accordion",
    );
                    ...
                    <ListItemText
                      primary={
                        ...
                        >
                          ...
                          >
                            {result.testCaseName ||
                              t("recentResults.testcase.fallback", {
                        ...
                        <Box sx={{ mt: 0.5 }}>
                          ...
                          {showExecutionInfo && result.testExecutionName && (
                            <Typography
                              ...
                              display="block"
                            >
                              {t("recentResults.label.execution")}{" "}
                            ...
                            {result.executedBy && (
                              <>
                                ...
                                <Typography
                                  ...
                                  color="text.secondary"
                                >
                                  {t("recentResults.label.executor")}{" "}
                                  {result.executedBy}
                                </Typography>
                              </>
                            )}
