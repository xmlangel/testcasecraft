...
function TestResultBarChart({
  ...
  if (
    ...
    !Array.isArray(data) ||
    data.length === 0 ||
    data.every((item) => (item.totalTests || 0) === 0)
  ) {
    return (
              ...
              <YAxis
                ...
                label={{
                  value: showPercentage
                    ? t("testResult.chart.yAxisPercent")
                    : t("testResult.chart.yAxisCount"),
                  angle: -90,
                  position: "insideLeft",
