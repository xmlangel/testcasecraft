          ...
          {lastUpdated && (
            <Chip
              label={t(
                ...
                "최근 업데이트: {time}",
              ).replace("{time}", lastUpdated.toLocaleTimeString("ko-KR"))}
              size="small"
              variant="outlined"
            />
          )}
            ...
            <Box>
              ...
              >
                <Typography variant="body2">
                  {t("performance.cache.hitRate", "적중률")}
                </Typography>
                <Typography variant="h6">
                  {(projectCache.hitRate || 0).toFixed(1)}%
                </Typography>
              </Box>
              <LinearProgress
                variant="determinate"
                ...
                <Grid size={{ xs: 6 }}>
                  ...
                  >
                    <Typography variant="caption" color="text.secondary">
                      {t("performance.cache.hit", "적중")}
                    </Typography>
                    <Typography variant="h6">
                      {projectCache.hitCount || 0}
                    </Typography>
                  </Box>
                </Grid>
                <Grid size={{ xs: 6 }}>
                  ...
                  >
                    <Typography variant="caption" color="text.secondary">
                      {t("performance.cache.miss", "누락")}
                    </Typography>
                    <Typography variant="h6">
                      {projectCache.missCount || 0}
                    </Typography>
                  </Box>
                </Grid>
              </Grid>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Box>
              ...
              >
                ...
                <Typography variant="h6">
                  {(testCaseCache.hitRate || 0).toFixed(1)}%
                </Typography>
              </Box>
              <LinearProgress
                variant="determinate"
          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, md: 4 }}>
              ...
              >
                ...
                <Typography variant="h5" fontWeight={700}>
                  <CountUp
                    end={usageMetrics.totalDailyVisits || 0}
                    duration={1}
                  />
                </Typography>
              </Box>
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              ...
              >
                ...
                <Typography variant="h5" fontWeight={700}>
                  <CountUp
                    end={usageMetrics.totalUniqueVisitors || 0}
                    duration={1}
                  />
                </Typography>
              </Box>
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              ...
              >
                ...
                <Typography variant="h5" fontWeight={700}>
                  <CountUp
                    end={usageMetrics.activeVisitors || 0}
                    duration={1}
                  />
                </Typography>
                <Typography variant="caption" color="text.secondary">
                  {t(
                    "performance.usage.recentMinutes",
                    "최근 {minutes}분 기준",
                  ).replace(
                    "{minutes}",
                    usageMetrics.rollingDayWindowMinutes || 10,
                  )}
                </Typography>
              </Box>
            </Grid>
                  ...
                  {usageMetrics.pages.slice(0, 5).map((page) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <Typography variant="caption" color="text.secondary">
                          {t(
                            "performance.usage.totalAccumulated",
                            "누적 {total}",
                          ).replace("{total}", page.totalCount)}
                        </Typography>
                      </Box>
                    </Box>
                  ))}
            ...
            {usageMetrics.dailySummaries &&
              usageMetrics.dailySummaries.length > 0 && (
                <Grid size={{ xs: 12, md: 6 }}>
                  <Typography variant="subtitle2" gutterBottom sx={{ mt: 1 }}>
                  ...
                  >
                    {usageMetrics.dailySummaries.slice(0, 5).map((summary) => (
                      ...
                      >
                        <Typography variant="body2">{summary.date}</Typography>
                        <Box
                          sx={{
                            display: "flex",
                            gap: 2,
                        ...
                        >
                          ...
                          <Typography variant="caption" color="text.secondary">
                            {t(
                              "performance.usage.uniqueCount",
                              "고유 {count}",
                            ).replace("{count}", summary.uniqueVisitors)}
                          </Typography>
                        </Box>
                      </Box>
                    ))}
