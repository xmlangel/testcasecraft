...
const GmailGuideDialog = ({ open, onClose }) => {
  ...
  const setupSteps = [
      ...
      content: (
        <Box>
          ...
          >
            ...
            <Link href="https://mail.google.com" target="_blank" rel="noopener">
              mail.google.com
            </Link>
          ...
          <Alert severity="info" sx={{ mt: 1 }}>
            <Typography variant="body2">
              <strong>{t("mail.guide.step1.alert.title", "주의:")}</strong>{" "}
              {t(
    ...
    },
    {
      ...
      description: t(
        ...
        "보안 설정을 위해 Google 계정 관리 페이지로 이동합니다",
      ),
      content: (
        <Box>
          <Typography
      ...
      content: (
        <Box>
          ...
          <Alert severity="warning" sx={{ mt: 1 }}>
            <Typography variant="body2">
              <strong>{t("mail.guide.step3.alert.title", "필수 단계:")}</strong>{" "}
              {t(
    ...
    },
    {
      ...
      description: t(
        ...
        "TestCase Manager용 앱 비밀번호를 생성합니다",
      ),
      content: (
        <Box>
          <Typography
          ...
          <Alert severity="success" sx={{ mt: 1 }}>
            <Typography variant="body2">
              <strong>{t("mail.guide.step4.alert.title", "중요:")}</strong>{" "}
              {t(
    ...
    },
    {
      ...
      description: t(
        ...
        "생성한 정보를 TestCase Manager에 입력합니다",
      ),
      content: (
        <Box>
          <Typography
  ...
  const requirements = [
    {
      text: t("mail.guide.requirements.gmail", "Gmail 계정 (@gmail.com)"),
      icon: <GoogleIcon />,
      color: red[500],
    },
    {
      text: t("mail.guide.requirements.twoFactor", "2단계 인증 활성화"),
      icon: <SecurityIcon />,
      color: orange[600],
    },
    {
      text: t("mail.guide.requirements.appPassword", "앱 비밀번호 생성"),
      icon: <KeyIcon />,
      color: green[600],
    },
    {
      text: t("mail.guide.requirements.https", "HTTPS 연결"),
      icon: <SecurityIcon />,
      color: blue[600],
    },
  ];
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <List dense>
            {requirements.map((req, index) => (
              <ListItem key={index}>
                <ListItemIcon>
                  <Box sx={{ color: req.color }}>{req.icon}</Box>
                </ListItemIcon>
                  ...
                  <Box sx={{ mt: 2 }}>
                    ...
                    >
                      {index === setupSteps.length - 1
                        ? t("mail.guide.button.complete", "완료")
                        : t("mail.guide.button.next", "다음")}
                    </Button>
                    <Button
                      disabled={index === 0}
                      onClick={handleBack}
