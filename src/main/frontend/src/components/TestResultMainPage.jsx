...
function TestResultMainPage() {
  ...
  const handleViewResult = (testCaseId, executionId) => {
    navigate(
      `/projects/${activeProject?.id}/executions/${executionId}/testcase/${testCaseId}`,
    );
  };
          ...
          <Tab
            ...
            label={
              <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
                ...
                >
                  {isMobile
                    ? t("testResult.tab.statistics")
                    : t("testResult.tab.statisticsFull")}
                </Typography>
                {!isMobile && (
                  <Typography
                    variant="caption"
          ...
          <Tab
            ...
            label={
              <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
                ...
                >
                  {isMobile
                    ? t("testResult.tab.table")
                    : t("testResult.tab.tableFull")}
                </Typography>
                {!isMobile && (
                  <Typography
                    variant="caption"
