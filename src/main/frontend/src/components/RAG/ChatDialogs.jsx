  ...
  return (
    <>
        ...
        <DialogActions>
          ...
          >
            {isSavingThread ? (
              ...
              t("rag.chat.threadCreateAction", "생성")
            )}
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogActions>
          <Button
            onClick={onCloseDeleteThreadDialog}
      ...
      >
        <DialogTitle>
          {t("rag.chat.deleteMessageTitle", "응답 삭제")}
        </DialogTitle>
        <DialogContent>
          <Typography variant="body2">
            {t(
        ...
        <DialogActions>
          <Button
            onClick={onCloseDeleteMessageConfirm}
