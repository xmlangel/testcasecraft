  ...
  return (
    ...
    >
      ...
      >
        <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
          ...
          {chunkInfo.chunkIndex && (
            <Chip
              label={t("rag.chunk.preview.chunkNumber", "청크 #{number}", {
                number: chunkInfo.chunkIndex,
              })}
              size="small"
              variant="outlined"
            />
          ...
          {typeof chunkInfo.similarityScore === "number" && (
            <Chip
              ...
              size="small"
              color={
                chunkInfo.similarityScore >= 0.8
                  ? "success"
                  : chunkInfo.similarityScore >= 0.6
                    ? "warning"
                    : "default"
              }
              variant="outlined"
      ...
      <DialogActions sx={{ px: 3, py: 2 }}>
        ...
        {!chunkInfo.isConversationThread &&
          chunkInfo.documentId &&
          onViewDocument && (
            <Button
              onClick={() => {
