        ...
        {selectedSummary ? (
          <Box>
            ...
            <Box sx={{ display: "flex", gap: 2, mb: 3 }}>
              ...
              <Chip
                label={t(
                  "rag.document.summary.analyzedChunksLabel",
                  "분석 완료: {count}개",
              ...
              <Chip
                label={t(
                  "rag.document.summary.progressLabel",
                  "진행률: {progress}%",
            ...
            <Box>
              ...
              {loadingSummary ? (
                ...
                <Alert severity="warning" sx={{ mt: 2 }}>
                  {t("rag.llmAnalysis.status.processingPausedMessage", {
                    analyzedChunks: selectedSummary.analyzedChunks,
                  })}
                </Alert>
              ) : null}
              {summaryContent && (
