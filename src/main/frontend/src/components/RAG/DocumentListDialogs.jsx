  ...
  return (
    <>
      ...
      >
        ...
        <DialogActions>
          <Button onClick={onPromoteClose}>{t("common.cancel", "취소")}</Button>
          <Button
          ...
          >
            {promoteSubmitting
              ...
              : t("rag.document.global.promoteAction", "공통 문서로 이동")}
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogActions>
          <Button onClick={onRequestClose}>{t("common.cancel", "취소")}</Button>
          <Button
          ...
          >
            {requestSubmitting
              ? t("common.processing", "처리 중...")
              : t("rag.document.global.requestAction", "공통 문서 등록 요청")}
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogActions>
          <Button onClick={onUploadClose}>{t("common.close", "닫기")}</Button>
        </DialogActions>
      </Dialog>
