  ...
  const handleCreateTestCase = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        preCondition:
          testCaseData.preCondition || testCaseData.preconditions || "",
      ...
      setErrorMessage(
        error.message ||
          t("rag.testcase.createError", "테스트케이스 생성에 실패했습니다."),
      );
    } finally {
      setIsCreating(false);
    }
  ...
  return (
    <Card
      ...
      sx={{
        mt: 2,
        borderColor:
          createStatus === "success" ? "success.main" : "primary.main",
        borderWidth: 2,
      }}
    >
      <CardContent>
              ...
              <Table size="small">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell width="45%">
                      {t("testcase.step.action", "동작")}
                    </TableCell>
                    <TableCell width="45%">
                      {t("testcase.step.expected", "예상 결과")}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
