...
function JiraLinkedCasesDialog({
  ...
  const loadJiraLinkedCases = useCallback(async () => {
    ...
    try {
      ...
      const linkedCases = allData.filter(
        (item) => item.jiraIssueKey && item.jiraIssueKey.trim() !== "",
      );
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!loading && (
          <Chip
            label={t("testResult.jiraDialog.count", "{count}건").replace(
              "{count}",
              jiraItems.length,
            )}
            size="small"
                    ...
                    >
                      ...
                      {tcIndex === 0 && (
                        ...
                        >
                          ...
                          >
                            ...
                            <Tooltip
                              title={t(
                                "testResult.jiraDialog.openJira",
                                "JIRA에서 열기",
                              )}
                            >
                              <IconButton
                                ...
                                target={
                                  activeConfig?.serverUrl ? "_blank" : "_self"
                                }
                          ...
                          <Typography variant="caption" color="text.secondary">
                            {t(
                              ...
                              "{count}개 케이스",
                            ).replace("{count}", jiraItem.testCases.length)}
                          </Typography>
                        </TableCell>
                      )}
                      <TableCell
                      ...
                      >
                        ...
                        >
                          {tc.testCaseName ||
                            t(
                              "testResult.filteredCases.unnamed",
                              "(이름 없음)",
                            )}
                        </Typography>
                      </TableCell>
                      ...
                      <TableCell>{getResultChip(tc.result)}</TableCell>
