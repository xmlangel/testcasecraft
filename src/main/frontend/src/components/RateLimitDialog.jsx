      ...
      <DialogContent sx={{ py: 3 }}>
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            초 후 자동으로 재시도 가능합니다 / Auto retry will be available
            after the countdown.
          </Typography>
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            • 페이지를 너무 자주 새로고침하지 마세요 / Please avoid refreshing
            too frequently.
            <br />
            • 잠시 기다렸다가 다시 시도해주세요 / Wait a moment before trying
            again.
            <br />• 문제가 계속되면 관리자에게 문의하세요 / Contact your
