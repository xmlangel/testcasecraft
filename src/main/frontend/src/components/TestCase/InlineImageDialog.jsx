...
const InlineImageDialog = ({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <DialogTitle>
        {t("testcase.inlineImage.dialogTitle", "클립보드 이미지 옵션")}
      </DialogTitle>
      <DialogContent dividers>
        <TextField
          ...
          onChange={(event) =>
            updateImageDialogState({ altText: event.target.value })
          }
          fullWidth
          margin="dense"
          autoFocus
        ...
        <Box sx={{ mt: 2, display: "flex", flexDirection: "column", gap: 2 }}>
          <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
            <TextField
              ...
              onChange={(event) =>
                updateImageDialogState({ width: event.target.value })
              }
              fullWidth
              helperText={t(
            ...
            <FormControl sx={{ minWidth: 120 }}>
              <InputLabel id="inline-image-width-unit-label">
                {t("testcase.inlineImage.unit", "단위")}
              </InputLabel>
              <Select
          ...
          <Slider
            ...
            onChange={(_, newValue) =>
              updateImageDialogState({ width: String(newValue) })
            }
            marks={
              widthUnit === "%"
                ? [
