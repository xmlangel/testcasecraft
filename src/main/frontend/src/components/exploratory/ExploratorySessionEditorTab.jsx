...
function ExploratorySessionEditorTab({
  ...
  const charterDetail = parseCharterMission(
    selectedCharter?.mission,
    selectedCharter?.areas,
  );
          ...
          >
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Chip
                size="small"
                label={t(
                  "exploratory.editor.header.elapsed",
                  "실행 시간 {value}",
              ...
              <Chip
                size="small"
                label={t(
                  "exploratory.editor.header.paused",
                  "중단 시간 {value}",
                  { value: formatSeconds(pausedSec) },
                )}
              />
            </Box>
          </Box>
        ...
        <CardContent sx={{ pb: 0 }}>
          ...
          >
            ...
            <Tab
              ...
              label={t(
                "exploratory.editor.tab.artifactsEvaluation",
                "산출물/평가",
              )}
            />
          </Tabs>
          ...
          <CardContent>
            ...
            <Grid container spacing={1.5}>
              <Grid size={{ xs: 12, md: 4 }}>
                <TextField
                  inputProps={{
                    "data-testid": "exploratory-editor-input-environment",
                  }}
                  fullWidth
                  size="small"
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <TextField
                  inputProps={{
                    "data-testid": "exploratory-editor-input-version",
                  }}
                  fullWidth
                  size="small"
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <TextField
                  inputProps={{
                    "data-testid": "exploratory-editor-input-tags",
                  }}
                  fullWidth
                  size="small"
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <FormControl size="small" fullWidth>
                  <InputLabel>
                    {t(
                      "exploratory.editor.charterSection.assigned",
                      "할당 차터",
                    )}
                  </InputLabel>
                  <Select
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <TextField
                  inputProps={{
                    "data-testid": "exploratory-editor-input-time-execution",
                  }}
                  fullWidth
                  size="small"
                  type="number"
                  ...
                  onChange={(e) =>
                    setSessionDraft((prev) => ({
                      ...prev,
                      timeExecution: Number(e.target.value || 0),
                    }))
                  }
                />
              </Grid>
              <Grid size={{ xs: 12, md: 4 }}>
                <TextField
                  inputProps={{
                    "data-testid":
                      "exploratory-editor-input-time-bug-investigation",
                  }}
                  fullWidth
                  size="small"
                  type="number"
                  ...
                  onChange={(e) =>
                    setSessionDraft((prev) => ({
                      ...prev,
                      timeBugInvestigation: Number(e.target.value || 0),
                    }))
                  }
                />
              </Grid>
              <Grid size={{ xs: 12, md: 4 }}>
                <TextField
                  inputProps={{
                    "data-testid": "exploratory-editor-input-time-setup-admin",
                  }}
                  fullWidth
                  size="small"
                  type="number"
                  label={t(
                    "exploratory.editor.timeSection.setupAdmin",
                    "Setup/Admin (%)",
                  )}
                  ...
                  onChange={(e) =>
                    setSessionDraft((prev) => ({
                      ...prev,
                      timeSetupAdmin: Number(e.target.value || 0),
                    }))
                  }
                />
              </Grid>
            ...
            <Typography variant="body2" sx={{ mt: 1 }}>
              {t("exploratory.editor.timeSection.total", "합계 {total}%", {
                total: totalRatio,
              })}{" "}
              |{" "}
              {t(
                ...
                { minutes: Math.floor(pausedSec / 60) },
              )}
            </Typography>
            {totalRatio !== 100 && (
            ...
            <CardContent>
              ...
              <Grid container spacing={1.5}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    inputProps={{
                      "data-testid": "exploratory-editor-input-notes-flow",
                    }}
                    fullWidth
                    multiline
                    minRows={3}
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    inputProps={{
                      "data-testid": "exploratory-editor-input-notes-coverage",
                    }}
                    fullWidth
                    multiline
                    minRows={3}
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    inputProps={{
                      "data-testid": "exploratory-editor-input-notes-oracle",
                    }}
                    fullWidth
                    multiline
                    minRows={3}
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    inputProps={{
                      "data-testid": "exploratory-editor-input-notes-activity",
                    }}
                    fullWidth
                    multiline
                    minRows={3}
              ...
              <Grid container spacing={1.5}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    inputProps={{
                      "data-testid":
                        "exploratory-editor-input-issue-bug-headline",
                    }}
                    fullWidth
                    label={t(
                      "exploratory.editor.issue.bugHeadline",
                      "버그 헤드라인 연동",
                    )}
                ...
                <Grid size={{ xs: 12, md: 3 }}>
                  <TextField
                    inputProps={{
                      "data-testid": "exploratory-editor-input-issue-blockers",
                    }}
                    fullWidth
                ...
                <Grid size={{ xs: 12, md: 3 }}>
                  <TextField
                    inputProps={{
                      "data-testid": "exploratory-editor-input-issue-questions",
                    }}
                    fullWidth
        ...
        <>
          <Card variant="outlined">
            <CardContent>
              ...
              <TextField
                inputProps={{
                  "data-testid": "exploratory-editor-input-test-data",
                }}
                fullWidth
                multiline
                minRows={2}
                label={t(
                  "exploratory.editor.artifact.testData",
                  "테스트 데이터",
                )}
              ...
              <Grid container spacing={1}>
                {artifacts.length === 0 && (
                  <Grid size={{ xs: 12 }}>
                    <Typography variant="body2" color="text.secondary">
                      {t(
                        "exploratory.editor.artifact.empty",
                        "업로드된 파일이 없습니다.",
                      )}
                    </Typography>
                  </Grid>
                    ...
                    <Card variant="outlined">
                      <CardContent sx={{ p: 1.5 }}>
                        ...
                        <Typography variant="caption" color="text.secondary">
                          {t(
                            "exploratory.editor.artifact.sizeKb",
                            "{size} KB",
            ...
            <CardContent>
              ...
              <Stack spacing={1.5}>
                ...
                <TextField
                  inputProps={{
                    "data-testid":
                      "exploratory-editor-input-evaluation-overall",
                  }}
                  fullWidth
                  multiline
                  minRows={2}
                  label={t(
                    "exploratory.editor.evaluation.overall",
                    "전체 평가",
                  )}
                ...
                <TextField
                  inputProps={{
                    "data-testid":
                      "exploratory-editor-input-evaluation-next-charter",
                  }}
                  fullWidth
                  label={t(
